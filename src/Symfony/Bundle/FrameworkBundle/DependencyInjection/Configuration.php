                            ...
                            ->arrayPrototype()
                                ...
                                ->children()
                                    ...
                                    ->booleanNode('force_https_urls')
                                        ...
                                        ->defaultFalse()
                                    ->end()
                                    ->variableNode('allowed_link_schemes')
                                        ->info('Allows only a given list of schemes to be used in links href attributes or null to allow any scheme.')
                                        ->defaultValue([])
                                        ->validate()
                                            ->ifTrue(function ($v) { return !\is_array($v) && null !== $v; })
                                            ->thenInvalid('The "allowed_link_schemes" parameter must be an array or null')
                                        ->end()
                                    ->end()
