...
use Symphony\Component\Validator\Tests\Fixtures\FailingConstraint;
...
abstract class AbstractTest extends AbstractValidatorTest
{
    ...
    /**
     * @expectedException \Symphony\Component\Validator\Exception\RuntimeException
     */
    ...
    public function testInitializeObjectsOnFirstValidation()
    {
        ...
        $initializer1 = $this->getMockBuilder('Symphony\\Component\\Validator\\ObjectInitializerInterface')->getMock();
        $initializer2 = $this->getMockBuilder('Symphony\\Component\\Validator\\ObjectInitializerInterface')->getMock();
