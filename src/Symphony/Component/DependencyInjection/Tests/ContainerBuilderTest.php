...
use Symphony\Component\DependencyInjection\Tests\Fixtures\SimilarArgumentsDummy;
...
class ContainerBuilderTest extends TestCase
{
    ...
    public function testRegister()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\DependencyInjection\Definition', $builder->getDefinition('foo'), '->register() returns the newly created Definition instance');
    }
    ...
    public function testAddGetCompilerPass()
    {
        ...
        $builder->addCompilerPass($pass1 = $this->getMockBuilder('Symphony\Component\DependencyInjection\Compiler\CompilerPassInterface')->getMock(), PassConfig::TYPE_BEFORE_OPTIMIZATION, -5);
        $builder->addCompilerPass($pass2 = $this->getMockBuilder('Symphony\Component\DependencyInjection\Compiler\CompilerPassInterface')->getMock(), PassConfig::TYPE_BEFORE_OPTIMIZATION, 10);
    ...
    /**
     * @expectedException \Symphony\Component\DependencyInjection\Exception\EnvNotFoundException
    ...
    public function testAddObjectResource()
    {
        ...
        /* @var $resource \Symphony\Component\Config\Resource\FileResource */
        $resource = end($resources);

        $this->assertInstanceOf('Symphony\Component\Config\Resource\FileResource', $resource);
    ...
    public function testCaseSensitivity()
    {
        ...
        $this->assertSame(array('service_container', 'foo', 'Foo', 'fOO', 'Psr\Container\ContainerInterface', 'Symphony\Component\DependencyInjection\ContainerInterface'), $container->getServiceIds());
    ...
    public function testArgumentsHaveHigherPriorityThanBindings()
    {
        ...
        $this->assertSame(array('service_container', 'class.via.bindings', 'class.via.argument', 'foo', 'Psr\Container\ContainerInterface', 'Symphony\Component\DependencyInjection\ContainerInterface'), $container->getServiceIds());
