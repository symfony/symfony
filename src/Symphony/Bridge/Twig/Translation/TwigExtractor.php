...
namespace Symphony\Bridge\Twig\Translation;

use Symphony\Component\Finder\Finder;
use Symphony\Component\Finder\SplFileInfo;
use Symphony\Component\Translation\Extractor\AbstractFileExtractor;
...
class TwigExtractor extends AbstractFileExtractor implements ExtractorInterface
{
    ...
    {
        $visitor = $this->twig->getExtension('Symphony\Bridge\Twig\Extension\TranslationExtension')->getTranslationNodeVisitor();
        $visitor->enable();
