...
class RouteCollectionBuilderTest extends TestCase
{
    public function testImport()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\Routing\RouteCollectionBuilder', $importedRoutes);
    ...
    public function testAdd()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\Routing\Route', $addedRoute);
    ...
    public function testFlushSetsDetailsOnChildrenRoutes()
    {
        ...
        $this->assertEquals('symphony.com', $actualEditRoute->getHost());
