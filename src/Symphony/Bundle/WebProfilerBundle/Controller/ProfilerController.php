...
use Symphony\Bundle\WebProfilerBundle\Csp\ContentSecurityPolicyHandler;
...
use Symphony\Component\HttpFoundation\Session\Flash\AutoExpireFlashBag;
...
class ProfilerController
{
    ...
    public function panelAction(Request $request, $token)
    {
        ...
        return new Response($this->twig->render($this->getTemplateManager()->getName($profile, $panel), array(
            ...
            'profiler_markup_version' => 2, // 1 = original profiler, 2 = Symphony 2.8+ profiler
    ...
    public function toolbarAction(Request $request, $token)
    {
        ...
        return $this->renderWithCspNonces($request, '@WebProfiler/Profiler/toolbar.html.twig', array(
            ...
            'profiler_url' => $url,
            'token' => $token,
            'profiler_markup_version' => 2, // 1 = original toolbar, 2 = Symphony 2.8+ toolbar
        ));
    }
