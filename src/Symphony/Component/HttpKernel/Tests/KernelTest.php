...
use Symphony\Component\HttpKernel\Tests\Fixtures\KernelForTest;
use Symphony\Component\HttpKernel\Tests\Fixtures\KernelForOverrideName;
use Symphony\Component\HttpKernel\Tests\Fixtures\KernelWithoutBundles;
...
class KernelTest extends TestCase
{
    ...
    {
        $bundle = $this->getMockBuilder('Symphony\Component\HttpKernel\Bundle\Bundle')->getMock();
    ...
    public function testHandleCallsHandleOnHttpKernel()
    {
        ...
        $httpKernelMock = $this->getMockBuilder('Symphony\Component\HttpKernel\HttpKernel')
...
EOF;
    ...
    public function testKernelRootDirNameStartingWithANumber()
    {
        ...
        $kernel = new \Symphony\Component\HttpKernel\Tests\Fixtures\_123\Kernel123('dev', true);
    ...
    {
        $bundle = $this
            ->getMockBuilder('Symphony\Component\HttpKernel\Bundle\BundleInterface')
    ...
    {
        $kernel = $this->getMockBuilder('Symphony\Component\HttpKernel\Tests\Fixtures\KernelForTest')
            ->setConstructorArgs(array('test', false))
            ->setMethods($methods)
            ->getMock();
        $p = new \ReflectionProperty($kernel, 'rootDir');
