...
namespace Symphony\Component\Console\Style;

use Symphony\Component\Console\Exception\RuntimeException;
use Symphony\Component\Console\Formatter\OutputFormatter;
use Symphony\Component\Console\Helper\Helper;
use Symphony\Component\Console\Helper\ProgressBar;
...
use Symphony\Component\Console\Terminal;

/**
 * Output decorator helpers for the Symphony Style Guide.
 *
 * @author Kevin Bond <kevinbond@gmail.com>
 */
class SymphonyStyle extends OutputStyle
{
    ...
    {
        $style = clone Table::getStyleDefinition('symphony-style-guide');
    ...
    public function askQuestion(Question $question)
    {
        ...
        if (!$this->questionHelper) {
            $this->questionHelper = new SymphonyQuestionHelper();
        }
