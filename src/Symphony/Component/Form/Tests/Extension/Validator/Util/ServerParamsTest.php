...
namespace Symphony\Component\Form\Tests\Extension\Validator\Util;

use PHPUnit\Framework\TestCase;
use Symphony\Component\Form\Extension\Validator\Util\ServerParams;
...
class ServerParamsTest extends TestCase
{
    ...
    public function testGetContentLengthFromRequest()
    {
        ...
        $requestStack = $this->getMockBuilder('Symphony\Component\HttpFoundation\RequestStack')->setMethods(array('getCurrentRequest'))->getMock();
    ...
    {
        $serverParams = $this->getMockBuilder('Symphony\Component\Form\Extension\Validator\Util\ServerParams')->setMethods(array('getNormalizedIniPostMaxSize'))->getMock();
        $serverParams
            ->expects($this->any())
