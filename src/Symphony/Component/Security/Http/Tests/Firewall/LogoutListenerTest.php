...
use Symphony\Component\Security\Http\Firewall\LogoutListener;
...
class LogoutListenerTest extends TestCase
{
    ...
    /**
     * @expectedException \Symphony\Component\Security\Core\Exception\LogoutException
     */
    ...
    {
        return $this->getMockBuilder('Symphony\Component\Security\Csrf\CsrfTokenManagerInterface')->getMock();
    }
    ...
    {
        return $this->getMockBuilder('Symphony\Component\Security\Http\Logout\LogoutHandlerInterface')->getMock();
    }

    private function getHttpUtils()
    {
        return $this->getMockBuilder('Symphony\Component\Security\Http\HttpUtils')
            ->disableOriginalConstructor()
            ->getMock();
    }
    ...
    {
        return $this->getMockBuilder('Symphony\Component\Security\Http\Logout\LogoutSuccessHandlerInterface')->getMock();
    }

    private function getToken()
    {
        return $this->getMockBuilder('Symphony\Component\Security\Core\Authentication\Token\TokenInterface')->getMock();
    }
}
