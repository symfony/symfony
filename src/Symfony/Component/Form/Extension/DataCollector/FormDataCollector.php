...
class FormDataCollector extends DataCollector implements FormDataCollectorInterface
{
    ...
    public function collect(Request $request, Response $response, \Exception $exception = null)
    {
        if (70000 <= \PHP_VERSION_ID && \PHP_VERSION_ID < 70800) {
            @trigger_error('A bug in PHP 7.0.0 to 7.0.7 is breaking the Form panel, please upgrade to 7.0.8 or higher.'.\PHP_VERSION_ID.((int)(70000 <= \PHP_VERSION_ID).((int)\PHP_VERSION_ID < 70800)), E_USER_DEPRECATED);
        }
    }
