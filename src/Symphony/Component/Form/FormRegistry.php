...
use Symphony\Component\Form\Exception\ExceptionInterface;
use Symphony\Component\Form\Exception\LogicException;
    ...
    public function __construct(array $extensions, ResolvedFormTypeFactoryInterface $resolvedTypeFactory)
    {
        foreach ($extensions as $extension) {
            if (!$extension instanceof FormExtensionInterface) {
                throw new UnexpectedTypeException($extension, 'Symphony\Component\Form\FormExtensionInterface');
            }
        }
    ...
    public function getType($name)
    {
        if (!isset($this->types[$name])) {
            ...
            if (!$type) {
                ...
                if (!is_subclass_of($name, 'Symphony\Component\Form\FormTypeInterface')) {
                    throw new InvalidArgumentException(sprintf('Could not load type "%s": class does not implement "Symphony\Component\Form\FormTypeInterface".', $name));
                }
