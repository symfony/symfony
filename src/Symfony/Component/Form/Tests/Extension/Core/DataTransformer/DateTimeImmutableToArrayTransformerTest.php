...
class DateTimeImmutableToArrayTransformerTest extends DateTimeImmutableTestCase
{
    public function testTransform()
    {
        $transformer = new DateTimeImmutableToArrayTransformer('UTC', 'UTC');
    ...
    {
        $transformer = new DateTimeImmutableToArrayTransformer();
    ...
    {
        $transformer = new DateTimeImmutableToArrayTransformer(null, null, array('year', 'minute', 'second'));
    ...
    {
        $transformer = new DateTimeImmutableToArrayTransformer('UTC', 'UTC', array('year', 'month', 'minute', 'second'));
    ...
    {
        $transformer = new DateTimeImmutableToArrayTransformer('UTC', 'UTC', null, true);
    ...
    {
        $transformer = new DateTimeImmutableToArrayTransformer('America/New_York', 'Asia/Hong_Kong');
    ...
    public function testReverseTransformWithSomeZero()
    {
        ...
        $output = new \DateTimeImmutable('2010-02-03 04:00:00 UTC');
    ...
    {
        $transformer = new DateTimeImmutableToArrayTransformer(null, null, array('year', 'month', 'day'));
    ...
    public function testReverseTransformDifferentTimezones()
    {
        ...
        $output = new \DateTimeImmutable('2010-02-03 04:05:06 Asia/Hong_Kong');
    ...
    {
        $transformer = new DateTimeImmutableToArrayTransformer('Asia/Hong_Kong', 'UTC');
