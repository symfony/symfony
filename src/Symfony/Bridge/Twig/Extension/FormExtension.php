...
class FormExtension extends AbstractExtension implements InitRuntimeInterface
{
    ...
    public function __construct($renderer = null)
    {
        if ($renderer instanceof TwigRendererInterface) {
            ...
            throw new \InvalidArgumentException(sprintf('Passing any arguments the constructor of %s is reserved for internal use.', self::class));
        }
    ...
    {
        if ('renderer' === $name) {
            @trigger_error(sprintf('Using the "%s::$renderer" property is deprecated since Symfony 3.2 as it will be removed in 4.0.', self::class), E_USER_DEPRECATED);
