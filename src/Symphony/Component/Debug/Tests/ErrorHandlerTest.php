...
use Symphony\Component\Debug\BufferingLogger;
...
class ErrorHandlerTest extends TestCase
{
    public function testRegister()
    {
        ...
        try {
            $this->assertInstanceOf('Symphony\Component\Debug\ErrorHandler', $handler);
    ...
    public function testHandleErrorException()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\Debug\Exception\ClassNotFoundException', $args[0]);
