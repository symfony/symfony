...
use Symphony\Component\Serializer\Encoder\ChainEncoder;
use Symphony\Component\Serializer\Encoder\EncoderInterface;
use Symphony\Component\Serializer\Encoder\NormalizationAwareInterface;
...
class ChainEncoderTest extends TestCase
{
    ...
    {
        $this->encoder1 = $this
            ->getMockBuilder('Symphony\Component\Serializer\Encoder\EncoderInterface')
            ->getMock();
    ...
    {
        $chainEncoder = $this
            ->getMockBuilder('Symphony\Component\Serializer\Tests\Encoder\ChainNormalizationAwareEncoder')
            ->getMock();
