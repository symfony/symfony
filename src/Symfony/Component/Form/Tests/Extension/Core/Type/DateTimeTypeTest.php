...
class DateTimeTypeTest extends BaseTypeTest
{
    ...
    public function testSubmitString()
    {
        ...
        self::assertEquals('2010-06-02 03:04:00', $form->getData());
    }
    ...
    public function testSubmitWithoutMinutes()
    {
        ...
        self::assertEquals(new \DateTime('2010-06-02 03:00:00 UTC'), $form->getData());
    }
    ...
    public function testSubmitWithSeconds()
    {
        ...
        self::assertEquals(new \DateTime('2010-06-02 03:04:05 UTC'), $form->getData());
    }
    ...
    public function testSubmitDifferentTimezones()
    {
        ...
        self::assertEquals($dateTime->format('Y-m-d H:i:s'), $form->getData());
    }
    ...
    public function testSubmitDifferentTimezonesDateTime()
    {
        ...
        self::assertEquals($outputTime, $form->getData());
        self::assertEquals('2010-06-02T03:04:00', $form->getViewData());
    }
    ...
    public function testSubmitStringSingleTextWithSeconds()
    {
        ...
        self::assertEquals('2010-06-02 03:04:05', $form->getData());
        self::assertEquals('2010-06-02T03:04:05', $form->getViewData());
    }
    ...
    public function testSingleTextWidgetShouldUseTheRightInputType()
    {
        ...
        self::assertEquals('datetime-local', $view->vars['type']);
    }
    ...
    public function testPassDefaultPlaceholderToViewIfNotRequired()
    {
        ...
        self::assertSame('', $view['date']['year']->vars['placeholder']);
        self::assertSame('', $view['date']['month']->vars['placeholder']);
        self::assertSame('', $view['date']['day']->vars['placeholder']);
        self::assertSame('', $view['time']['hour']->vars['placeholder']);
        self::assertSame('', $view['time']['minute']->vars['placeholder']);
        self::assertSame('', $view['time']['second']->vars['placeholder']);
    }
    ...
    public function testPassNoPlaceholderToViewIfRequired()
    {
        ...
        self::assertNull($view['date']['year']->vars['placeholder']);
        self::assertNull($view['date']['month']->vars['placeholder']);
        self::assertNull($view['date']['day']->vars['placeholder']);
        self::assertNull($view['time']['hour']->vars['placeholder']);
        self::assertNull($view['time']['minute']->vars['placeholder']);
        self::assertNull($view['time']['second']->vars['placeholder']);
    }
    ...
    public function testPassPlaceholderAsString()
    {
        ...
        self::assertSame('Empty', $view['date']['year']->vars['placeholder']);
        self::assertSame('Empty', $view['date']['month']->vars['placeholder']);
        self::assertSame('Empty', $view['date']['day']->vars['placeholder']);
        self::assertSame('Empty', $view['time']['hour']->vars['placeholder']);
        self::assertSame('Empty', $view['time']['minute']->vars['placeholder']);
        self::assertSame('Empty', $view['time']['second']->vars['placeholder']);
    }
    ...
    public function testPassPlaceholderAsArray()
    {
        ...
        self::assertSame('Empty year', $view['date']['year']->vars['placeholder']);
        self::assertSame('Empty month', $view['date']['month']->vars['placeholder']);
        self::assertSame('Empty day', $view['date']['day']->vars['placeholder']);
        self::assertSame('Empty hour', $view['time']['hour']->vars['placeholder']);
        self::assertSame('Empty minute', $view['time']['minute']->vars['placeholder']);
        self::assertSame('Empty second', $view['time']['second']->vars['placeholder']);
    }
    ...
    public function testPassHtml5TypeIfSingleTextAndHtml5Format()
    {
        ...
        self::assertSame('datetime-local', $view->vars['type']);
    }
    ...
    public function testSingleTextWidgetWithCustomNonHtml5Format()
    {
        ...
        self::assertSame('2/13/19, 7:12:13 PM', $view->vars['value']);
    }
    ...
    public function testDateTypeChoiceErrorsBubbleUp()
    {
        ...
        self::assertSame([], iterator_to_array($form['date']->getErrors()));
    ...
    public function testTimeTypeChoiceErrorsBubbleUp()
    {
        ...
        self::assertSame([], iterator_to_array($form['time']->getErrors()));
        self::assertSame([$error], iterator_to_array($form->getErrors()));
    }
    ...
    public function testPassDefaultChoiceTranslationDomain()
    {
        ...
        self::assertFalse($view['date']['year']->vars['choice_translation_domain']);
        self::assertFalse($view['date']['month']->vars['choice_translation_domain']);
        self::assertFalse($view['date']['day']->vars['choice_translation_domain']);
        self::assertFalse($view['time']['hour']->vars['choice_translation_domain']);
        self::assertFalse($view['time']['minute']->vars['choice_translation_domain']);
        self::assertFalse($view['time']['second']->vars['choice_translation_domain']);
    }
    ...
    public function testPassChoiceTranslationDomainAsString()
    {
        ...
        $view = $form->createView();
        self::assertSame('messages', $view['date']['year']->vars['choice_translation_domain']);
        self::assertSame('messages', $view['date']['month']->vars['choice_translation_domain']);
        self::assertSame('messages', $view['date']['day']->vars['choice_translation_domain']);
        self::assertSame('messages', $view['time']['hour']->vars['choice_translation_domain']);
        self::assertSame('messages', $view['time']['minute']->vars['choice_translation_domain']);
        self::assertSame('messages', $view['time']['second']->vars['choice_translation_domain']);
    }
    ...
    public function testPassChoiceTranslationDomainAsArray()
    {
        ...
        $view = $form->createView();
        self::assertSame('foo', $view['date']['year']->vars['choice_translation_domain']);
        self::assertSame('test', $view['date']['month']->vars['choice_translation_domain']);
        self::assertFalse($view['date']['day']->vars['choice_translation_domain']);
        self::assertSame('foo', $view['time']['hour']->vars['choice_translation_domain']);
        self::assertFalse($view['time']['minute']->vars['choice_translation_domain']);
        self::assertSame('test', $view['time']['second']->vars['choice_translation_domain']);
    }
    ...
    public function testSubmitNullUsesDefaultEmptyData($emptyData = [], $expectedData = null)
    {
        ...
        self::assertSame(['date' => ['year' => '', 'month' => '', 'day' => ''], 'time' => ['hour' => '', 'minute' => '']], $form->getViewData());
    ...
    public function testSubmitStringWithCustomInputFormat()
    {
        ...
        self::assertSame('14/01/2018 21:29:00 +00:00', $form->getData());
    }
}
