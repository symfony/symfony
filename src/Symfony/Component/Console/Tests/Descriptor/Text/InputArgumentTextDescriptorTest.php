...
use Symfony\Component\Console\Descriptor\Text\InputArgumentTextDescriptor;
...
class InputArgumentTextDescriptorTest extends AbstractDescriptorTest
{
    protected function getDescriptor()
    {
        return new InputArgumentTextDescriptor();
    }
