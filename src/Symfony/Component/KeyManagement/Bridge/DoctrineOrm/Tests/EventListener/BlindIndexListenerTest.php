...
use Symfony\Component\KeyManagement\Bridge\DoctrineOrm\Tests\Fixtures\BlindIndexedNonNullableTargetEntity;
...
use Symfony\Component\KeyManagement\Bridge\DoctrineOrm\Tests\Fixtures\BlindIndexedUnmappedTargetEntity;
...
class BlindIndexListenerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        (new SchemaTool($this->entityManager))->createSchema(array_map(
            ...
            [BlindIndexedEntity::class, BlindIndexedNonNullableTargetEntity::class, BlindIndexedNonStringEntity::class, BlindIndexedUnknownSourceEntity::class, BlindIndexedUnmappedTargetEntity::class, PlainEntity::class],
        ));
    }
    ...
    public function testATargetThatCannotHoldTheNullTagOfANullableSourceIsRefused()
    {
        ...
        $this->expectException(\LogicException::class);
        $this->expectExceptionMessage(\sprintf('The property "%1$s::$email" may be null, but "%1$s::$emailIndex", which indexes it, does not accept null: declare it nullable.', BlindIndexedNonNullableTargetEntity::class));
