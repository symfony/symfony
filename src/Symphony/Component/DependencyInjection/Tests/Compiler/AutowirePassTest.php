...
use Symphony\Component\DependencyInjection\Compiler\AutowirePass;
use Symphony\Component\DependencyInjection\Compiler\DecoratorServicePass;
...
use Symphony\Component\DependencyInjection\Tests\Fixtures\includes\FooVariadic;
...
class AutowirePassTest extends TestCase
{
     ...
     * @expectedExceptionMessage Cannot autowire service "c": argument "$a" of method "Symphony\Component\DependencyInjection\Tests\Compiler\C::__construct()" references class "Symphony\Component\DependencyInjection\Tests\Compiler\A" but no such service exists. You should maybe alias this class to the existing "Symphony\Component\DependencyInjection\Tests\Compiler\B" service.
     */
    ...
    /**
     * @expectedException \Symphony\Component\DependencyInjection\Exception\RuntimeException
     * @expectedExceptionMessage Cannot autowire service "g": argument "$d" of method "Symphony\Component\DependencyInjection\Tests\Compiler\G::__construct()" references interface "Symphony\Component\DependencyInjection\Tests\Compiler\DInterface" but no such service exists. You should maybe alias this interface to the existing "Symphony\Component\DependencyInjection\Tests\Compiler\F" service.
     */
    ...
    /**
     * @expectedException \Symphony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Invalid service "private_service": constructor of class "Symphony\Component\DependencyInjection\Tests\Compiler\PrivateConstructor" must be public.
     */
    ...
    /**
     * @expectedException \Symphony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "a": argument "$collision" of method "Symphony\Component\DependencyInjection\Tests\Compiler\CannotBeAutowired::__construct()" references interface "Symphony\Component\DependencyInjection\Tests\Compiler\CollisionInterface" but no such service exists. You should maybe alias this interface to one of these existing services: "c1", "c2", "c3".
     */
    ...
    /**
     * @expectedException \Symphony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "a": argument "$k" of method "Symphony\Component\DependencyInjection\Tests\Compiler\NotGuessableArgument::__construct()" references class "Symphony\Component\DependencyInjection\Tests\Compiler\Foo" but no such service exists. You should maybe alias this class to one of these existing services: "a1", "a2".
     */
    ...
    /**
     * @expectedException \Symphony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "a": argument "$k" of method "Symphony\Component\DependencyInjection\Tests\Compiler\NotGuessableArgumentForSubclass::__construct()" references class "Symphony\Component\DependencyInjection\Tests\Compiler\A" but no such service exists. You should maybe alias this class to one of these existing services: "a1", "a2".
     */
    ...
    /**
     * @expectedException \Symphony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "a": argument "$collision" of method "Symphony\Component\DependencyInjection\Tests\Compiler\CannotBeAutowired::__construct()" references interface "Symphony\Component\DependencyInjection\Tests\Compiler\CollisionInterface" but no such service exists.
     */
    ...
    /**
     * @expectedException \Symphony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "coop_tilleuls": argument "$j" of method "Symphony\Component\DependencyInjection\Tests\Compiler\LesTilleuls::__construct()" references class "Symphony\Component\DependencyInjection\Tests\Compiler\Dunglas" but no such service exists.
     */
    ...
    /**
     * @expectedException \Symphony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "a": argument "$r" of method "Symphony\Component\DependencyInjection\Tests\Compiler\BadTypeHintedArgument::__construct()" has type "Symphony\Component\DependencyInjection\Tests\Compiler\NotARealClass" but this class was not found.
     */
    ...
    /**
     * @expectedException \Symphony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "a": argument "$r" of method "Symphony\Component\DependencyInjection\Tests\Compiler\BadParentTypeHintedArgument::__construct()" has type "Symphony\Component\DependencyInjection\Tests\Compiler\OptionalServiceClass" but this class is missing a parent class (Class Symphony\Bug\NotExistClass not found).
     */
    ...
    /**
     * @expectedException \Symphony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "bar": argument "$foo" of method "Symphony\Component\DependencyInjection\Tests\Compiler\Bar::__construct()" references class "Symphony\Component\DependencyInjection\Tests\Compiler\Foo" but this service is abstract. You should maybe alias this class to the existing "foo" service.
     */
    ...
    /**
     * @expectedException \Symphony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "arg_no_type_hint": argument "$foo" of method "Symphony\Component\DependencyInjection\Tests\Compiler\MultipleArguments::__construct()" must have a type-hint or be given a value explicitly.
     */
    ...
    /**
     * @expectedException \Symphony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "setter_injection_collision": argument "$collision" of method "Symphony\Component\DependencyInjection\Tests\Compiler\SetterInjectionCollision::setMultipleInstancesForOneArg()" references interface "Symphony\Component\DependencyInjection\Tests\Compiler\CollisionInterface" but no such service exists. You should maybe alias this interface to one of these existing services: "c1", "c2".
     */
    ...
    /**
     * @expectedException \Symphony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "my_service": argument "$i" of method "Symphony\Component\DependencyInjection\Tests\Compiler\K::__construct()" references interface "Symphony\Component\DependencyInjection\Tests\Compiler\IInterface" but no such service exists. Did you create a class that implements this interface?
     */
    ...
    /**
     * @expectedException \Symphony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "bar": argument "$foo" of method "Symphony\Component\DependencyInjection\Tests\Compiler\Bar::__construct()" references class "Symphony\Component\DependencyInjection\Tests\Compiler\Foo" but no such service exists. You should maybe alias this class to the existing "foo" service.
     */
    public function testProcessDoesNotTriggerDeprecations()
    {
        $container = new ContainerBuilder();
        $container->register('deprecated', 'Symphony\Component\DependencyInjection\Tests\Fixtures\DeprecatedClass')->setDeprecated(true);
        $container->register('foo', __NAMESPACE__.'\Foo');
        $container->register('bar', __NAMESPACE__.'\Bar')->setAutowired(true);
    ...
    {
        return array(
            array('setNotAutowireable', 'Cannot autowire service "foo": argument "$n" of method "Symphony\Component\DependencyInjection\Tests\Compiler\NotWireable::setNotAutowireable()" has type "Symphony\Component\DependencyInjection\Tests\Compiler\NotARealClass" but this class was not found.'),
            array('setDifferentNamespace', 'Cannot autowire service "foo": argument "$n" of method "Symphony\Component\DependencyInjection\Tests\Compiler\NotWireable::setDifferentNamespace()" references class "stdClass" but no such service exists.'),
            array(null, 'Invalid service "foo": method "Symphony\Component\DependencyInjection\Tests\Compiler\NotWireable::setProtectedMethod()" must be public.'),
        );
    }

    /**
     * @expectedException \Symphony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "foo": argument "$sam" of method "Symphony\Component\DependencyInjection\Tests\Compiler\NotWireable::setNotAutowireableBecauseOfATypo()" references class "Symphony\Component\DependencyInjection\Tests\Compiler\lesTilleuls" but no such service exists. Did you mean "Symphony\Component\DependencyInjection\Tests\Compiler\LesTilleuls"?
     */
    ...
    /**
     * @expectedException \Symphony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "j": argument "$i" of method "Symphony\Component\DependencyInjection\Tests\Compiler\J::__construct()" references class "Symphony\Component\DependencyInjection\Tests\Compiler\I" but no such service exists. Try changing the type-hint to "Symphony\Component\DependencyInjection\Tests\Compiler\IInterface" instead.
     */
    ...
    /**
     * @expectedException \Symphony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "j": argument "$i" of method "Symphony\Component\DependencyInjection\Tests\Compiler\J::__construct()" references class "Symphony\Component\DependencyInjection\Tests\Compiler\I" but no such service exists. You should maybe alias this class to one of these existing services: "i", "i2".
     */
    ...
    /**
     * @expectedException \Symphony\Component\DependencyInjection\Exception\AutowiringFailedException
     * @expectedExceptionMessage Cannot autowire service "Symphony\Component\DependencyInjection\Tests\Compiler\NonAutowirableDecorator": argument "$decorated1" of method "__construct()" references interface "Symphony\Component\DependencyInjection\Tests\Compiler\DecoratorInterface" but no such service exists. You should maybe alias this interface to one of these existing services: "Symphony\Component\DependencyInjection\Tests\Compiler\NonAutowirableDecorator", "Symphony\Component\DependencyInjection\Tests\Compiler\NonAutowirableDecorator.inner". Did you create a class that implements this interface?
     */
    ...
    public function testErroredServiceLocator()
    {
        ...
        $this->assertEquals($erroredDefinition->addError('Cannot autowire service "some_locator": it has type "Symphony\Component\DependencyInjection\Tests\Compiler\MissingClass" but this class was not found.'), $container->getDefinition('_errored.some_locator.'.MissingClass::class));
    }
}
