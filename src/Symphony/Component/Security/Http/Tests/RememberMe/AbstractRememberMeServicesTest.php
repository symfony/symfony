...
use Symphony\Component\Security\Http\RememberMe\AbstractRememberMeServices;
...
class AbstractRememberMeServicesTest extends TestCase
{
    ...
    public function testLogout(array $options)
    {
        ...
        $this->assertInstanceOf('Symphony\Component\HttpFoundation\Cookie', $cookie);
    ...
    public function testLoginSuccessIsNotProcessedWhenTokenDoesNotContainUserInterfaceImplementation()
    {
        ...
        $request = new Request();
        $response = new Response();
        $account = $this->getMockBuilder('Symphony\Component\Security\Core\User\UserInterface')->getMock();
        $token = $this->getMockBuilder('Symphony\Component\Security\Core\Authentication\Token\TokenInterface')->getMock();
        $token
            ->expects($this->once())
            ->method('getUser')
    ...
    protected function getService($userProvider = null, $options = array(), $logger = null)
    {
        ...
        return $this->getMockForAbstractClass('Symphony\Component\Security\Http\RememberMe\AbstractRememberMeServices', array(
