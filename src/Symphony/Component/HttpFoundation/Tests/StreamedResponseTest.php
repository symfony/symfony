...
class StreamedResponseTest extends TestCase
{
    ...
    public function testCreate()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\HttpFoundation\StreamedResponse', $response);
    ...
    public function testReturnThis()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\HttpFoundation\StreamedResponse', $response->sendContent());
        $this->assertInstanceOf('Symphony\Component\HttpFoundation\StreamedResponse', $response->sendContent());

        $response = new StreamedResponse(function () {});
        $this->assertInstanceOf('Symphony\Component\HttpFoundation\StreamedResponse', $response->sendHeaders());
        $this->assertInstanceOf('Symphony\Component\HttpFoundation\StreamedResponse', $response->sendHeaders());
    }
}
