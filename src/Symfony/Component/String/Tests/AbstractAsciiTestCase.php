...
abstract class AbstractAsciiTestCase extends TestCase
{
    ...
    public static function provideSnake()
    {
        return [
            ...
            ['symfony_is_great', 'symfonyIsGREAT'],
            ['symfony_is_great', 'SYMFONY IS GREAT'],
            ['symfony_7_is_great', 'symfony 7 is great'],
            ['symfony_7_4_is_great', 'symfony 7.4 is great'],
            ['symfony_2000_is_great', 'symfony 2000 is great'],
            ...
            ['symfony_is_great', 'Symfony IS GREAT!'],
            ['best_symfony_is_2', 'Best Symfony is 2'],
