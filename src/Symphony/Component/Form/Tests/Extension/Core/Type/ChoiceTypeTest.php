...
{
    const TESTED_TYPE = 'Symphony\Component\Form\Extension\Core\Type\ChoiceType';
    ...
    {
        $this->assertInstanceOf('Symphony\Component\Form\FormInterface', $this->factory->create(static::TESTED_TYPE, null, array()));
    }
    ...
    public function testPassHierarchicalChoicesToView()
    {
        ...
        $this->assertEquals(array(
            'Symphony' => new ChoiceGroupView('Symphony', array(
    ...
    // https://github.com/symphony/symphony/issues/3298
    public function testInitializeWithEmptyChoices()
    {
        $this->assertInstanceOf('Symphony\Component\Form\FormInterface', $this->factory->createNamed('name', static::TESTED_TYPE, null, array(
            'choices' => array(),
        )));
    }
    ...
    public function testCustomChoiceTypeDoesNotInheritChoiceLabels()
    {
        ...
        $builder->add('subChoice', 'Symphony\Component\Form\Tests\Fixtures\ChoiceSubType');
