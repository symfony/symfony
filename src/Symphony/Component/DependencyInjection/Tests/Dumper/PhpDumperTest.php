...
use Symphony\Component\DependencyInjection\ContainerInterface as SymphonyContainerInterface;
...
use Symphony\Component\DependencyInjection\Tests\Fixtures\StubbedTranslator;
...
use Symphony\Component\DependencyInjection\Tests\Fixtures\CustomDefinition;
use Symphony\Component\DependencyInjection\Tests\Fixtures\TestServiceSubscriber;
use Symphony\Component\DependencyInjection\Variable;
...
class PhpDumperTest extends TestCase
{
    ...
    public function testDump()
    {
        ...
        $this->assertStringEqualsFile(self::$fixturesPath.'/php/services1-1.php', $dumper->dump(array('class' => 'Container', 'base_class' => 'AbstractContainer', 'namespace' => 'Symphony\Component\DependencyInjection\Dump')), '->dump() takes a class and a base_class options');
    }
    ...
    public function testDumpCustomContainerClassWithoutConstructor()
    {
        ...
        $this->assertStringEqualsFile(self::$fixturesPath.'/php/custom_container_class_without_constructor.php', $dumper->dump(array('base_class' => 'NoConstructorContainer', 'namespace' => 'Symphony\Component\DependencyInjection\Tests\Fixtures\Container')));
    }
    ...
    public function testDumpCustomContainerClassConstructorWithoutArguments()
    {
        ...
        $this->assertStringEqualsFile(self::$fixturesPath.'/php/custom_container_class_constructor_without_arguments.php', $dumper->dump(array('base_class' => 'ConstructorWithoutArgumentsContainer', 'namespace' => 'Symphony\Component\DependencyInjection\Tests\Fixtures\Container')));
    }
    ...
    public function testDumpCustomContainerClassWithOptionalArgumentLessConstructor()
    {
        ...
        $this->assertStringEqualsFile(self::$fixturesPath.'/php/custom_container_class_with_optional_constructor_arguments.php', $dumper->dump(array('base_class' => 'ConstructorWithOptionalArgumentsContainer', 'namespace' => 'Symphony\Component\DependencyInjection\Tests\Fixtures\Container')));
    }
    ...
    public function testDumpCustomContainerClassWithMandatoryArgumentLessConstructor()
    {
        ...
        $this->assertStringEqualsFile(self::$fixturesPath.'/php/custom_container_class_with_mandatory_constructor_arguments.php', $dumper->dump(array('base_class' => 'ConstructorWithMandatoryArgumentsContainer', 'namespace' => 'Symphony\Component\DependencyInjection\Tests\Fixtures\Container')));
    }
    ...
    public function testAddService()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('\Symphony\Component\DependencyInjection\Exception\RuntimeException', $e, '->dump() throws a RuntimeException if the container to be dumped has reference to objects or resources');
    ...
    {
        $class = 'Symphony_DI_PhpDumper_Test_Unsupported_Characters';
        $container = new ContainerBuilder();
    ...
    {
        $class = 'Symphony_DI_PhpDumper_Test_Conflicting_Service_Ids';
        $container = new ContainerBuilder();
    ...
    {
        $class = 'Symphony_DI_PhpDumper_Test_Conflicting_Method_With_Parent';
        $container = new ContainerBuilder();
        $container->register('bar', 'FooClass')->setPublic(true);
        $container->register('foo_bar', 'FooClass')->setPublic(true);
        $container->compile();
        ...
        eval('?>'.$dumper->dump(array(
            'class' => $class,
            'base_class' => 'Symphony\Component\DependencyInjection\Tests\Fixtures\containers\CustomContainer',
        )));
    ...
    public function testAliases()
    {
        ...
        $container->compile();
        $dumper = new PhpDumper($container);
        eval('?>'.$dumper->dump(array('class' => 'Symphony_DI_PhpDumper_Test_Aliases')));

        $container = new \Symphony_DI_PhpDumper_Test_Aliases();
    ...
    public function testFrozenContainerWithoutAliases()
    {
        ...
        $dumper = new PhpDumper($container);
        eval('?>'.$dumper->dump(array('class' => 'Symphony_DI_PhpDumper_Test_Frozen_No_Aliases')));

        $container = new \Symphony_DI_PhpDumper_Test_Frozen_No_Aliases();
    ...
    public function testEnvParameter()
    {
        ...
        $this->assertStringEqualsFile(self::$fixturesPath.'/php/services26.php', $dumper->dump(array('class' => 'Symphony_DI_PhpDumper_Test_EnvParameters', 'file' => self::$fixturesPath.'/php/services26.php')));

        require self::$fixturesPath.'/php/services26.php';
        $container = new \Symphony_DI_PhpDumper_Test_EnvParameters();
    ...
    public function testDumpedBase64EnvParameters()
    {
        ...
        $this->assertStringEqualsFile(self::$fixturesPath.'/php/services_base64_env.php', $dumper->dump(array('class' => 'Symphony_DI_PhpDumper_Test_Base64Parameters')));

        require self::$fixturesPath.'/php/services_base64_env.php';
        $container = new \Symphony_DI_PhpDumper_Test_Base64Parameters();
    ...
    public function testDumpedCsvEnvParameters()
    {
        ...
        $this->assertStringEqualsFile(self::$fixturesPath.'/php/services_csv_env.php', $dumper->dump(array('class' => 'Symphony_DI_PhpDumper_Test_CsvParameters')));

        require self::$fixturesPath.'/php/services_csv_env.php';
        $container = new \Symphony_DI_PhpDumper_Test_CsvParameters();
    ...
    public function testDumpedJsonEnvParameters()
    {
        ...
        $this->assertStringEqualsFile(self::$fixturesPath.'/php/services_json_env.php', $dumper->dump(array('class' => 'Symphony_DI_PhpDumper_Test_JsonParameters')));

        putenv('foobar="hello"');
        require self::$fixturesPath.'/php/services_json_env.php';
        $container = new \Symphony_DI_PhpDumper_Test_JsonParameters();
        $this->assertSame(array('foo', 'bar'), $container->getParameter('hello'));
    ...
    public function testCustomEnvParameters()
    {
        ...
        $this->assertStringEqualsFile(self::$fixturesPath.'/php/services_rot13_env.php', $dumper->dump(array('class' => 'Symphony_DI_PhpDumper_Test_Rot13Parameters')));

        require self::$fixturesPath.'/php/services_rot13_env.php';
        $container = new \Symphony_DI_PhpDumper_Test_Rot13Parameters();
        $this->assertSame('world', $container->getParameter('hello'));
    }
    ...
    /**
     * @expectedException \Symphony\Component\DependencyInjection\Exception\EnvParameterException
    ...
    /**
     * @expectedException \Symphony\Component\DependencyInjection\Exception\ParameterCircularReferenceException
    ...
    public function testInitializePropertiesBeforeMethodCalls()
    {
        ...
        $dumper = new PhpDumper($container);
        eval('?>'.$dumper->dump(array('class' => 'Symphony_DI_PhpDumper_Test_Properties_Before_Method_Calls')));

        $container = new \Symphony_DI_PhpDumper_Test_Properties_Before_Method_Calls();
    ...
    public function testLazyArgumentProvideGenerator()
    {
        ...
        $dumper = new PhpDumper($container);
        eval('?>'.$dumper->dump(array('class' => 'Symphony_DI_PhpDumper_Test_Lazy_Argument_Provide_Generator')));

        $container = new \Symphony_DI_PhpDumper_Test_Lazy_Argument_Provide_Generator();
        ...
        foreach ($lazyContext->lazyValues as $k => $v) {
            switch (++$i) {
                ...
                case 1:
                    ...
                    $this->assertInstanceOf('Symphony_DI_PhpDumper_Test_Lazy_Argument_Provide_Generator', $v);
                    break;
            }
        }
    ...
    public function testPrivateWithIgnoreOnInvalidReference()
    {
        ...
        $container->register('bar', 'BarClass')
            ->setPublic(true)
            ->addMethodCall('setBaz', array(new Reference('not_invalid', SymphonyContainerInterface::IGNORE_ON_INVALID_REFERENCE)));
        $container->compile();

        $dumper = new PhpDumper($container);
        eval('?>'.$dumper->dump(array('class' => 'Symphony_DI_PhpDumper_Test_Private_With_Ignore_On_Invalid_Reference')));

        $container = new \Symphony_DI_PhpDumper_Test_Private_With_Ignore_On_Invalid_Reference();
    ...
    public function testUninitializedReference()
    {
        ...
        $this->assertStringEqualsFile(self::$fixturesPath.'/php/services_uninitialized_ref.php', $dumper->dump(array('class' => 'Symphony_DI_PhpDumper_Test_Uninitialized_Reference')));

        require self::$fixturesPath.'/php/services_uninitialized_ref.php';

        $container = new \Symphony_DI_PhpDumper_Test_Uninitialized_Reference();
    ...
    public function testAlmostCircular($visibility)
    {
        ...
        $container = 'Symphony_DI_PhpDumper_Test_Almost_Circular_'.ucfirst($visibility);
    ...
    public function testDumpHandlesLiteralClassWithRootNamespace()
    {
        ...
        $dumper = new PhpDumper($container);
        eval('?>'.$dumper->dump(array('class' => 'Symphony_DI_PhpDumper_Test_Literal_Class_With_Root_Namespace')));

        $container = new \Symphony_DI_PhpDumper_Test_Literal_Class_With_Root_Namespace();
    ...
    public function testDumpHandlesObjectClassNames()
    {
        ...
        $dumper = new PhpDumper($container);
        eval('?>'.$dumper->dump(array(
            'class' => 'Symphony_DI_PhpDumper_Test_Object_Class_Name',
            'inline_class_loader_parameter' => 'inline_requires',
        )));

        $container = new \Symphony_DI_PhpDumper_Test_Object_Class_Name();
    ...
    public function testPrivateServiceTriggersDeprecation()
    {
        ...
        $dumper = new PhpDumper($container);
        eval('?>'.$dumper->dump(array('class' => 'Symphony_DI_PhpDumper_Test_Private_Service_Triggers_Deprecation')));

        $container = new \Symphony_DI_PhpDumper_Test_Private_Service_Triggers_Deprecation();
    ...
    public function testParameterWithMixedCase()
    {
        ...
        $dumper = new PhpDumper($container);
        eval('?>'.$dumper->dump(array('class' => 'Symphony_DI_PhpDumper_Test_Parameter_With_Mixed_Case')));

        $container = new \Symphony_DI_PhpDumper_Test_Parameter_With_Mixed_Case();
    ...
    public function testErroredDefinition()
    {
        ...
        $container->compile();
        $dumper = new PhpDumper($container);
        $dump = $dumper->dump(array('class' => 'Symphony_DI_PhpDumper_Errored_Definition'));
        ...
        $container = new \Symphony_DI_PhpDumper_Errored_Definition();
