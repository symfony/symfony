...
class CacheLoaderTest extends TestCase
{
    public function testConstructor()
    {
        ...
        self::assertSame($loader->getLoader(), $varLoader, '__construct() takes a template loader as its first argument');
        self::assertEquals(sys_get_temp_dir(), $loader->getDir(), '__construct() takes a directory where to store the cache as its second argument');
    }
    ...
    public function testLoad()
    {
        ...
        self::assertFalse($loader->load(new TemplateReference('foo', 'php')), '->load() returns false if the embed loader is not able to load the template');
