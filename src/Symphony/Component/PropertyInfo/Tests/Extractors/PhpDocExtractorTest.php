...
namespace Symphony\Component\PropertyInfo\Tests\PhpDocExtractors;
...
class PhpDocExtractorTest extends TestCase
{
    ...
    {
        $this->assertEquals($type, $this->extractor->getTypes('Symphony\Component\PropertyInfo\Tests\Fixtures\Dummy', $property));
        $this->assertSame($shortDescription, $this->extractor->getShortDescription('Symphony\Component\PropertyInfo\Tests\Fixtures\Dummy', $property));
        $this->assertSame($longDescription, $this->extractor->getLongDescription('Symphony\Component\PropertyInfo\Tests\Fixtures\Dummy', $property));
    }
    ...
    public function typesProvider()
    {
        return array(
            ...
            array('parent', array(new Type(Type::BUILTIN_TYPE_OBJECT, false, 'Symphony\Component\PropertyInfo\Tests\Fixtures\ParentDummy')), null, null),
            ...
            array('b', array(new Type(Type::BUILTIN_TYPE_OBJECT, true, 'Symphony\Component\PropertyInfo\Tests\Fixtures\ParentDummy')), 'B.', null),
    ...
    public function testExtractTypesWithCustomPrefixes($property, array $type = null)
    {
        ...
        $this->assertEquals($type, $customExtractor->getTypes('Symphony\Component\PropertyInfo\Tests\Fixtures\Dummy', $property));
    }
    ...
    public function testExtractTypesWithNoPrefixes($property, array $type = null)
    {
        ...
        $this->assertEquals($type, $noPrefixExtractor->getTypes('Symphony\Component\PropertyInfo\Tests\Fixtures\Dummy', $property));
    }
