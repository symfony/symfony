...
namespace Symphony\Bundle\FrameworkBundle\Tests\Console;
...
class ApplicationTest extends TestCase
{
    ...
    {
        $command = $this->getMockForAbstractClass('Symphony\Bundle\FrameworkBundle\Command\ContainerAwareCommand', array('foo'), '', true, true, true, array('setContainer'));
