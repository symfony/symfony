...
use Symphony\Component\Console\Helper\TableStyle;
...
TABLE;
     ...
     * @expectedExceptionMessage Output should be an instance of "Symphony\Component\Console\Output\ConsoleSectionOutput" when calling "Symphony\Component\Console\Helper\Table::appendRow".
     */
