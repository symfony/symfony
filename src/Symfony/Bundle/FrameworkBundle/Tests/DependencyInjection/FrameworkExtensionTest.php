...
abstract class FrameworkExtensionTest extends TestCase
{
    ...
    private function assertPathPackage(ContainerBuilder $container, $package, $basePath, $version, $format)
    {
    ...
    private function assertUrlPackage(ContainerBuilder $container, $package, $baseUrls, $version, $format)
    {
    ...
    private function assertCachePoolServiceDefinitionIsCreated(ContainerBuilder $container, $id, $adapter, $defaultLifetime)
    {
        ...
        $this->assertInstanceOf(class_exists(ChildDefinition::class) ? ChildDefinition::class : DefinitionDecorator::class, $poolDefinition, sprintf('Cache pool "%s" is based on an abstract cache pool.', $id));
        ...
        } while ($parentDefinition instanceof DefinitionDecorator || $parentDefinition instanceof ChildDefinition);
