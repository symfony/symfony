...
class ClosureLoaderTest extends TestCase
{
    public function testSupports(): void
    {
        ...
        $this->assertTrue($loader->supports(static function ($container): void {}), '->supports() returns true if the resource is loadable');
    ...
    public function testLoad(): void
    {
        ...
        $loader->load(static function ($container, $env): void {
