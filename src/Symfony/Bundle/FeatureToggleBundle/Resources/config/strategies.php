...
return static function (ContainerConfigurator $container) {
    ...
    $services->set($prefix.'request_attribute', RequestStackAttributeStrategy::class)->abstract()->args([
        ...
        '$requestStack' => service('request_stack')->nullOnInvalid(),
    ]);
    $services->set($prefix.'native_request_header', RequestHeaderStrategy::class)->abstract()->args([
        '$headerName' => abstract_arg('Defined in FeatureToggleExtension'),
    ]);
    $services->set($prefix.'native_request_query', RequestQueryStrategy::class)->abstract()->args([
