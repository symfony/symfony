...
class UploadedFile extends File
{
     ...
     *
     * @param $path         The full temporary path to the file
     * @param $originalName The original file name of the uploaded file
     * @param $mimeType     The type of the file as provided by PHP; null defaults to application/octet-stream
     * @param $error        The error constant of the upload (one of PHP's UPLOAD_ERR_XXX constants); null defaults to UPLOAD_ERR_OK
     * @param $test         Whether the test mode is active
