...
class YamlFileLoader extends FileLoader
{
    ...
    protected function loadFile($file)
    {
        if (!class_exists('Symphony\Component\Yaml\Parser')) {
            throw new RuntimeException('Unable to load YAML config files as the Symphony Yaml Component is not installed.');
        }
    ...
    private function resolveServices($value, $file, $isParameter = false)
    {
        ...
        if (is_array($value)) {
            ...
            if (!class_exists(Expression::class)) {
                throw new \LogicException(sprintf('The "@=" expression syntax cannot be used without the ExpressionLanguage component. Try running "composer require symphony/expression-language".'));
            }
