 ...
 * deprecated `Symphony\Bundle\TwigBundle\Command\DebugCommand`, use `Symphony\Bridge\Twig\Command\DebugCommand` instead
 * deprecated relying on the `ContainerAwareInterface` implementation for `Symphony\Bundle\TwigBundle\Command\LintCommand`
 ...
 * moved the exception controller to be a service (`twig.controller.exception:showAction` vs `Symphony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction`)
