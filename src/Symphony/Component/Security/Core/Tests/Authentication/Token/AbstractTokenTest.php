...
class AbstractTokenTest extends TestCase
{
    ...
    {
        $user = $this->getMockBuilder('Symphony\Component\Security\Core\User\UserInterface')->getMock();
        $advancedUser = $this->getMockBuilder('Symphony\Component\Security\Core\User\AdvancedUserInterface')->getMock();
    ...
    {
        return $this->getMockForAbstractClass('Symphony\Component\Security\Core\Authentication\Token\AbstractToken', array($roles));
    }
}
