...
class DoctrineOrmTypeGuesserTest extends TestCase
{
    ...
    {
        yield [Types::DATE_IMMUTABLE, new TypeGuess('Symfony\Component\Form\Extension\Core\Type\DateType', ['input' => 'datetime_immutable'], AbstractGuess::HIGH_CONFIDENCE)];
        yield [Types::DATE_MUTABLE, new TypeGuess('Symfony\Component\Form\Extension\Core\Type\DateType', [], AbstractGuess::HIGH_CONFIDENCE)];

        yield [Types::TIME_IMMUTABLE, new TypeGuess('Symfony\Component\Form\Extension\Core\Type\TimeType', ['input' => 'datetime_immutable'], AbstractGuess::HIGH_CONFIDENCE)];
        yield [Types::TIME_MUTABLE, new TypeGuess('Symfony\Component\Form\Extension\Core\Type\TimeType', [], AbstractGuess::HIGH_CONFIDENCE)];

        yield [Types::DATETIME_IMMUTABLE, new TypeGuess('Symfony\Component\Form\Extension\Core\Type\DateTimeType', ['input' => 'datetime_immutable'], AbstractGuess::HIGH_CONFIDENCE)];
        yield [Types::DATETIMETZ_IMMUTABLE, new TypeGuess('Symfony\Component\Form\Extension\Core\Type\DateTimeType', ['input' => 'datetime_immutable'], AbstractGuess::HIGH_CONFIDENCE)];
        yield [Types::DATETIME_MUTABLE, new TypeGuess('Symfony\Component\Form\Extension\Core\Type\DateTimeType', [], AbstractGuess::HIGH_CONFIDENCE)];
        yield [Types::DATETIMETZ_MUTABLE, new TypeGuess('Symfony\Component\Form\Extension\Core\Type\DateTimeType', [], AbstractGuess::HIGH_CONFIDENCE)];
    }
    ...
    public function requiredProvider()
    {
        ...
        $return[] = [$classMetadata, new ValueGuess(true, AbstractGuess::HIGH_CONFIDENCE)];
        ...
        $return[] = [$classMetadata, new ValueGuess(false, AbstractGuess::MEDIUM_CONFIDENCE)];
        ...
        $return[] = [$classMetadata, new ValueGuess(false, AbstractGuess::HIGH_CONFIDENCE)];
