...
namespace Symphony\Component\PropertyInfo\Tests\Extractor;

use PHPUnit\Framework\TestCase;
use Symphony\Component\PropertyInfo\Extractor\ReflectionExtractor;
use Symphony\Component\PropertyInfo\Tests\Fixtures\AdderRemoverDummy;
...
class ReflectionExtractorTest extends TestCase
{
    ...
    public function testGetProperties()
    {
        $this->assertSame(
            ...
            $this->extractor->getProperties('Symphony\Component\PropertyInfo\Tests\Fixtures\Dummy')
        );

        $this->assertNull($this->extractor->getProperties('Symphony\Component\PropertyInfo\Tests\Fixtures\NoProperties'));
    }
    ...
    public function testGetPropertiesWithCustomPrefixes()
    {
        ...
        $this->assertSame(
            ...
            $customExtractor->getProperties('Symphony\Component\PropertyInfo\Tests\Fixtures\Dummy')
        );
    }
    ...
    public function testGetPropertiesWithNoPrefixes()
    {
        ...
        $this->assertSame(
            ...
            $noPrefixExtractor->getProperties('Symphony\Component\PropertyInfo\Tests\Fixtures\Dummy')
        );
    }
    ...
    public function testGetPropertiesPhp71()
    {
        ...
        $this->assertSame(
            ...
            $noPrefixExtractor->getProperties('Symphony\Component\PropertyInfo\Tests\Fixtures\Php71Dummy')
        );
    }
    ...
    {
        $this->assertEquals($type, $this->extractor->getTypes('Symphony\Component\PropertyInfo\Tests\Fixtures\Dummy', $property, array()));
    }
    ...
    public function typesProvider()
    {
        return array(
            array('a', null),
            array('b', array(new Type(Type::BUILTIN_TYPE_OBJECT, true, 'Symphony\Component\PropertyInfo\Tests\Fixtures\ParentDummy'))),
    ...
    {
        $this->assertEquals($type, $this->extractor->getTypes('Symphony\Component\PropertyInfo\Tests\Fixtures\Php7Dummy', $property, array()));
    }
    ...
    {
        $this->assertEquals($type, $this->extractor->getTypes('Symphony\Component\PropertyInfo\Tests\Fixtures\Php71Dummy', $property, array()));
    }
    ...
    public function testExtractPhp71TypeWithParentConstructor()
    {
        ...
        $this->assertEquals($type, $this->extractor->getTypes('Symphony\Component\PropertyInfo\Tests\Fixtures\Php71DummyChild', $property, array()));
        $this->assertEquals($type, $this->extractor->getTypes('Symphony\Component\PropertyInfo\Tests\Fixtures\Php71DummyChild2', $property, array()));
        $this->assertEquals($type, $this->extractor->getTypes('Symphony\Component\PropertyInfo\Tests\Fixtures\Php71DummyChild3', $property, array()));
    }
    ...
    public function testIsReadable($property, $expected)
    {
        $this->assertSame(
            $expected,
            $this->extractor->isReadable('Symphony\Component\PropertyInfo\Tests\Fixtures\Dummy', $property, array())
        );
    }
    ...
    public function testIsWritable($property, $expected)
    {
        $this->assertSame(
            $expected,
            $this->extractor->isWritable('Symphony\Component\PropertyInfo\Tests\Fixtures\Dummy', $property, array())
        );
    }
