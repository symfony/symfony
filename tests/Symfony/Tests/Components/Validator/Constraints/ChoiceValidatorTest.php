...
class ChoiceValidatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $interpolator = $this->getMock('Symfony\Components\Validator\MessageInterpolator\MessageInterpolatorInterface');
        $walker = $this->getMock('Symfony\Components\Validator\GraphWalker', array(), array(), '', false);
        $factory = $this->getMock('Symfony\Components\Validator\Mapping\ClassMetadataFactoryInterface');
