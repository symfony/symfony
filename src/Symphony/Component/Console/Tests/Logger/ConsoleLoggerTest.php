...
namespace Symphony\Component\Console\Tests\Logger;
...
use Symphony\Component\Console\Tests\Fixtures\DummyOutput;
...
class ConsoleLoggerTest extends TestCase
{
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('Symphony\Component\Console\Tests\Logger\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('Symphony\Component\Console\Tests\Logger\DummyTest', array('__toString'));
        }
