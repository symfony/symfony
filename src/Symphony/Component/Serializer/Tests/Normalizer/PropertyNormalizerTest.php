...
use Symphony\Component\Serializer\Tests\Fixtures\GroupDummyChild;
use Symphony\Component\Serializer\Tests\Fixtures\MaxDepthDummy;
use Symphony\Component\Serializer\Tests\Fixtures\PropertyCircularReferenceDummy;
use Symphony\Component\Serializer\Tests\Fixtures\PropertySiblingHolder;
...
class PropertyNormalizerTest extends TestCase
{
    ...
    {
        $this->serializer = $this->getMockBuilder('Symphony\Component\Serializer\SerializerInterface')->getMock();
    ...
    public function testNormalizeWithParentClass()
    {
        ...
        $this->assertEquals(
            array('foo' => 'foo', 'bar' => 'bar', 'kevin' => 'Kevin',
                  'coopTilleuls' => 'coop', 'fooBar' => null, 'symphony' => null, 'baz' => 'baz', ),
    ...
    public function testDenormalizeWithParentClass()
    {
        ...
        $this->assertNull($obj->getSymphony());
    }
    ...
    public function testGroupsDenormalizeWithNameConverter()
    {
        ...
        $this->assertEquals(
            ...
            ), 'Symphony\Component\Serializer\Tests\Fixtures\GroupDummy', null, array(PropertyNormalizer::GROUPS => array('name_converter')))
        );
    }
    ...
    public function testCircularReferenceHandler()
    {
        ...
        $expected = array('me' => 'Symphony\Component\Serializer\Tests\Fixtures\PropertyCircularReferenceDummy');
