...
namespace Symphony\Bundle\WebProfilerBundle\Tests\EventListener;

use PHPUnit\Framework\TestCase;
use Symphony\Bundle\WebProfilerBundle\EventListener\WebDebugToolbarListener;
use Symphony\Component\HttpFoundation\HeaderBag;
...
class WebDebugToolbarListenerTest extends TestCase
{
    ...
    {
        $request = $this->getMockBuilder('Symphony\Component\HttpFoundation\Request')->setMethods(array('getSession', 'isXmlHttpRequest', 'getRequestFormat'))->disableOriginalConstructor()->getMock();
    ...
    {
        return $this->getMockBuilder('Symphony\Component\Routing\Generator\UrlGeneratorInterface')->getMock();
    }

    protected function getKernelMock()
    {
        return $this->getMockBuilder('Symphony\Component\HttpKernel\Kernel')->disableOriginalConstructor()->getMock();
    }
}
