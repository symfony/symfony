...
namespace Symphony\Component\Security\Core\Tests\Validator\Constraints;
...
use Symphony\Component\Security\Core\Encoder\PasswordEncoderInterface;
use Symphony\Component\Security\Core\Validator\Constraints\UserPassword;
use Symphony\Component\Security\Core\Validator\Constraints\UserPasswordValidator;
...
abstract class UserPasswordValidatorTest extends ConstraintValidatorTestCase
{
    ...
    {
        $mock = $this->getMockBuilder('Symphony\Component\Security\Core\User\UserInterface')->getMock();
    ...
    {
        return $this->getMockBuilder('Symphony\Component\Security\Core\Encoder\PasswordEncoderInterface')->getMock();
    }

    protected function createEncoderFactory($encoder = null)
    {
        $mock = $this->getMockBuilder('Symphony\Component\Security\Core\Encoder\EncoderFactoryInterface')->getMock();
    ...
    protected function createTokenStorage($user = null)
    {
        ...
        $mock = $this->getMockBuilder('Symphony\Component\Security\Core\Authentication\Token\Storage\TokenStorageInterface')->getMock();
        $mock
            ->expects($this->any())
            ->method('getToken')
    ...
    {
        $mock = $this->getMockBuilder('Symphony\Component\Security\Core\Authentication\Token\TokenInterface')->getMock();
        $mock
            ->expects($this->any())
            ->method('getUser')
