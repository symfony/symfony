...
use Symphony\Component\DomCrawler\Form;
use Symphony\Component\DomCrawler\FormFieldRegistry;
...
class FormTest extends TestCase
{
    public static function setUpBeforeClass()
    {
        ...
        class_exists('Symphony\\Component\\DomCrawler\\Form');
    }
    ...
    public function testGet()
    {
        ...
        $this->assertInstanceOf('Symphony\\Component\\DomCrawler\\Field\\InputFormField', $form->get('bar'), '->get() returns the field object associated with the given name');
    ...
    public function testAll()
    {
        ...
        $this->assertInstanceOf('Symphony\\Component\\DomCrawler\\Field\\InputFormField', $fields['bar'], '->all() return an array of form field objects');
    }
    ...
    public function testDifferentFieldTypesWithSameName()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\DomCrawler\Field\ChoiceFormField', $form->get('option'));
    }

    protected function getFormFieldMock($name, $value = null)
    {
        $field = $this
            ->getMockBuilder('Symphony\\Component\\DomCrawler\\Field\\FormField')
