...
use Symphony\Component\Form\Tests\AbstractDivLayoutTest;
...
class FormExtensionDivLayoutTest extends AbstractDivLayoutTest
{
    ...
    public function testIsChoiceSelected($expected, $choice, $value)
    {
        ...
        $this->assertSame($expected, \Symphony\Bridge\Twig\Extension\twig_is_selected_choice($choice, $value));
    }
    ...
    {
        $this->assertSame($expected, \Symphony\Bridge\Twig\Extension\twig_is_root_form($formView));
    }
