...
use Symphony\Bundle\FrameworkBundle\Templating\DelegatingEngine;
...
class DelegatingEngineTest extends TestCase
{
    ...
    public function testRenderResponseWithTemplatingEngine()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\HttpFoundation\Response', $delegatingEngine->renderResponse('template.php', array('foo' => 'bar')));
    }
    ...
    {
        $engine = $this->getMockBuilder('Symphony\Bundle\FrameworkBundle\Templating\EngineInterface')->getMock();
