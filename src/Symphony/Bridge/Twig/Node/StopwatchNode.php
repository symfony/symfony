...
class StopwatchNode extends Node
{
    ...
    public function compile(Compiler $compiler)
    {
        $compiler
            ...
            ->write(";\n")
            ->write("\$this->env->getExtension('Symphony\Bridge\Twig\Extension\StopwatchExtension')->getStopwatch()->start(")
            ->subcompile($this->getNode('var'))
            ->raw(", 'template');\n")
            ->subcompile($this->getNode('body'))
            ->write("\$this->env->getExtension('Symphony\Bridge\Twig\Extension\StopwatchExtension')->getStopwatch()->stop(")
            ->subcompile($this->getNode('var'))
            ->raw(");\n")
        ;
    }
