...
class RedisClusterProxy extends \RedisCluster implements ResetInterface, LazyObjectInterface
{
    ...
    public function info($key_or_address = null, ...$sections): \RedisCluster|array|false
    {
    ...
    public function object($subcommand = null, $key = null): \RedisCluster|false|int|string
    {
    ...
    public function unsubscribe($channels, ...$other_channels): array|bool
    {
    ...
    public function xclaim($key, $group, $consumer, $min_iddle, $ids, $options = null): \RedisCluster|array|false|string
    {
    ...
    public function zrange($key, $start, $end, $scores = null, $options = null): \RedisCluster|array|bool
    {
    ...
    public function zrevrange($key, $min, $max, $scores = null, $options = null): \RedisCluster|array|bool
    {
        return $this->initializeLazyObject()->zrevrange(...\func_get_args());
    }

    public function zrevrangebylex($key, $min, $max, $offset = -1, $limit = -1, $options = null): \RedisCluster|array|bool
    {
