...
use Symphony\Component\PropertyInfo\Extractor\PhpDocExtractor;
use Symphony\Component\PropertyInfo\Extractor\ReflectionExtractor;
...
use Symphony\Component\Serializer\Normalizer\DateTimeNormalizer;
...
use Symphony\Component\Serializer\Tests\Fixtures\CircularReferenceDummy;
use Symphony\Component\Serializer\Tests\Fixtures\MaxDepthDummy;
use Symphony\Component\Serializer\Tests\Fixtures\SiblingHolder;
...
use Symphony\Component\Serializer\Tests\Fixtures\GroupDummy;
...
class ObjectNormalizerTest extends TestCase
{
    ...
    /**
     * @expectedException \Symphony\Component\Serializer\Exception\MissingConstructorArgumentsException
     * @expectedExceptionMessage Cannot create an instance of Symphony\Component\Serializer\Tests\Normalizer\DummyValueObject from serialized data because its constructor requires parameter "bar" to be present.
     */
    ...
    public function testGroupsDenormalize()
    {
        ...
        $normalized = $this->normalizer->denormalize(
            $toNormalize,
            'Symphony\Component\Serializer\Tests\Fixtures\GroupDummy',
            null,
    ...
    public function testGroupsDenormalizeWithNameConverter()
    {
        ...
        $this->assertEquals(
            ...
            ), 'Symphony\Component\Serializer\Tests\Fixtures\GroupDummy', null, array(ObjectNormalizer::GROUPS => array('name_converter')))
        );
    }
    ...
    {
        $serializer = $this->getMockBuilder('Symphony\Component\Serializer\SerializerInterface')->getMock();
    ...
    public function testCircularReferenceHandler()
    {
        ...
        $expected = array('me' => 'Symphony\Component\Serializer\Tests\Fixtures\CircularReferenceDummy');
    ...
    /**
     * @expectedException \Symphony\Component\Serializer\Exception\UnexpectedValueException
     * @expectedExceptionMessage The type of the "date" attribute for class "Symphony\Component\Serializer\Tests\Normalizer\ObjectOuter" must be one of "DateTimeInterface" ("string" given).
     */
