...
class DefinitionTest extends TestCase
{
    ...
    public function testSetGetDecoratedService()
    {
        ...
        $this->assertNull($def->getDecoratedService());
        $this->assertSame(array('decorated_service' => true), $def->getChanges());
    ...
    public function testSetGetFile()
    {
        ...
        $this->assertSame(array('file' => true), $def->getChanges());
    }
    ...
    public function testSetIsShared()
    {
        ...
        $this->assertSame(array('shared' => true), $def->getChanges());
    }
    ...
    public function testSetIsSynthetic()
    {
        ...
        $this->assertSame(array('synthetic' => true), $def->getChanges());
    }
    ...
    public function testSetIsAbstract()
    {
        ...
        $this->assertSame(array('abstract' => true), $def->getChanges());
    }
    ...
    public function testSetIsDeprecated()
    {
        ...
        $this->assertSame(array('deprecated' => true), $def->getChanges());
    }
    ...
    public function testSetGetConfigurator()
    {
        ...
        $this->assertSame(array('configurator' => true), $def->getChanges());
    }
    ...
    public function testGetChangesWithTrackChanges()
    {
        $def = new Definition();
        $def->setPublic(true);

        // make an untracked change!
        $def->setTrackChanges(false);
        $def->setSynthetic(true);
        $def->setTrackChanges(true);

        $def->setAbstract(true);

        $this->assertSame(array('public' => true, 'abstract' => true), $def->getChanges());
    }
}
