...
class DebugClassLoaderTest extends TestCase
{
    ...
    public function testReturnType()
    {
        ...
        $this->assertSame([
            ...
            'Method "Symfony\Component\ErrorHandler\Tests\Fixtures\ReturnTypeInterface::returnTypeInterfaceWithWillChangeAndVersion()" will add "string" as a native return type declaration in version 42.0.0. Do the same in implementation "Test\Symfony\Component\ErrorHandler\Tests\ReturnType" now to avoid errors.',
