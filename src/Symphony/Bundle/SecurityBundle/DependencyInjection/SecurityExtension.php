...
use Symphony\Bundle\SecurityBundle\DependencyInjection\Security\Factory\SecurityFactoryInterface;
...
class SecurityExtension extends Extension
{
    ...
    private function createFirewalls($config, ContainerBuilder $container)
    {
        ...
        if (!$customUserChecker) {
            $container->setAlias('Symphony\Component\Security\Core\User\UserCheckerInterface', new Alias('security.user_checker', false));
        }
    }
    ...
    private function createExpression($container, $expression)
    {
        ...
        $container
            ->register($id, 'Symphony\Component\ExpressionLanguage\SerializedParsedExpression')
            ->setPublic(false)
    ...
    private function createRequestMatcher($container, $path = null, $host = null, $methods = array(), $ip = null, array $attributes = array())
    {
        ...
        $container
            ->register($id, 'Symphony\Component\HttpFoundation\RequestMatcher')
            ->setPublic(false)
    ...
    {
        return 'http://symphony.com/schema/dic/security';
    }
