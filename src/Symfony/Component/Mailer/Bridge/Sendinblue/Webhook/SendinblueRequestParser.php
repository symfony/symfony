...
namespace Symfony\Component\Mailer\Bridge\Sendinblue\Webhook;
...
final class SendinblueRequestParser extends AbstractRequestParser
{
    public function __construct(
        private readonly SendinbluePayloadConverter $converter,
    ) {
    }
