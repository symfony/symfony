...
{
    /**
     * @param                   $callable The callable to autowire
     * @param                   $service  The service containing the callable to autowire
     * @param                   $method   The method name that will be autowired
