...
use Symphony\Component\Security\Core\Authorization\Voter\AuthenticatedVoter;
...
class AuthenticatedVoterTest extends TestCase
{
    ...
    protected function getResolver()
    {
        return new AuthenticationTrustResolver(
            'Symphony\\Component\\Security\\Core\\Authentication\\Token\\AnonymousToken',
            'Symphony\\Component\\Security\\Core\\Authentication\\Token\\RememberMeToken'
        );
    }
    ...
    protected function getToken($authenticated)
    {
        if ('fully' === $authenticated) {
            ...
            return $this->getMockBuilder('Symphony\Component\Security\Core\Authentication\Token\RememberMeToken')->setMethods(array('setPersistent'))->disableOriginalConstructor()->getMock();
        } else {
            return $this->getMockBuilder('Symphony\Component\Security\Core\Authentication\Token\AnonymousToken')->setConstructorArgs(array('', ''))->getMock();
        }
    }
}
