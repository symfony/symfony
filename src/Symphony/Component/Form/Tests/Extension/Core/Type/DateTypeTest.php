...
{
    const TESTED_TYPE = 'Symphony\Component\Form\Extension\Core\Type\DateType';
    ...
    public function testInitializeWithDateTime()
    {
        ...
        // to null in the type
        $this->assertInstanceOf('Symphony\Component\Form\FormInterface', $this->factory->create(static::TESTED_TYPE, new \DateTime()));
    }
