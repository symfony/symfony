...
class HelpCommandTest extends \PHPUnit_Framework_TestCase
{
    public function testExecuteForCommandAlias()
    {
        ...
        $this->assertRegExp('/list \[--format="\.\.\."\] \[--raw\] \[--xml\] \[namespace\]/', $commandTester->getDisplay(), '->execute() returns a text help for the given command alias');
    }
    ...
    public function testExecuteForCommand()
    {
        ...
        $this->assertRegExp('/list \[--format="\.\.\."\] \[--raw\] \[--xml\] \[namespace\]/', $commandTester->getDisplay(), '->execute() returns a text help for the given command');
    }
