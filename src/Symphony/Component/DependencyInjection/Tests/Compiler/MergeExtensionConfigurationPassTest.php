...
use Symphony\Component\DependencyInjection\Compiler\MergeExtensionConfigurationPass;
use Symphony\Component\DependencyInjection\Compiler\MergeExtensionConfigurationContainerBuilder;
...
class MergeExtensionConfigurationPassTest extends TestCase
{
    public function testExpressionLanguageProviderForwarding()
    {
        ...
        $extension = $this->getMockBuilder('Symphony\\Component\\DependencyInjection\\Extension\\ExtensionInterface')->getMock();
        ...
        $provider = $this->getMockBuilder('Symphony\\Component\\ExpressionLanguage\\ExpressionFunctionProviderInterface')->getMock();
     ...
     * @expectedExceptionMessage Using a cast in "env(int:FOO)" is incompatible with resolution at compile time in "Symphony\Component\DependencyInjection\Tests\Compiler\BarExtension". The logic in the extension should be moved to a compiler pass, or an env parameter with no cast should be used instead.
     */
