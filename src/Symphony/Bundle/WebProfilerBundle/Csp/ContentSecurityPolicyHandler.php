...
class ContentSecurityPolicyHandler
{
    ...
    {
        if ($request->headers->has('X-SymphonyProfiler-Script-Nonce') && $request->headers->has('X-SymphonyProfiler-Style-Nonce')) {
            return array(
                'csp_script_nonce' => $request->headers->get('X-SymphonyProfiler-Script-Nonce'),
                'csp_style_nonce' => $request->headers->get('X-SymphonyProfiler-Style-Nonce'),
            );
        }

        if ($response->headers->has('X-SymphonyProfiler-Script-Nonce') && $response->headers->has('X-SymphonyProfiler-Style-Nonce')) {
            return array(
                'csp_script_nonce' => $response->headers->get('X-SymphonyProfiler-Script-Nonce'),
                'csp_style_nonce' => $response->headers->get('X-SymphonyProfiler-Style-Nonce'),
            );
        }
        ...
        $response->headers->set('X-SymphonyProfiler-Script-Nonce', $nonces['csp_script_nonce']);
        $response->headers->set('X-SymphonyProfiler-Style-Nonce', $nonces['csp_style_nonce']);
    ...
    {
        $response->headers->remove('X-SymphonyProfiler-Script-Nonce');
        $response->headers->remove('X-SymphonyProfiler-Style-Nonce');
    }
