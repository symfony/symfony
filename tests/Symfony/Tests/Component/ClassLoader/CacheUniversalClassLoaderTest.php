...
use Symfony\Component\ClassLoader\CacheUniversalClassLoader;
use Symfony\Component\Cache\ApcCache;

/**
 * @group GH-1513
 */
class CacheUniversalClassLoaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $loader = new CacheUniversalClassLoader(new ApcCache(), 'test.prefix.');
   ...
   {
       $loader = new CacheUniversalClassLoader(new ApcCache(), 'test.prefix.fallback');
       $loader->registerNamespace('Apc\Namespaced', __DIR__.DIRECTORY_SEPARATOR.'Fixtures');
       $loader->registerPrefix('Apc_Pearlike_', __DIR__.DIRECTORY_SEPARATOR.'Fixtures');
   ...
   {
       $loader = new CacheUniversalClassLoader(new ApcCache(), 'test.prefix.collision');
