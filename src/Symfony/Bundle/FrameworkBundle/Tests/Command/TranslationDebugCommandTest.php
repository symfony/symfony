...
class TranslationDebugCommandTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->translationDir = sys_get_temp_dir().DIRECTORY_SEPARATOR.uniqid('sf2_translation');
        $this->fs->mkdir($this->translationDir.DIRECTORY_SEPARATOR.'Resources');
        $this->fs->mkdir($this->translationDir.DIRECTORY_SEPARATOR.'Resources'.DIRECTORY_SEPARATOR.'translations');
        $this->fs->mkdir($this->translationDir.DIRECTORY_SEPARATOR.'Resources'.DIRECTORY_SEPARATOR.'views');
    }
