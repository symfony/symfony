...
namespace Symphony\Bridge\Doctrine\Tests\DependencyInjection;
...
{
    /**
     * @var \Symphony\Bridge\Doctrine\DependencyInjection\AbstractDoctrineExtension
     */
    private $extension;
    ...
    protected function setUp()
    {
        ...
        $this->extension = $this
            ->getMockBuilder('Symphony\Bridge\Doctrine\DependencyInjection\AbstractDoctrineExtension')
            ->setMethods(array(
    ...
    /**
     * @return \Symphony\Component\DependencyInjection\ContainerBuilder
     */
    protected function createContainer(array $data = array())
    {
        return new ContainerBuilder(new ParameterBag(array_merge(array(
            'kernel.bundles' => array('FrameworkBundle' => 'Symphony\\Bundle\\FrameworkBundle\\FrameworkBundle'),
