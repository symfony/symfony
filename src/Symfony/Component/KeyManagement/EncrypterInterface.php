...
interface EncrypterInterface
{
     ...
     * @throws UnsupportedOperationException If `$aad` is non-empty and the backend cannot enforce it, or if `$deterministic` is true and the backend cannot offer it
