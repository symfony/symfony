...
use Symphony\Component\DomCrawler\Crawler;
...
class CrawlerTest extends TestCase
{
    ...
    public function testAddHtmlContentWithBaseTag()
    {
        ...
        $crawler->addHtmlContent('<html><head><base href="http://symphony.com"></head><a href="/contact"></a></html>', 'UTF-8');

        $this->assertEquals('http://symphony.com', $crawler->filterXPath('//base')->attr('href'), '->addHtmlContent() adds nodes from an HTML string');
        $this->assertEquals('http://symphony.com/contact', $crawler->filterXPath('//a')->link()->getUri(), '->addHtmlContent() adds nodes from an HTML string');
    }
    ...
    {
        $crawler = new Crawler(null, 'http://symphony.com');

        $crawler->addHtmlContent('<html><head><base target="_top"></head><a href="/contact"></a></html>', 'UTF-8');

        $this->assertEquals('http://symphony.com/contact', current($crawler->filterXPath('//a')->links())->getUri(), '->addHtmlContent() correctly handles a non-existent base tag href attribute');
    }
...
EOF
    ...
    public function testEq()
    {
        ...
        $this->assertInstanceOf('Symphony\\Component\\DomCrawler\\Crawler', $crawler, '->eq() returns a new instance of a crawler');
    ...
    public function testSlice()
    {
        ...
        $this->assertInstanceOf('Symphony\\Component\\DomCrawler\\Crawler', $crawler->slice(), '->slice() returns a new instance of a crawler');
    ...
    public function testReduce()
    {
        ...
        $this->assertInstanceOf('Symphony\\Component\\DomCrawler\\Crawler', $nodes, '->reduce() returns a new instance of a crawler');
    ...
    public function testFilterXPath()
    {
        ...
        $this->assertInstanceOf('Symphony\\Component\\DomCrawler\\Crawler', $crawler, '->filterXPath() returns a new instance of a crawler');
    ...
    public function testFilter()
    {
        ...
        $this->assertInstanceOf('Symphony\\Component\\DomCrawler\\Crawler', $crawler, '->filter() returns a new instance of a crawler');
    ...
    public function testSelectLink()
    {
        ...
        $this->assertInstanceOf('Symphony\\Component\\DomCrawler\\Crawler', $crawler, '->selectLink() returns a new instance of a crawler');
    ...
    public function testSelectImage()
    {
        ...
        $this->assertInstanceOf('Symphony\\Component\\DomCrawler\\Crawler', $crawler, '->selectImage() returns a new instance of a crawler');
    ...
    public function testSelectButton()
    {
        ...
        $this->assertInstanceOf('Symphony\\Component\\DomCrawler\\Crawler', $crawler, '->selectButton() returns a new instance of a crawler');
...
HTML;
    ...
    public function testLink()
    {
        ...
        $this->assertInstanceOf('Symphony\\Component\\DomCrawler\\Link', $crawler->link(), '->link() returns a Link instance');
    ...
    public function testImage()
    {
        ...
        $this->assertInstanceOf('Symphony\\Component\\DomCrawler\\Image', $crawler->image(), '->image() returns an Image instance');
...
HTML;
    ...
    public function testLinks()
    {
        ...
        $links = $crawler->links();
        $this->assertInstanceOf('Symphony\\Component\\DomCrawler\\Link', $links[0], '->links() returns an array of Link instances');
    ...
    public function testImages()
    {
        ...
        $this->assertInstanceOf('Symphony\\Component\\DomCrawler\\Image', $images[0], '->images() returns an array of Image instances');
    ...
    public function testForm()
    {
        ...
        $this->assertInstanceOf('Symphony\\Component\\DomCrawler\\Form', $crawler->form(), '->form() returns a Form instance');
        $this->assertInstanceOf('Symphony\\Component\\DomCrawler\\Form', $crawler2->form(), '->form() returns a Form instance');
    ...
    public function testLast()
    {
        ...
        $this->assertInstanceOf('Symphony\\Component\\DomCrawler\\Crawler', $crawler, '->last() returns a new instance of a crawler');
    ...
    public function testFirst()
    {
        ...
        $this->assertInstanceOf('Symphony\\Component\\DomCrawler\\Crawler', $crawler, '->first() returns a new instance of a crawler');
    ...
    public function testSiblings()
    {
        ...
        $this->assertInstanceOf('Symphony\\Component\\DomCrawler\\Crawler', $crawler, '->siblings() returns a new instance of a crawler');
    ...
    public function testNextAll()
    {
        ...
        $this->assertInstanceOf('Symphony\\Component\\DomCrawler\\Crawler', $crawler, '->nextAll() returns a new instance of a crawler');
    ...
    public function testPreviousAll()
    {
        ...
        $this->assertInstanceOf('Symphony\\Component\\DomCrawler\\Crawler', $crawler, '->previousAll() returns a new instance of a crawler');
    ...
    public function testChildren()
    {
        ...
        $this->assertInstanceOf('Symphony\\Component\\DomCrawler\\Crawler', $crawler, '->children() returns a new instance of a crawler');
    ...
    public function testParents()
    {
        ...
        $this->assertInstanceOf('Symphony\\Component\\DomCrawler\\Crawler', $crawler, '->parents() returns a new instance of a crawler');
