...
class Registry
{
     ...
     *
     * @deprecated since Symphony 4.1, use addWorkflow() instead
     */
    public function add(Workflow $workflow, $supportStrategy)
    {
        @trigger_error(sprintf('%s is deprecated since Symphony 4.1. Use addWorkflow() instead.', __METHOD__), E_USER_DEPRECATED);
