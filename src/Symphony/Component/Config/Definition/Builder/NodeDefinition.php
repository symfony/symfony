...
use Symphony\Component\Config\Definition\BaseNode;
    ...
    public function setPathSeparator(string $separator)
    {
        if ($this instanceof ParentNodeDefinitionInterface) {
            if (method_exists($this, 'getChildNodeDefinitions')) {
                ...
                @trigger_error('Passing a ParentNodeDefinitionInterface without getChildNodeDefinitions() is deprecated since Symphony 4.1.', E_USER_DEPRECATED);
            }
        }
