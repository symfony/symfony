...
{
    protected function assertIterator($expected, \Traversable $iterator): void
    {
     ...
     */
    protected function assertOrderedIteratorForGroups($expected, \Traversable $iterator): void
    {
     ...
     * @param \Traversable $iterator
     */
    protected function assertIteratorInForeach($expected, \Traversable $iterator): void
    {
        $values = array();
     ...
     * @param \Traversable $iterator
     */
    protected function assertOrderedIteratorInForeach($expected, \Traversable $iterator): void
    {
        $values = array();
        foreach ($iterator as $file) {
            $this->assertInstanceOf('Symfony\\Component\\Finder\\SplFileInfo', $file);
