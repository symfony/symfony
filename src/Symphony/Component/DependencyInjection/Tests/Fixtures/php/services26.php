 ...
 */
class Symphony_DI_PhpDumper_Test_EnvParameters extends Container
{
    private $parameters;
     ...
     *
     * @return \Symphony\Component\DependencyInjection\Tests\Fixtures\Bar
     */
    protected function getBarService()
    {
        return $this->services['bar'] = new \Symphony\Component\DependencyInjection\Tests\Fixtures\Bar($this->getEnv('QUZ'));
    }
