...
use Symphony\Component\DependencyInjection\Compiler\RegisterServiceSubscribersPass;
use Symphony\Component\DependencyInjection\Compiler\ResolveServiceSubscribersPass;
...
class RegisterServiceSubscribersPassTest extends TestCase
{
     ...
     * @expectedExceptionMessage Service "foo" must implement interface "Symphony\Component\DependencyInjection\ServiceSubscriberInterface".
     */
    ...
    /**
     * @expectedException \Symphony\Component\DependencyInjection\Exception\InvalidArgumentException
     * @expectedExceptionMessage Service key "test" does not exist in the map returned by "Symphony\Component\DependencyInjection\Tests\Fixtures\TestServiceSubscriber::getSubscribedServices()" for service "foo_service".
     */
