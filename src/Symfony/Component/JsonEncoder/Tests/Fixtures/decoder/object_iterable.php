...
return static function (string|\Stringable $string, \Psr\Container\ContainerInterface $denormalizers, \Symfony\Component\JsonEncoder\Decode\Instantiator $instantiator, array $options): mixed {
    $providers['iterable<int|string,Symfony\Component\JsonEncoder\Tests\Fixtures\Model\ClassicDummy>'] = static function ($data) use ($options, $denormalizers, $instantiator, &$providers) {
    ...
    return $providers['iterable<int|string,Symfony\Component\JsonEncoder\Tests\Fixtures\Model\ClassicDummy>'](\Symfony\Component\JsonEncoder\Decode\NativeDecoder::decodeString((string) $string));
};
