...
use Symphony\Bridge\Doctrine\Form\ChoiceList\ORMQueryBuilderLoader;
...
class ORMQueryBuilderLoaderTest extends TestCase
{
    ...
    {
        $this->checkIdentifierType('Symphony\Bridge\Doctrine\Tests\Fixtures\SingleStringIdEntity', Connection::PARAM_STR_ARRAY);
    }

    public function testIdentifierTypeIsIntegerArray()
    {
        $this->checkIdentifierType('Symphony\Bridge\Doctrine\Tests\Fixtures\SingleIntIdEntity', Connection::PARAM_INT_ARRAY);
    }
    ...
    public function testFilterNonIntegerValues()
    {
        ...
        $qb->select('e')
            ->from('Symphony\Bridge\Doctrine\Tests\Fixtures\SingleIntIdEntity', 'e');
    ...
    public function testEmbeddedIdentifierName()
    {
        ...
        $qb->select('e')
            ->from('Symphony\Bridge\Doctrine\Tests\Fixtures\EmbeddedIdentifierEntity', 'e');
    ...
    {
        return array(
            array('Symphony\Bridge\Doctrine\Tests\Fixtures\GuidIdEntity'),
            array('Symphony\Bridge\Doctrine\Tests\Fixtures\UuidIdEntity'),
        );
    }
}
