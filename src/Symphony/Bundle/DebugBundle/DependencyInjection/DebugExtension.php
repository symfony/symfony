...
namespace Symphony\Bundle\DebugBundle\DependencyInjection;

use Symphony\Bundle\DebugBundle\Command\ServerDumpPlaceholderCommand;
...
class DebugExtension extends Extension
{
    ...
    {
        return 'http://symphony.com/schema/dic/debug';
    }
}
