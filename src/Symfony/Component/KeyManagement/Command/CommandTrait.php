...
trait CommandTrait
{
     ...
     * @param ServiceProviderInterface<EncrypterInterface&DecrypterInterface>|null $clients
     *
     * @return (DataKeyGeneratorInterface&EncrypterInterface&DecrypterInterface)|int The resolved client, or a Command::* exit code on failure
     */
    private static function resolveDataKeyGenerator(?ServiceProviderInterface $clients, ?string $requested, SymfonyStyle $errorIo): (DataKeyGeneratorInterface&EncrypterInterface&DecrypterInterface)|int
    {
