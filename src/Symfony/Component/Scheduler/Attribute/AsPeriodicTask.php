...
{
    /**
     * @param                                     $frequency  A string (i.e. "every hour") or an integer (the number of seconds) representing the frequency of the task
     * @param                                     $from       A string representing the start time of the periodic task (i.e. "08:00:00")
     * @param                                     $until      A string representing the end time of the periodic task (i.e. "20:00:00")
     * @param                                     $jitter     The cron jitter, in seconds; for example, if set to 60, the cron
     ...
     * @param                                     $schedule   The name of the schedule responsible for triggering the task
     * @param                                     $method     The method to run as the task when the attribute target is a class
