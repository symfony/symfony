...
namespace Symphony\Bundle\FrameworkBundle\Tests\Translation;

use PHPUnit\Framework\TestCase;
use Psr\Container\ContainerInterface;
use Symphony\Bundle\FrameworkBundle\Translation\Translator;
use Symphony\Component\Translation\Formatter\MessageFormatter;
...
class TranslatorTest extends TestCase
{
    ...
    {
        $loader = $this->getMockBuilder('Symphony\Component\Translation\Loader\LoaderInterface')->getMock();
        $translator = $this->getTranslator($loader, array('cache_dir' => $this->tmpDir), 'loader', '\Symphony\Bundle\FrameworkBundle\Tests\Translation\TranslatorWithInvalidLocale');
    ...
    {
        $loader = new \Symphony\Component\Translation\Loader\YamlFileLoader();
        $resourceFiles = array(
            'fr' => array(
    ...
    public function getTranslator($loader, $options = array(), $loaderFomat = 'loader', $translatorClass = '\Symphony\Bundle\FrameworkBundle\Translation\Translator', $defaultLocale = 'en')
    {
    ...
    private function createTranslator($loader, $options, $translatorClass = '\Symphony\Bundle\FrameworkBundle\Translation\Translator', $loaderFomat = 'loader', $defaultLocale = 'en')
    {
