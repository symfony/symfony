...
namespace Symphony\Component\Dotenv\Tests;

use PHPUnit\Framework\TestCase;
use Symphony\Component\Dotenv\Dotenv;
...
class DotenvTest extends TestCase
{
    ...
    /**
     * @expectedException \Symphony\Component\Dotenv\Exception\PathException
     */
    ...
    public function testMemorizingLoadedVarsNamesInSpecialVar()
    {
        ...
        unset($_ENV['SYMPHONY_DOTENV_VARS']);
        unset($_SERVER['SYMPHONY_DOTENV_VARS']);
        putenv('SYMPHONY_DOTENV_VARS');
        ...
        $this->assertSame('APP_DEBUG,DATABASE_URL', getenv('SYMPHONY_DOTENV_VARS'));

        // Special variable has a value
        $_ENV['SYMPHONY_DOTENV_VARS'] = 'APP_ENV';
        $_SERVER['SYMPHONY_DOTENV_VARS'] = 'APP_ENV';
        putenv('SYMPHONY_DOTENV_VARS=APP_ENV');
        ...
        $this->assertSame('APP_ENV,DATABASE_URL', getenv('SYMPHONY_DOTENV_VARS'));
    }

    public function testOverridingEnvVarsWithNamesMemorizedInSpecialVar()
    {
        putenv('SYMPHONY_DOTENV_VARS=FOO,BAR,BAZ');
