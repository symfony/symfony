...
class ResolvedFormTypeTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->dataMapper = $this->getMockBuilder('Symphony\Component\Form\DataMapperInterface')->getMock();
    ...
    public function testCreateBuilder()
    {
        $givenOptions = array('a' => 'a_custom', 'c' => 'c_custom');
        $resolvedOptions = array('a' => 'a_custom', 'b' => 'b_default', 'c' => 'c_custom', 'd' => 'd_default');
        $optionsResolver = $this->getMockBuilder('Symphony\Component\OptionsResolver\OptionsResolver')->getMock();

        $this->resolvedType = $this->getMockBuilder('Symphony\Component\Form\ResolvedFormType')
    ...
    public function testCreateView()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\Form\FormView', $view);
     ...
     */
    private function getMockFormType($typeClass = 'Symphony\Component\Form\AbstractType')
    {
    ...
    {
        return $this->getMockBuilder('Symphony\Component\Form\AbstractTypeExtension')->setMethods(array('getExtendedType', 'configureOptions', 'finishView', 'buildView', 'buildForm'))->getMock();
    }
    ...
    {
        return $this->getMockBuilder('Symphony\Component\Form\FormFactoryInterface')->getMock();
    }
