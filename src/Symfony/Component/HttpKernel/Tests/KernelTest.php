...
class KernelTest extends TestCase
{
    ...
    public function testConstructor()
    {
        $mode = 'test_mode';
        $debug = true;
        $kernel = new KernelForTest($mode, $debug);

        $this->assertEquals($mode, $kernel->getMode());
    ...
    public function testClone()
    {
        ...
        $this->assertEquals($mode, $clone->getMode());
    ...
    public function testClassNameValidityGetter()
    {
        ...
        $this->expectExceptionMessage('The mode "test.mode" contains invalid characters, it can only contain characters allowed in PHP class names.');
        // We check the classname that will be generated by using a $mode that
        // contains invalid characters.
        $mode = 'test.mode';
        $kernel = new KernelForTest($mode, false, false);
...
EOF;
    ...
    public function testSerialize()
    {
        ...
        $debug = true;
        $kernel = new KernelForTest($mode, $debug);
        $expected = "O:57:\"Symfony\Component\HttpKernel\Tests\Fixtures\KernelForTest\":2:{s:7:\"\0*\0mode\";s:9:\"test_mode\";s:8:\"\0*\0debug\";b:1;}";
...
class CustomProjectDirKernel extends Kernel implements WarmableInterface
{
    ...
    public function __construct(\Closure $buildContainer = null, HttpKernelInterface $httpKernel = null, $mode = 'custom')
    {
        parent::__construct($mode, true);
