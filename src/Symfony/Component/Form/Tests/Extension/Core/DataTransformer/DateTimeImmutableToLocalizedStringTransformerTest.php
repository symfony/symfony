...
class DateTimeImmutableToLocalizedStringTransformerTest extends DateTimeImmutableTestCase
{
    protected $dateTime;
    ...
    public function testTransform($dateFormat, $timeFormat, $pattern, $output, $input)
    {
        ...
        $transformer = new DateTimeImmutableToLocalizedStringTransformer(
            'UTC',
            'UTC',
            $dateFormat,
            $timeFormat,
    ...
    public function testTransformFullTime()
    {
        ...
        $transformer = new DateTimeImmutableToLocalizedStringTransformer('UTC', 'UTC', null, \IntlDateFormatter::FULL);
    ...
    public function testTransformToDifferentLocale()
    {
        ...
        $transformer = new DateTimeImmutableToLocalizedStringTransformer('UTC', 'UTC');
    ...
    {
        $transformer = new DateTimeImmutableToLocalizedStringTransformer('America/New_York', 'Asia/Hong_Kong');
    ...
    {
        $transformer = new DateTimeImmutableToLocalizedStringTransformer('UTC', 'UTC', \IntlDateFormatter::FULL, \IntlDateFormatter::FULL, \IntlDateFormatter::GREGORIAN, 'MM*yyyy*dd HH|mm|ss');
    ...
    public function testReverseTransformFullTime()
    {
        ...
        $this->assertDateTimeImmutableEquals($this->dateTime, $transformer->reverseTransform('03.02.2010, 04:05:06 GMT+00:00'));
    }
    ...
    public function testReverseTransformFromDifferentLocale()
    {
        ...
        $this->assertDateTimeImmutableEquals($this->dateTimeWithoutSeconds, $transformer->reverseTransform('Feb 3, 2010, 04:05 AM'));
    }
    ...
    public function testReverseTransformWithDifferentTimezones()
    {
        ...
        $this->assertDateTimeImmutableEquals($dateTime, $transformer->reverseTransform('03.02.2010, 04:05'));
    }

    public function testReverseTransformOnlyDateWithDifferentTimezones()
    {
        $transformer = new DateTimeImmutableToLocalizedStringTransformer('Europe/Berlin', 'Pacific/Tahiti', \IntlDateFormatter::FULL, \IntlDateFormatter::FULL, \IntlDateFormatter::GREGORIAN, 'yyyy-MM-dd');

        $dateTime = new \DateTimeImmutable('2017-01-10 11:00', new \DateTimeZone('Europe/Berlin'));

        $this->assertDateTimeImmutableEquals($dateTime, $transformer->reverseTransform('2017-01-10'));
    }
    ...
    public function testReverseTransformWithDifferentPatterns()
    {
        ...
        $this->assertDateTimeImmutableEquals($this->dateTime, $transformer->reverseTransform('02*2010*03 04|05|06'));
    }

    public function testReverseTransformDateOnlyWithDstIssue()
    {
        $transformer = new DateTimeImmutableToLocalizedStringTransformer('Europe/Rome', 'Europe/Rome', \IntlDateFormatter::FULL, \IntlDateFormatter::FULL, \IntlDateFormatter::GREGORIAN, 'dd/MM/yyyy');

        $this->assertDateTimeImmutableEquals(
    ...
    {
        $transformer = new DateTimeImmutableToLocalizedStringTransformer('Europe/Rome', 'Europe/Rome', \IntlDateFormatter::FULL, \IntlDateFormatter::FULL, \IntlDateFormatter::GREGORIAN, "'day': dd 'month': MM 'year': yyyy");
    ...
    {
        $transformer = new DateTimeImmutableToLocalizedStringTransformer('UTC', 'UTC', \IntlDateFormatter::SHORT);

        $this->assertDateTimeImmutableEquals($this->dateTimeWithoutSeconds, $transformer->reverseTransform('31.04.10 04:05'));
    }
