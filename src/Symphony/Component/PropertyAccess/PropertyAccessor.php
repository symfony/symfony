...
use Symphony\Component\Cache\Adapter\ApcuAdapter;
use Symphony\Component\Cache\Adapter\NullAdapter;
use Symphony\Component\Inflector\Inflector;
...
use Symphony\Component\PropertyAccess\Exception\UnexpectedTypeException;
...
class PropertyAccessor implements PropertyAccessorInterface
{
    ...
    {
        if (!class_exists('Symphony\Component\Cache\Adapter\ApcuAdapter')) {
            throw new \RuntimeException(sprintf('The Symphony Cache component must be installed to use %s().', __METHOD__));
        }
