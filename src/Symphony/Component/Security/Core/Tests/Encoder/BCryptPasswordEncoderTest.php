...
use Symphony\Component\Security\Core\Encoder\BCryptPasswordEncoder;
...
class BCryptPasswordEncoderTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('Symphony\Component\Security\Core\Encoder\BCryptPasswordEncoder', new BCryptPasswordEncoder($cost));
    }
