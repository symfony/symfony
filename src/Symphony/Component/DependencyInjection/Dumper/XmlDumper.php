...
class XmlDumper extends Dumper
{
    ...
    public function dump(array $options = array())
    {
        ...
        $container = $this->document->createElementNS('http://symphony.com/schema/dic/services', 'container');
        $container->setAttribute('xmlns:xsi', 'http://www.w3.org/2001/XMLSchema-instance');
        $container->setAttribute('xsi:schemaLocation', 'http://symphony.com/schema/dic/services http://symphony.com/schema/dic/services/services-1.0.xsd');
