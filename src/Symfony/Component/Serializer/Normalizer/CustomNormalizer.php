...
class CustomNormalizer implements NormalizerInterface, DenormalizerInterface, SerializerAwareInterface, CacheableSupportsMethodInterface
{
    ...
    {
        return [
            NormalizableInterface::class => __CLASS__ === static::class || $this->hasCacheableSupportsMethod(false),
            DenormalizableInterface::class => __CLASS__ === static::class || $this->hasCacheableSupportsMethod(false),
        ];
    }
