...
{
    public const UNKNOWN_CURRENCY_ID = 'XXX';

    public const EUROPEAN_COMPOSITE_UNIT_ID = 'XBA';

    public const EUROPEAN_MONETARY_UNIT_ID = 'XBB';

    public const EUROPEAN_UNIT_OF_ACCOUNT_XBC_ID = 'XBC';

    public const EUROPEAN_UNIT_OF_ACCOUNT_XBD_ID = 'XBD';

    public const TESTING_CURRENCY_CODE_ID = 'XTS';

    public const ADB_UNIT_OF_ACCOUNT_ID = 'XUA';

    public const GOLD_ID = 'XAU';

    public const SILVER_ID = 'XAG';

    public const PLATINUM_ID = 'XPT';

    public const PALLADIUM_ID = 'XPD';

    public const SUCRE_ID = 'XSU';

    public const SPECIAL_DRAWING_RIGHTS_ID = 'XDR';
