            ...
            ->children()
                ->arrayNode('acl')
                    ->children()
                        ...
                        ->end()
                        ->scalarNode('object_identity_retrieval_strategy')
                            ->setInfo('name of a class implementing "Symfony\Component\Security\Acl\Model\ObjectIdentityRetrievalStrategyInterface"')
                        ->end()
                        ->arrayNode('cache')
                            ->addDefaultsIfNotSet()
                            ->children()
