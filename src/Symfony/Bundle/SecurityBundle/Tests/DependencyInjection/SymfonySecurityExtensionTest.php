...
use Symfony\Bundle\SecurityBundle\DependencyInjection\SymfonySecurityExtension;
use Symfony\Component\DependencyInjection\ContainerBuilder;

abstract class SymfonySecurityExtensionTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function getContainer($file)
    {
        ...
        $security = new SymfonySecurityExtension();
