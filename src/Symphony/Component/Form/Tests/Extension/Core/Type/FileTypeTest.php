...
use Symphony\Component\Form\NativeRequestHandler;
...
{
    const TESTED_TYPE = 'Symphony\Component\Form\Extension\Core\Type\FileType';

    // https://github.com/symphony/symphony/pull/5028
    public function testSetData()
    {
        $form = $this->factory->createBuilder(static::TESTED_TYPE)->getForm();
        $data = $this->getMockBuilder('Symphony\Component\HttpFoundation\File\File')
