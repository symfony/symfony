...
class FlysystemKmsFactoryTest extends TestCase
{
    ...
    public function testRejectsNonFlysystemSchemes()
    {
        ...
        $this->assertFalse($factory->supports(Dsn::fromString('hashicorp-vault-transit://x@host')));
    }

    public function testCreateOnUnsupportedSchemeThrows()
    {
        $this->expectException(UnsupportedSchemeException::class);
        (new FlysystemKmsFactory(new ServiceLocator([])))->create(Dsn::fromString('hashicorp-vault-transit://x@host'));
    }
