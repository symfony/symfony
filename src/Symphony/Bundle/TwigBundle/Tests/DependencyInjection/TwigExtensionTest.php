...
use Symphony\Bundle\TwigBundle\DependencyInjection\TwigExtension;
...
class TwigExtensionTest extends TestCase
{
    ...
    public function testStopwatchExtensionAvailability($debug, $stopwatchEnabled, $expected)
    {
        ...
        if ($stopwatchEnabled) {
            $container->register('debug.stopwatch', 'Symphony\Component\Stopwatch\Stopwatch');
        }
        $container->registerExtension(new TwigExtension());
        $container->loadFromExtension('twig', array(
            'strict_variables' => false, // to be removed in 5.0 relying on default
    ...
    public function testRuntimeLoader()
    {
        ...
        $this->assertArrayHasKey('Symphony\Component\Form\FormRenderer', $args);
        $this->assertArrayHasKey('FooClass', $args);
        $this->assertEquals('twig.form.renderer', $args['Symphony\Component\Form\FormRenderer']->getValues()[0]);
    ...
    private function createContainer()
    {
        $container = new ContainerBuilder(new ParameterBag(array(
            ...
            'kernel.bundles' => array(
                'TwigBundle' => 'Symphony\\Bundle\\TwigBundle\\TwigBundle',
            ),
