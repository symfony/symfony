...
use Symphony\Component\Security\Csrf\TokenStorage\SessionTokenStorage;
...
class SessionTokenStorageTest extends TestCase
{
    ...
    {
        $this->session = $this->getMockBuilder('Symphony\Component\HttpFoundation\Session\SessionInterface')
