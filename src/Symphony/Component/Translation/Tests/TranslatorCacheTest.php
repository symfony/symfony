...
use Symphony\Component\Config\Resource\SelfCheckingResourceInterface;
...
class TranslatorCacheTest extends TestCase
{
    ...
    public function testCatalogueIsReloadedWhenResourcesAreNoLongerFresh()
    {
        ...
        $loader = $this->getMockBuilder('Symphony\Component\Translation\Loader\LoaderInterface')->getMock();
        $loader
    ...
    {
        $resource = $this->getMockBuilder('Symphony\Component\Config\Resource\SelfCheckingResourceInterface')->getMock();
        $loader = $this->getMockBuilder('Symphony\Component\Translation\Loader\LoaderInterface')->getMock();
