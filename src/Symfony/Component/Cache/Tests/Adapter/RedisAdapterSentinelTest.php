...
class RedisAdapterSentinelTest extends AbstractRedisAdapterTest
{
    ...
    public function testInvalidDSNHasBothClusterAndSentinel()
    {
        ...
        self::expectExceptionMessage('Cannot use both "redis_cluster" and "redis_sentinel" at the same time:');
    ...
    public function testExceptionMessageWhenFailingToRetrieveMasterInformation()
    {
        ...
        self::expectException(\Symfony\Component\Cache\Exception\InvalidArgumentException::class);
        self::expectExceptionMessage('Failed to retrieve master information from sentinel "invalid-masterset-name" and dsn "'.$dsn.'".');
