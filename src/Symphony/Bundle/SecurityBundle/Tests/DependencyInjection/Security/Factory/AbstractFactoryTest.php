...
namespace Symphony\Bundle\SecurityBundle\Tests\DependencyInjection\Security\Factory;
...
class AbstractFactoryTest extends TestCase
{
    ...
    {
        $factory = $this->getMockForAbstractClass('Symphony\Bundle\SecurityBundle\DependencyInjection\Security\Factory\AbstractFactory', array());
