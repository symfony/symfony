...
use Symphony\Bundle\FrameworkBundle\Routing\Router;
...
class RouterTest extends TestCase
{
     ...
     * @expectedExceptionMessage You should either pass a "Symphony\Component\DependencyInjection\ContainerInterface" instance or provide the $parameters argument of the "Symphony\Bundle\FrameworkBundle\Routing\Router::__construct" method
     */
    public function testConstructThrowsOnNonSymphonyNorPsr11Container()
    {
    ...
    /**
     * @return \Symphony\Component\DependencyInjection\Container
     */
    private function getServiceContainer(RouteCollection $routes)
    {
        ...
        $sc = $this->getMockBuilder('Symphony\\Component\\DependencyInjection\\Container')->setMethods(array('get'))->getMock();
