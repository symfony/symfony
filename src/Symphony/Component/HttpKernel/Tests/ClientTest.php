...
use Symphony\Component\HttpKernel\Tests\Fixtures\TestClient;
...
class ClientTest extends TestCase
{
    public function testDoRequest()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\BrowserKit\Request', $client->getInternalRequest());
        $this->assertInstanceOf('Symphony\Component\HttpFoundation\Request', $client->getRequest());
        $this->assertInstanceOf('Symphony\Component\BrowserKit\Response', $client->getInternalResponse());
        $this->assertInstanceOf('Symphony\Component\HttpFoundation\Response', $client->getResponse());
    ...
    public function testUploadedFileWhenSizeExceedsUploadMaxFileSize()
    {
        ...
        $file = $this
            ->getMockBuilder('Symphony\Component\HttpFoundation\File\UploadedFile')
