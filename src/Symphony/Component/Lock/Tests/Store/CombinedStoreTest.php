...
use Symphony\Component\Lock\Strategy\UnanimousStrategy;
use Symphony\Component\Lock\Strategy\StrategyInterface;
use Symphony\Component\Lock\Store\CombinedStore;
...
class CombinedStoreTest extends AbstractStoreTest
{
    ...
    /**
     * @expectedException \Symphony\Component\Lock\Exception\LockConflictedException
     */
