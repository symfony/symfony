...
namespace Symphony\Component\Config\Definition\Dumper;
                ...
                if ($prototype instanceof PrototypedArrayNode) {
                    ...
                    if ($prototype->hasDefaultValue()) {
                        ...
                        switch (get_class($prototype)) {
                            case 'Symphony\Component\Config\Definition\ScalarNode':
                                $prototypeValue = 'scalar value';
                                break;

                            case 'Symphony\Component\Config\Definition\FloatNode':
                            case 'Symphony\Component\Config\Definition\IntegerNode':
                                $prototypeValue = 'numeric value';
                                break;

                            case 'Symphony\Component\Config\Definition\BooleanNode':
                                $prototypeValue = 'true|false';
                                break;

                            case 'Symphony\Component\Config\Definition\EnumNode':
