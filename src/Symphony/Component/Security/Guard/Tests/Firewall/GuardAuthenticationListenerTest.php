...
namespace Symphony\Component\Security\Guard\Tests\Firewall;
...
use Symphony\Component\Security\Guard\Firewall\GuardAuthenticationListener;
use Symphony\Component\Security\Guard\Token\PreAuthenticationGuardToken;
...
class GuardAuthenticationListenerTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->guardAuthenticatorHandler = $this->getMockBuilder('Symphony\Component\Security\Guard\GuardAuthenticatorHandler')
            ->disableOriginalConstructor()
            ->getMock();

        $this->request = new Request(array(), array(), array(), array(), array(), array());

        $this->event = $this->getMockBuilder('Symphony\Component\HttpKernel\Event\GetResponseEvent')
            ->disableOriginalConstructor()
        ...
        $this->rememberMeServices = $this->getMockBuilder('Symphony\Component\Security\Http\RememberMe\RememberMeServicesInterface')->getMock();
    }
