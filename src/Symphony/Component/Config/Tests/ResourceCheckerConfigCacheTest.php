...
use Symphony\Component\Config\Tests\Resource\ResourceStub;
use Symphony\Component\Config\Resource\FileResource;
use Symphony\Component\Config\ResourceCheckerConfigCache;
...
class ResourceCheckerConfigCacheTest extends TestCase
{
    ...
    {
        $checker = $this->getMockBuilder('\Symphony\Component\Config\ResourceCheckerInterface')->getMock()
