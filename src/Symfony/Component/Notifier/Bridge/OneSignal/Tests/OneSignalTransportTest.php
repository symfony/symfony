...
final class OneSignalTransportTest extends TransportTestCase
{
    ...
    {
        return new OneSignalTransport('9fb175f0-0b32-4e99-ae97-bd228b9eb246', 'api_key', $recipientId, $client ?? self::createMock(HttpClientInterface::class));
    }
    ...
    public function testCanSetCustomHost()
    {
        ...
        self::assertSame(sprintf('onesignal://9fb175f0-0b32-4e99-ae97-bd228b9eb246@%s', $customHost), (string) $transport);
    }
    ...
    public function testCanSetCustomHostAndPort()
    {
        ...
        self::assertSame(sprintf('onesignal://9fb175f0-0b32-4e99-ae97-bd228b9eb246@%s:%d', $customHost, $customPort), (string) $transport);
    }
    ...
    {
        self::assertFalse($this->createTransport()->supports(new PushMessage('Hello', 'World')));
    }
    ...
    public function testSendThrowsWithoutRecipient()
    {
        ...
        self::expectExceptionMessage('The "Symfony\Component\Notifier\Bridge\OneSignal\OneSignalTransport" transport should have configured `defaultRecipientId` via DSN or provided with message options.');
    ...
    public function testSendWithErrorResponseThrows()
    {
        ...
        self::expectExceptionMessageMatches('/Message Notifications must have English language content/');
    ...
    public function testSendWithErrorResponseThrowsWhenAllUnsubscribed()
    {
        ...
        self::expectException(TransportException::class);
        self::expectExceptionMessageMatches('/All included players are not subscribed/');
    ...
    public function testSend()
    {
        ...
        self::assertSame('b98881cc-1e94-4366-bbd9-db8f3429292b', $sentMessage->getMessageId());
    }
}
