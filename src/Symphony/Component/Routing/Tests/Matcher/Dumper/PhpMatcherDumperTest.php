...
namespace Symphony\Component\Routing\Tests\Matcher\Dumper;
...
class PhpMatcherDumperTest extends TestCase
{
    ...
    public function getRouteCollections()
    {
        ...
        return array(
           ...
           array($redirectCollection, 'url_matcher2.php', array('base_class' => 'Symphony\Component\Routing\Tests\Fixtures\RedirectableUrlMatcher')),
           array($rootprefixCollection, 'url_matcher3.php', array()),
           array($headMatchCasesCollection, 'url_matcher4.php', array()),
           array($groupOptimisedCollection, 'url_matcher5.php', array('base_class' => 'Symphony\Component\Routing\Tests\Fixtures\RedirectableUrlMatcher')),
           array($trailingSlashCollection, 'url_matcher6.php', array()),
           array($trailingSlashCollection, 'url_matcher7.php', array('base_class' => 'Symphony\Component\Routing\Tests\Fixtures\RedirectableUrlMatcher')),
           ...
           array($demoCollection, 'url_matcher11.php', array('base_class' => 'Symphony\Component\Routing\Tests\Fixtures\RedirectableUrlMatcher')),
    ...
    private function generateDumpedMatcher(RouteCollection $collection, $redirectableStub = false)
    {
        ...
        if ($redirectableStub) {
            $options['base_class'] = '\Symphony\Component\Routing\Tests\Matcher\Dumper\RedirectableUrlMatcherStub';
        }
