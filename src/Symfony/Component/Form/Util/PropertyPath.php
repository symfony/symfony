        ...
        if ($this->isIndex[$currentIndex]) {
            ...
            if ($reflClass->hasMethod($getter)) {
                ...
                if (!$reflClass->getProperty($property)->isPublic()) {
                    throw new PropertyAccessDeniedException(sprintf('Property "%s" is not public in class "%s". Maybe you should create the method "get%s()" or "is%s()"?', $property, $reflClass->getName(), $this->camelize($property), $this->camelize($property)));
                }
    ...
    protected function writeProperty(&$objectOrArray, $currentIndex, $value)
    {
        ...
        if (is_object($objectOrArray) && $this->isIndex[$currentIndex]) {
            ...
            if ($reflClass->hasMethod($setter)) {
                ...
                if (!$reflClass->getProperty($property)->isPublic()) {
                    throw new PropertyAccessDeniedException(sprintf('Property "%s" is not public in class "%s". Maybe you should create the method "set%s()"?', $property, $reflClass->getName(), $this->camelize($property)));
                }
