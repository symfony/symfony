...
class Process implements \IteratorAggregate
{
    ...
    public function start(?callable $callback = null, array $env = []): void
    {
        ...
        if ($this->ignoredSignals && \function_exists('pcntl_sigprocmask')) {
            // block signals we want to ignore, as proc_open will use fork / posix_spawn which will copy the signal mask this allow to block
        ...
        try {
            ...
            if ($this->ignoredSignals && \function_exists('pcntl_sigprocmask')) {
                //restore the signal mask here to avoid any side effects
