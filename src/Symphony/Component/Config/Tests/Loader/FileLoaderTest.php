...
class FileLoaderTest extends TestCase
{
    ...
    {
        $locatorMock = $this->getMockBuilder('Symphony\Component\Config\FileLocatorInterface')->getMock();

        $locatorMockForAdditionalLoader = $this->getMockBuilder('Symphony\Component\Config\FileLocatorInterface')->getMock();
        ...
        try {
            ...
            $this->assertInstanceOf('Symphony\Component\Config\Exception\FileLoaderImportCircularReferenceException', $e, '->import() throws a FileLoaderImportCircularReferenceException if the resource is already loading');
        }
