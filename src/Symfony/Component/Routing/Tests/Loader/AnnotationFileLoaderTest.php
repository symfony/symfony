...
class AnnotationFileLoaderTest extends AbstractAnnotationLoaderTest
{
    ...
    {
        $this->reader->expects(self::once())->method('getClassAnnotation');
    ...
    {
        $this->reader->expects(self::never())->method('getClassAnnotation');
    ...
    public function testLoadFileWithoutStartTag()
    {
        ...
        self::expectExceptionMessage('Did you forgot to add the "<?php" start tag at the beginning of the file?');
    ...
    public function testLoadVariadic()
    {
        ...
        $this->reader->expects(self::once())->method('getClassAnnotation');
        $this->reader->expects(self::once())->method('getMethodAnnotations')
            ->willReturn([$route]);
    ...
    {
        $this->reader->expects(self::never())->method('getClassAnnotation');
        $this->reader->expects(self::never())->method('getMethodAnnotations');
    ...
    public function testSupports()
    {
        ...
        self::assertTrue($this->loader->supports($fixture), '->supports() returns true if the resource is loadable');
        self::assertFalse($this->loader->supports('foo.foo'), '->supports() returns true if the resource is loadable');

        self::assertTrue($this->loader->supports($fixture, 'annotation'), '->supports() checks the resource type if specified');
        self::assertFalse($this->loader->supports($fixture, 'foo'), '->supports() checks the resource type if specified');
    }
