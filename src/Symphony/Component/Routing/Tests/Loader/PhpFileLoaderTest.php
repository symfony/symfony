...
use Symphony\Component\Routing\Loader\PhpFileLoader;
...
class PhpFileLoaderTest extends TestCase
{
    ...
    {
        $loader = new PhpFileLoader($this->getMockBuilder('Symphony\Component\Config\FileLocator')->getMock());
    ...
    public function testThatDefiningVariableInConfigFileHasNoSideEffects()
    {
        ...
        $this->assertContainsOnly('Symphony\Component\Config\Resource\ResourceInterface', $resources);
