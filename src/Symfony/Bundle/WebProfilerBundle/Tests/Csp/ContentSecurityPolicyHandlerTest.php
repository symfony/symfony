    ...
    public function provideRequestAndResponsesForOnKernelResponse()
    {
        ...
        return array(
            ...
            array(
                ...
                array('Content-Security-Policy' => 'script-src \'self\' \'unsafe-inline\' \'nonce-'.$nonce.'\' \'unsafe-eval\' \'nonce-'.$nonce.'\'; style-src \'self\' \'unsafe-inline\' \'nonce-'.$nonce.'\' \'unsafe-eval\' \'nonce-'.$nonce.'\'', 'X-Content-Security-Policy' => null),
            ),
            array(
                $nonce,
                array('csp_script_nonce' => $nonce, 'csp_style_nonce' => $nonce),
            ...
            array(
                ...
                array('X-Content-Security-Policy' => 'script-src \'self\' \'unsafe-inline\' \'nonce-'.$nonce.'\' \'unsafe-eval\' \'nonce-'.$nonce.'\'', 'Content-Security-Policy' => null),
            ),
            array(
                $nonce,
                array('csp_script_nonce' => $nonce, 'csp_style_nonce' => $nonce),
                ...
                array('X-Content-Security-Policy' => 'script-src \'self\' \'unsafe-inline\' \'sha384-LALALALALAAL\' \'nonce-'.$nonce.'\' \'unsafe-eval\' \'nonce-'.$nonce.'\'', 'Content-Security-Policy' => null),
            ),
            array(
                $nonce,
                array('csp_script_nonce' => $nonce, 'csp_style_nonce' => $nonce),
                ...
                array('Content-Security-Policy' => 'script-src \'self\' \'unsafe-inline\' \'nonce-'.$nonce.'\' \'unsafe-eval\' \'nonce-'.$nonce.'\'; style-src \'self\' \'unsafe-inline\' \'nonce-'.$nonce.'\' \'unsafe-eval\' \'nonce-'.$nonce.'\'', 'X-Content-Security-Policy' => 'script-src \'self\' \'unsafe-inline\' \'unsafe-eval\' \'nonce-'.$nonce.'\'; style-src \'self\' \'unsafe-inline\' \'nonce-'.$nonce.'\' \'unsafe-eval\' \'nonce-'.$nonce.'\''),
            ),
        );
    }
