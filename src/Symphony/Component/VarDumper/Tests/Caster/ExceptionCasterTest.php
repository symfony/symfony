...
use Symphony\Component\VarDumper\Caster\ExceptionCaster;
use Symphony\Component\VarDumper\Caster\FrameStub;
...
Exception {
  ...
  trace: {
    ...
    Symphony\Component\VarDumper\Tests\Caster\ExceptionCasterTest->testDefaultSettings() {}
%A
EODUMP;
        ...
        $expectedDump = <<<'EODUMP'
{
  ...
  Symphony\Component\VarDumper\Tests\Caster\ExceptionCasterTest->testSeek() {}
%A
EODUMP;
...
Exception {
  ...
  trace: {
    ...
    Symphony\Component\VarDumper\Tests\Caster\ExceptionCasterTest->testNoArgs() {}
%A
EODUMP;
