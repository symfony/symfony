...
class Filesystem
{
    ...
    public function tempNam($dir, $prefix)
    {
        ...
        $hierachy = $this->getHierachy($dir);

        // Create temp file in local filesystem
        $tmpFile = tempnam($hierachy, $prefix);
        ...
        for ($i = 0; $i < $limit; $i++) {
            ...
            // Use our original dir and the OS generated basename
            $tmpFile = $dir.'/'.basename($tmpFile);

            // If the file already exists create a new temp file in local filesystem and restart the loop
