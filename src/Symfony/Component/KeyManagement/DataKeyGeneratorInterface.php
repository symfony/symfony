...
{
    /**
     * @param positive-int $length Length of the data key in bytes; backend-specific minimum (e.g. 16 for AES-128). Each implementation throws `InvalidArgumentException` if the requested length is outside its accepted range. See the class-level docblock for the cross-backend `{16, 32, 64}` intersection.
