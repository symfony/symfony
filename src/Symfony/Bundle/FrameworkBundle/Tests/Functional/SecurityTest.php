...
class SecurityTest extends AbstractWebTestCase
{
    ...
    public function testLoginUser(string $username, array $roles, ?string $firewallContext)
    {
        ...
        $client = self::createClient(['test_case' => 'Security', 'root_config' => 'config.yml']);
    ...
    public function testLoginUserMultipleRequests()
    {
        ...
        self::assertEquals('Welcome the-username!', $client->getResponse()->getContent());
    ...
    public function testLoginUserMultipleTimes()
    {
        ...
        $client->request('GET', '/main/user_profile');
        self::assertEquals('Welcome no-role-username!', $client->getResponse()->getContent());
    }
}
