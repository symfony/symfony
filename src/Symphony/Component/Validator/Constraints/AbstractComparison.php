    ...
    public function __construct($options = null)
    {
        ...
        if (is_array($options)) {
            ...
            if (isset($options['propertyPath']) && !class_exists(PropertyAccess::class)) {
                throw new ConstraintDefinitionException(sprintf('The "%s" constraint requires the Symphony PropertyAccess component to use the "propertyPath" option.', get_class($this)));
            }
        }
