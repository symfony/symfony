...
class PoFileLoaderTest extends TestCase
{
    public function testLoad()
    {
        ...
        self::assertEquals(['foo' => 'bar', 'bar' => 'foo'], $catalogue->all('domain1'));
    ...
    public function testEscapedIdPlurals()
    {
        ...
        $messages = $catalogue->all('domain1');
        self::assertArrayHasKey('escaped "foo"|escaped "foos"', $messages);
        self::assertEquals('escaped "bar"|escaped "bars"', $messages['escaped "foo"|escaped "foos"']);
    }
