...
use Symphony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider;
...
class RememberMeAuthenticationProviderTest extends TestCase
{
    ...
    public function testAuthenticate()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\Security\Core\Authentication\Token\RememberMeToken', $authToken);
    ...
    protected function getSupportedToken($user = null, $secret = 'test')
    {
        ...
        $token = $this->getMockBuilder('Symphony\Component\Security\Core\Authentication\Token\RememberMeToken')->setMethods(array('getProviderKey'))->setConstructorArgs(array($user, 'foo', $secret))->getMock();
        $token
            ->expects($this->once())
