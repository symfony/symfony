...
final class PgpSigner
{
     ...
     */
    public function __construct(private readonly string $signingKey, private readonly ?string $publicKey = null, #[\SensitiveParameter] private readonly ?string $secretKeyPassphrase = null, array $options = [])
    {
