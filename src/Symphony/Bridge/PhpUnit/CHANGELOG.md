 ...
 * support for passing an array of mocked namespaces not indexed by the mock
   feature to the constructor of the `SymphonyTestsListenerTrait` class was
   dropped
 ...
 * passing a numerically indexed array to the constructor of the `SymphonyTestsListenerTrait`
