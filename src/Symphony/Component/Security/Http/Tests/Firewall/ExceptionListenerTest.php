...
class ExceptionListenerTest extends TestCase
{
    ...
    public function testAccessDeniedExceptionFullFledgedAndWithAccessDeniedHandlerAndWithoutErrorPage(\Exception $exception, \Exception $eventException = null)
    {
        ...
        $accessDeniedHandler = $this->getMockBuilder('Symphony\Component\Security\Http\Authorization\AccessDeniedHandlerInterface')->getMock();
    ...
    public function testAccessDeniedExceptionNotFullFledged(\Exception $exception, \Exception $eventException = null)
    {
        ...
        $tokenStorage->expects($this->once())->method('getToken')->will($this->returnValue($this->getMockBuilder('Symphony\Component\Security\Core\Authentication\Token\TokenInterface')->getMock()));
    ...
    {
        $trustResolver = $this->getMockBuilder('Symphony\Component\Security\Core\Authentication\AuthenticationTrustResolverInterface')->getMock();
