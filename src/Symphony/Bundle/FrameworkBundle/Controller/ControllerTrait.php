...
trait ControllerTrait
{
    ...
    protected function isGranted($attributes, $subject = null): bool
    {
        if (!$this->container->has('security.authorization_checker')) {
            throw new \LogicException('The SecurityBundle is not registered in your application. Try running "composer require symphony/security-bundle".');
        }
    ...
    protected function renderView(string $view, array $parameters = array()): string
    {
        ...
        if (!$this->container->has('twig')) {
            throw new \LogicException('You can not use the "renderView" method if the Templating Component or the Twig Bundle are not available. Try running "composer require symphony/twig-bundle".');
        }
    ...
    protected function render(string $view, array $parameters = array(), Response $response = null): Response
    {
        if ($this->container->has('templating')) {
            ...
            throw new \LogicException('You can not use the "render" method if the Templating Component or the Twig Bundle are not available. Try running "composer require symphony/twig-bundle".');
        }
    ...
    protected function stream(string $view, array $parameters = array(), StreamedResponse $response = null): StreamedResponse
    {
        if ($this->container->has('templating')) {
            ...
            throw new \LogicException('You can not use the "stream" method if the Templating Component or the Twig Bundle are not available. Try running "composer require symphony/twig-bundle".');
        }
    ...
    protected function createAccessDeniedException(string $message = 'Access Denied.', \Exception $previous = null): AccessDeniedException
    {
        if (!class_exists(AccessDeniedException::class)) {
            throw new \LogicException('You can not use the "createAccessDeniedException" method if the Security component is not available. Try running "composer require symphony/security-bundle".');
        }
    ...
    protected function getDoctrine(): ManagerRegistry
    {
        if (!$this->container->has('doctrine')) {
            throw new \LogicException('The DoctrineBundle is not registered in your application. Try running "composer require symphony/orm-pack".');
        }
    ...
    protected function dispatchMessage($message)
    {
        if (!$this->container->has('message_bus')) {
            throw new \LogicException('The message bus is not enabled in your application. Try running "composer require symphony/messenger".');
        }
