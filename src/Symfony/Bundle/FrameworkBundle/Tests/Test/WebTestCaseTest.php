...
class WebTestCaseTest extends TestCase
{
    public function testAssertResponseIsSuccessful()
    {
        ...
        self::expectExceptionMessage("Failed asserting that the Response is successful.\nHTTP/1.0 404 Not Found");
    ...
    public function testAssertResponseStatusCodeSame()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage("Failed asserting that the Response status code is 200.\nHTTP/1.0 404 Not Found");
    ...
    public function testAssertResponseRedirects()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage("Failed asserting that the Response is redirected.\nHTTP/1.0 200 OK");
    ...
    public function testAssertResponseRedirectsWithLocation()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage('is redirected and has header "Location" with value "https://example.com/".');
    ...
    public function testAssertResponseRedirectsWithStatusCode()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage('is redirected and status code is 301.');
    ...
    public function testAssertResponseRedirectsWithLocationAndStatusCode()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessageMatches('#(:?\( )?is redirected and has header "Location" with value "https://example\.com/" (:?\) )?and status code is 301\.#');
    ...
    public function testAssertResponseFormat()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage("Failed asserting that the Response format is jsonld.\nHTTP/1.0 200 OK");
    ...
    public function testAssertResponseHasHeader()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage('Failed asserting that the Response has header "X-Date".');
    ...
    public function testAssertResponseNotHasHeader()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage('Failed asserting that the Response does not have header "Date".');
    ...
    public function testAssertResponseHeaderSame()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage('Failed asserting that the Response has header "Cache-Control" with value "public".');
    ...
    public function testAssertResponseHeaderNotSame()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage('Failed asserting that the Response does not have header "Cache-Control" with value "no-cache, private".');
    ...
    public function testAssertResponseHasCookie()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage('Failed asserting that the Response has cookie "bar".');
    ...
    public function testAssertResponseNotHasCookie()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage('Failed asserting that the Response does not have cookie "foo".');
    ...
    public function testAssertResponseCookieValueSame()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage('has cookie "bar" and has cookie "bar" with value "bar".');
    ...
    public function testAssertBrowserHasCookie()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage('Failed asserting that the Browser has cookie "bar".');
    ...
    public function testAssertBrowserNotHasCookie()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage('Failed asserting that the Browser does not have cookie "foo" with path "/path".');
    ...
    public function testAssertBrowserCookieValueSame()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage('has cookie "foo" with path "/path" and has cookie "foo" with path "/path" with value "babar".');
    ...
    public function testAssertSelectorExists()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage('matches selector "body > h1".');
    ...
    public function testAssertSelectorNotExists()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage('does not match selector "body > h1".');
    ...
    public function testAssertSelectorTextNotContains()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage('matches selector "body > h1" and the text "Foo" of the node matching selector "body > h1" does not contain "Foo".');
    ...
    public function testAssertPageTitleSame()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage('matches selector "title" and has a node matching selector "title" with content "Bar".');
    ...
    public function testAssertPageTitleContains()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage('matches selector "title" and the text "Foo" of the node matching selector "title" contains "Bar".');
    ...
    public function testAssertInputValueSame()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage('matches selector "input[name="password"]" and has a node matching selector "input[name="password"]" with attribute "value" of value "pa$$".');
    ...
    public function testAssertInputValueNotSame()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage('matches selector "input[name="password"]" and does not have a node matching selector "input[name="password"]" with attribute "value" of value "pa$$".');
    ...
    public function testAssertCheckboxChecked()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage('matches selector "input[name="rememberMe"]" and has a node matching selector "input[name="rememberMe"]" with attribute "checked" of value "checked".');
    ...
    public function testAssertCheckboxNotChecked()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage('matches selector "input[name="rememberMe"]" and does not have a node matching selector "input[name="rememberMe"]" with attribute "checked" of value "checked".');
    ...
    public function testAssertFormValue()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage('Failed asserting that two strings are identical.');
    ...
    public function testAssertNoFormValue()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage('Field "rememberMe" has a value in form "#form".');
    ...
    public function testAssertRequestAttributeValueSame()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage('Failed asserting that the Request has attribute "foo" with value "baz".');
    ...
    public function testAssertRouteSame()
    {
        ...
        self::expectException(AssertionFailedError::class);
        self::expectExceptionMessage('Failed asserting that the Request has attribute "_route" with value "articles".');
    ...
    public function testExceptionOnServerError()
    {
        try {
            ...
            self::assertSame('An exception has occurred', $exception->getPrevious()->getMessage());
            self::assertSame('/srv/test.php', $exception->getPrevious()->getFile());
            self::assertSame(12, $exception->getPrevious()->getLine());
        }
    }

    private function getResponseTester(Response $response): WebTestCase
    {
        $client = self::createMock(KernelBrowser::class);
        $client->expects(self::any())->method('getResponse')->willReturn($response);

        $request = new Request();
        $request->setFormat('custom', ['application/vnd.myformat']);
        $client->expects(self::any())->method('getRequest')->willReturn($request);
    ...
    {
        $client = self::createMock(KernelBrowser::class);
        $client->expects(self::any())->method('getCrawler')->willReturn($crawler);
    ...
    private function getClientTester(): WebTestCase
    {
        ...
        $client->expects(self::any())->method('getCookieJar')->willReturn($jar);
