...
class GetSetMethodNormalizerTest extends TestCase
{
    ...
    public function testConstructorDenormalizeWithVariadicArgument()
    {
        $obj = $this->normalizer->denormalize(
            ...
            'Symphony\Component\Serializer\Tests\Fixtures\VariadicConstructorArgsDummy', 'any');
    ...
    public function testGroupsDenormalizeWithNameConverter()
    {
        ...
        $this->assertEquals(
            ...
            ), 'Symphony\Component\Serializer\Tests\Fixtures\GroupDummy', null, array(GetSetMethodNormalizer::GROUPS => array('name_converter')))
        );
    }
