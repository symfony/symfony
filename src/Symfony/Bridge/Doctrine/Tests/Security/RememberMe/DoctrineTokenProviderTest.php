...
class DoctrineTokenProviderTest extends TestCase
{
    ...
    public function testVerifyOutdatedTokenAfterParallelRequestWithASeriesGeneratedByTheHandler()
    {
        $provider = $this->bootstrapProvider();
        // the series generated by PersistentRememberMeHandler carry no base64 padding
        $series = strtr(base64_encode(random_bytes(33)), '+/=', '-_~');
        $oldValue = 'oldValue';
        $newValue = 'newValue';
