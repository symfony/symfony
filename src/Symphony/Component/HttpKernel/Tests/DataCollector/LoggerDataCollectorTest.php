...
use Symphony\Component\Debug\Exception\SilencedErrorContext;
use Symphony\Component\HttpKernel\DataCollector\LoggerDataCollector;
...
class LoggerDataCollectorTest extends TestCase
{
    ...
    {
        $logger = $this
            ->getMockBuilder('Symphony\Component\HttpKernel\Log\DebugLoggerInterface')
        ...
        $this->assertSame(array(
            ...
            array('message' => 'Removed service "Symphony\Component\DependencyInjection\ContainerInterface"; reason: private alias.'),
        ), $compilerLogs['Symphony\Component\DependencyInjection\Compiler\RemovePrivateAliasesPass']);
    ...
    public function testCollect($nb, $logs, $expectedLogs, $expectedDeprecationCount, $expectedScreamCount, $expectedPriorities = null)
    {
        ...
        $logs = array_map(function ($v) {
            if (isset($v['context']['exception'])) {
                ...
                $e = isset($e["\0*\0message"]) ? array($e["\0*\0message"], $e["\0*\0severity"]) : array($e["\0Symphony\Component\Debug\Exception\SilencedErrorContext\0severity"]);
            }
