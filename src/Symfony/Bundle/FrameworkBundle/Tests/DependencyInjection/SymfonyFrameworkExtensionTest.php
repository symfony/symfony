...
use Symfony\Bundle\FrameworkBundle\DependencyInjection\SymfonyFrameworkExtension;
use Symfony\Component\DependencyInjection\ContainerBuilder;
use Symfony\Component\DependencyInjection\ParameterBag\ParameterBag;

abstract class SymfonyFrameworkExtensionTest extends TestCase
{
    ...
    public function testRouterRequiresResourceOption()
    {
        ...
        $loader = new SymfonyFrameworkExtension();
    ...
    public function testTranslator()
    {
        ...
        $this->assertContains(
            ...
            '->registerTranslatorConfiguration() finds SymfonyFrameworkExtension translation resources'
        );
    ...
    protected function createContainer()
    {
        return new ContainerBuilder(new ParameterBag(array(
            'kernel.bundles'          => array('SymfonyFrameworkBundle' => 'Symfony\\Bundle\\FrameworkBundle\\SymfonyFrameworkBundle'),
    ...
    {
        $container = $this->createContainer();
        $container->registerExtension(new SymfonyFrameworkExtension());
