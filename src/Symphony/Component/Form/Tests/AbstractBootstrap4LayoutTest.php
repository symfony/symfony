...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\TextType', array('label' => false));
        $form->addError(new FormError('[trans]Error 1[/trans]'));
        $view = $form->createView();
        $html = $this->renderLabel($view);
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\FileType');
