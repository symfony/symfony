...
interface ExecutionContextInterface
{
     ...
     */
    public function addViolation(string $message, array $params = array()): void;
     ...
     */
    public function buildViolation(string $message, array $parameters = array()): ConstraintViolationBuilderInterface;
