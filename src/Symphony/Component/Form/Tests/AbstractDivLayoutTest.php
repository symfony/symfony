...
'
    ...
    {
        $view = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\TextType')->createView();
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\RepeatedType');
        $form->addError(new FormError('[trans]Error![/trans]'));
        $view = $form->createView();
        $html = $this->renderRow($view);
...
'
    ...
    {
        $view = $this->factory->createNamedBuilder('name', 'Symphony\Component\Form\Extension\Core\Type\FormType')
            ->add('field1', 'Symphony\Component\Form\Extension\Core\Type\TextType')
            ->add('field2', 'Symphony\Component\Form\Extension\Core\Type\RepeatedType')
            ->add('field3', 'Symphony\Component\Form\Extension\Core\Type\TextType')
            ->add('field4', 'Symphony\Component\Form\Extension\Core\Type\TextType')
            ->getForm()
            ->createView();
...
'
    ...
    {
        $child1 = $this->factory->createNamedBuilder('child1', 'Symphony\Component\Form\Extension\Core\Type\FormType')
            ->add('field1', 'Symphony\Component\Form\Extension\Core\Type\TextType')
            ->add('field2', 'Symphony\Component\Form\Extension\Core\Type\TextType');

        $child2 = $this->factory->createNamedBuilder('child2', 'Symphony\Component\Form\Extension\Core\Type\FormType')
            ->add('field1', 'Symphony\Component\Form\Extension\Core\Type\TextType')
            ->add('field2', 'Symphony\Component\Form\Extension\Core\Type\TextType');

        $view = $this->factory->createNamedBuilder('parent', 'Symphony\Component\Form\Extension\Core\Type\FormType')
            ->add($child1)
            ->add($child2)
            ->getForm()
            ->createView();
...
'
    ...
    {
        $view = $this->factory->createNamedBuilder('name', 'Symphony\Component\Form\Extension\Core\Type\FormType')
            ->add('first', 'Symphony\Component\Form\Extension\Core\Type\TextType')
            ->add('password', 'Symphony\Component\Form\Extension\Core\Type\RepeatedType')
            ->getForm()
            ->createView();
...
'
    ...
    {
        $form = $this->factory->createNamed('names', 'Symphony\Component\Form\Extension\Core\Type\CollectionType', array('a', 'b'), array(
            'entry_type' => 'Symphony\Component\Form\Extension\Core\Type\TextType',
        ));
...
'
    ...
    // https://github.com/symphony/symphony/issues/5038
    public function testCollectionWithAlternatingRowTypes()
    {
        ...
        $form = $this->factory->createNamed('names', 'Symphony\Component\Form\Extension\Core\Type\CollectionType', $data, array(
            'entry_type' => 'Symphony\Component\Form\Tests\Fixtures\AlternatingRowType',
        ));
...
'
    ...
    {
        $form = $this->factory->createNamed('names', 'Symphony\Component\Form\Extension\Core\Type\CollectionType', array(), array(
            'entry_type' => 'Symphony\Component\Form\Extension\Core\Type\TextType',
        ));
...
'
    ...
    public function testCollectionRow()
    {
        $collection = $this->factory->createNamedBuilder(
            'collection',
            'Symphony\Component\Form\Extension\Core\Type\CollectionType',
            array('a', 'b'),
            array('entry_type' => 'Symphony\Component\Form\Extension\Core\Type\TextType')
        );

        $form = $this->factory->createNamedBuilder('form', 'Symphony\Component\Form\Extension\Core\Type\FormType')
            ->add($collection)
            ->getForm();
...
'
    ...
    {
        $form = $this->factory->createNamedBuilder('name', 'Symphony\Component\Form\Extension\Core\Type\FormType')
            ->setMethod('PUT')
...
'
    ...
    // https://github.com/symphony/symphony/issues/2308
    public function testNestedFormError()
    {
        $form = $this->factory->createNamedBuilder('name', 'Symphony\Component\Form\Extension\Core\Type\FormType')
            ->add($this->factory
                ->createNamedBuilder('child', 'Symphony\Component\Form\Extension\Core\Type\FormType', null, array('error_bubbling' => false))
                ->add('grandChild', 'Symphony\Component\Form\Extension\Core\Type\FormType')
            )
            ->getForm();
    ...
    public function testCsrf()
    {
        ...
        $form = $this->factory->createNamedBuilder('name', 'Symphony\Component\Form\Extension\Core\Type\FormType')
            ->add($this->factory
                ...
                ->createNamedBuilder('child', 'Symphony\Component\Form\Extension\Core\Type\FormType')
                ->add($this->factory->createNamedBuilder('grandchild', 'Symphony\Component\Form\Extension\Core\Type\TextType'))
            )
            ->getForm();
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\RepeatedType', 'foobar', array(
            'type' => 'Symphony\Component\Form\Extension\Core\Type\TextType',
        ));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\RepeatedType', null, array(
...
'
    ...
    {
        $form = $this->factory->createNamedBuilder('full', 'Symphony\Component\Form\Extension\Core\Type\FormType')
            ->add('name', 'Symphony\Component\Form\Extension\Core\Type\SearchType')
            ->getForm();
...
'
    ...
    {
        $view = $this->factory
            ->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\EmailType')
            ->createView()
        ;
    ...
    {
        $child = $this->factory->createNamedBuilder('child', 'Symphony\Component\Form\Extension\Core\Type\FormType')
            ->add('field', 'Symphony\Component\Form\Extension\Core\Type\TextType');
...
'
    ...
    public function testCollectionRowWithCustomBlock()
    {
        ...
        $form = $this->factory->createNamedBuilder('names', 'Symphony\Component\Form\Extension\Core\Type\CollectionType', $collection)
            ->getForm();
...
'
    ...
    {
        $form = $this->factory->createNamedBuilder('name_c', 'Symphony\Component\Form\Extension\Core\Type\ChoiceType', 'a', array(
...
'
    ...
    {
        $form = $this->factory->createNamed('form', 'Symphony\Component\Form\Extension\Core\Type\FormType', null, array(
            'attr' => array('class' => 'foobar', 'data-foo' => 'bar'),
        ));

        $form->add('text', 'Symphony\Component\Form\Extension\Core\Type\TextType');
