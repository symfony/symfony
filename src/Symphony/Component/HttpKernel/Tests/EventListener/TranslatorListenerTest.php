...
use Symphony\Component\HttpKernel\EventListener\TranslatorListener;
...
class TranslatorListenerTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->requestStack = $this->getMockBuilder('Symphony\Component\HttpFoundation\RequestStack')->getMock();
    ...
    {
        return $this->getMockBuilder('Symphony\Component\HttpKernel\HttpKernelInterface')->getMock();
    }
