...
class Image extends File
{
    ...
    const TOO_MANY_ERROR = 'ee0804e8-44db-4eac-9775-be91aaf72ce1';
    ...
    public $maxPixelsMessage = 'The image has to many pixels ({{ pixels }} pixels). Maximum amount expected is {{ max_pixels }} pixels.';
