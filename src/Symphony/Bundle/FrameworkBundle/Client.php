...
use Symphony\Component\HttpKernel\Client as BaseClient;
use Symphony\Component\HttpKernel\Profiler\Profile as HttpProfile;
...
class Client extends BaseClient
{
     ...
     * Symphony Standard Edition). If this is not your case, create your own
