...
use Symphony\Component\DependencyInjection\Loader\DirectoryLoader;
...
use Symphony\Component\HttpKernel\Bundle\BundleInterface;
use Symphony\Component\HttpKernel\Config\FileLocator;
use Symphony\Component\HttpKernel\DependencyInjection\MergeExtensionConfigurationPass;
use Symphony\Component\HttpKernel\DependencyInjection\AddAnnotatedClassesToCachePass;
use Symphony\Component\Config\Loader\LoaderResolver;
use Symphony\Component\Config\Loader\DelegatingLoader;
use Symphony\Component\Config\ConfigCache;

/**
 * The Kernel is the heart of the Symphony system.
 *
...
abstract class Kernel implements KernelInterface, RebootableInterface, TerminableInterface
{
    ...
    protected function getContainerBuilder()
    {
        ...
        if (class_exists('ProxyManager\Configuration') && class_exists('Symphony\Bridge\ProxyManager\LazyProxy\Instantiator\RuntimeInstantiator')) {
    ...
    protected function dumpContainer(ConfigCache $cache, ContainerBuilder $container, $class, $baseClass)
    {
        ...
        if (class_exists('ProxyManager\Configuration') && class_exists('Symphony\Bridge\ProxyManager\LazyProxy\PhpDumper\ProxyDumper')) {
