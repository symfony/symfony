...
class UndefinedCallableHandler
{
    ...
    public static function onUndefinedFilter($name)
    {
        ...
        throw new SyntaxError(sprintf('Did you forget to run "composer require symphony/%s"? Unknown filter "%s".', self::$filterComponents[$name], $name));
    }
    ...
    public static function onUndefinedFunction($name)
    {
        ...
        throw new SyntaxError(sprintf('Did you forget to run "composer require symphony/%s"? Unknown function "%s".', self::$functionComponents[$name], $name));
    }
}
