...
class PropertyPathTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function provideAppendPaths()
    {
        return array(
            ...
            array('foo', 'bar', 'foo.bar', 'It appends the subPath to the basePath'),
            array('foo', '[bar]', 'foo[bar]', 'It does not include the dot separator if subPath uses an array notation'),
        );
    }
}
