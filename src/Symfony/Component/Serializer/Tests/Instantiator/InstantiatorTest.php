...
class InstantiatorTest extends TestCase
{
    ...
    public function testCannotInstantiate()
    {
        ...
        $this->assertTrue($dummyResult->hasFailed());
        $this->assertEquals('Cannot create an instance of "Symfony\\Component\\Serializer\\Tests\\Instantiator\\DummyWithExtraConstructor" from serialized data because its constructor requires parameter "extra" to be present.', $dummyResult->getError()->getMessage());
    }
    ...
    public function testInstantiateWithDenormalizationAndDenormalizer()
    {
        ...
        $this->assertNull($dummyResult->getObject());
        $this->assertTrue($dummyResult->hasFailed());
        $this->assertEquals('Could not create object of class "Symfony\\Component\\Serializer\\Tests\\Instantiator\\DummyBar" of the parameter "bar".', $dummyResult->getError()->getMessage());
    }
