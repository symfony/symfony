...
use Symphony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider;
use Symphony\Component\Security\Core\Exception\UsernameNotFoundException;

class DaoAuthenticationProviderTest extends TestCase
{
    /**
     * @expectedException \Symphony\Component\Security\Core\Exception\AuthenticationServiceException
     */
    ...
    public function testRetrieveUserWhenUsernameIsNotFound()
    {
        ...
        $provider = new DaoAuthenticationProvider($userProvider, $this->getMockBuilder('Symphony\\Component\\Security\\Core\\User\\UserCheckerInterface')->getMock(), 'key', $this->getMockBuilder('Symphony\\Component\\Security\\Core\\Encoder\\EncoderFactoryInterface')->getMock());
        $method = new \ReflectionMethod($provider, 'retrieveUser');
        $method->setAccessible(true);
    ...
    {
        $encoder = $this->getMockBuilder('Symphony\\Component\\Security\\Core\\Encoder\\PasswordEncoderInterface')->getMock();
        $encoder
            ->expects($this->never())
    ...
    public function testCheckAuthenticationWhenCredentialsAreNotValid()
    {
        ...
        $method->invoke($provider, $this->getMockBuilder('Symphony\\Component\\Security\\Core\\User\\UserInterface')->getMock(), $token);
    }
    ...
    public function testCheckAuthenticationDoesNotReauthenticateWhenPasswordHasChanged()
    {
        ...
        $dbUser = $this->getMockBuilder('Symphony\\Component\\Security\\Core\\User\\UserInterface')->getMock();
    ...
    {
        $mock = $this->getMockBuilder('Symphony\\Component\\Security\\Core\\Authentication\\Token\\UsernamePasswordToken')->setMethods(array('getCredentials', 'getUser', 'getProviderKey'))->disableOriginalConstructor()->getMock();
        $mock
            ->expects($this->any())
    ...
    protected function getProvider($user = null, $userChecker = null, $passwordEncoder = null)
    {
        ...
        $encoderFactory = $this->getMockBuilder('Symphony\\Component\\Security\\Core\\Encoder\\EncoderFactoryInterface')->getMock();
        $encoderFactory
            ->expects($this->any())
            ->method('getEncoder')
