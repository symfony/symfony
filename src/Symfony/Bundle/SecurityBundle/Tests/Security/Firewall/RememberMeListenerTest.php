...
namespace Symfony\Bundle\SecurityBundle\Tests\Security\Firewall;

use Symfony\Component\HttpKernel\HttpKernelInterface;
use Symfony\Component\HttpFoundation\Response;
use Symfony\Component\Security\Exception\CookieTheftException;
use Symfony\Component\Security\Exception\AuthenticationException;
use Symfony\Bundle\SecurityBundle\Security\Firewall\RememberMeListener;
...
class RememberMeListenerTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return $this->getMock('Symfony\Bundle\SecurityBundle\Security\RememberMe\RememberMeServicesInterface');
    }
