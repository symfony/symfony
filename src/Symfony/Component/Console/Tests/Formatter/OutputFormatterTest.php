...
class OutputFormatterTest extends TestCase
{
    ...
    public function provideInlineStyleOptionsCases()
    {
        return array(
            ...
            array('<fg=mode-0,255,0;>', "\033[38;2;0;255;0m[test]\033[39m", '[test]'),
            array('<fg=mode-0,255,0;bg=bright-cyan>', "\033[38;2;0;255;0;106m[test]\033[39;49m", '[test]'),
            array('<fg=mode-80;bg=mode-111,22,3>', "\033[38;5;80;48;2;111;22;3m[test]\033[39;49m", '[test]'),
            array('<fg=mode-0,150,0;bg=mode-255,255,250;options=bold;>', "\033[38;2;0;150;0;48;2;255;255;250;1m[test]\033[39;49;22m", '[test]'),
        );
    }
