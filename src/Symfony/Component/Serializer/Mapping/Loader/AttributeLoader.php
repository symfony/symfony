...
class AttributeLoader implements LoaderInterface
{
    ...
    private function doLoadClassMetadata(\ReflectionClass $reflectionClass, ClassMetadataInterface $classMetadata): bool
    {
        ...
        foreach ($reflectionClass->getProperties() as $property) {
            $propertiesMetadata[$property->name] = $property;
        ...
        foreach ($reflectionClass->getMethods() as $method) {
            ...
            foreach ($this->loadAttributes($method) as $attribute) {
                if ($attribute instanceof Groups) {
                    ...
                    $propertyMetadata = null !== $attributeName ? $propertiesMetadata[$attributeName] ?? null : null;

                    if ($attributeMetadata && (!$propertyMetadata || !$propertyMetadata->isPublic())) {
