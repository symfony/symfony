...
use Symphony\Component\Validator\Constraints\Expression;
use Symphony\Component\Validator\Constraints\ExpressionValidator;
use Symphony\Component\Validator\Test\ConstraintValidatorTestCase;
use Symphony\Component\Validator\Tests\Fixtures\Entity;
use Symphony\Component\Validator\Tests\Fixtures\ToString;
...
class ExpressionValidatorTest extends ConstraintValidatorTestCase
{
     ...
     * https://github.com/symphony/symphony/pull/11498.
     */
    ...
    public function testExpressionLanguageUsage()
    {
        ...
        $expressionLanguage = $this->getMockBuilder('Symphony\Component\ExpressionLanguage\ExpressionLanguage')->getMock();
