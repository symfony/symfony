    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $rootNode
            ->children()
                ...
                ->end()
                ->enumNode('csrf_migration_strategy')
                    ->values([SessionAuthenticationStrategy::CSRF_KEEP, SessionAuthenticationStrategy::CSRF_CLEAR])
                    ->defaultValue(SessionAuthenticationStrategy::CSRF_CLEAR)
                ->end()
