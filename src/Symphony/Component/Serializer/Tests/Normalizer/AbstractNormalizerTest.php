...
use Symphony\Component\Serializer\Tests\Fixtures\AbstractNormalizerDummy;
use Symphony\Component\Serializer\Tests\Fixtures\ProxyDummy;
use Symphony\Component\Serializer\Tests\Fixtures\StaticConstructorDummy;
use Symphony\Component\Serializer\Tests\Fixtures\StaticConstructorNormalizer;
...
class AbstractNormalizerTest extends TestCase
{
    ...
    {
        $loader = $this->getMockBuilder('Symphony\Component\Serializer\Mapping\Loader\LoaderChain')->setConstructorArgs(array(array()))->getMock();
        $this->classMetadata = $this->getMockBuilder('Symphony\Component\Serializer\Mapping\Factory\ClassMetadataFactory')->setConstructorArgs(array($loader))->getMock();
    ...
    public function testObjectToPopulateWithProxy()
    {
        ...
        $normalizer->denormalize(array('foo' => 'bar'), 'Symphony\Component\Serializer\Tests\Fixtures\ToBeProxyfiedDummy', null, $context);
