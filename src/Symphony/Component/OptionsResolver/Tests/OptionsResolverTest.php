...
namespace Symphony\Component\OptionsResolver\Tests;

use PHPUnit\Framework\Assert;
use PHPUnit\Framework\TestCase;
use Symphony\Component\OptionsResolver\Exception\InvalidOptionsException;
...
class OptionsResolverTest extends TestCase
{
    ...
    /**
     * @expectedException \Symphony\Component\OptionsResolver\Exception\UndefinedOptionsException
    ...
    /**
     * @expectedException \Symphony\Component\OptionsResolver\Exception\AccessException
     */
    ...
    public function testResolveFailsIfInvalidType($actualType, $allowedType, $exceptionMessage)
    {
        ...
        if (method_exists($this, 'expectException')) {
            $this->expectException('Symphony\Component\OptionsResolver\Exception\InvalidOptionsException');
            $this->expectExceptionMessage($exceptionMessage);
        } else {
            $this->setExpectedException('Symphony\Component\OptionsResolver\Exception\InvalidOptionsException', $exceptionMessage);
        }
    ...
    public function provideInvalidTypes()
    {
        return array(
            ...
            array(new OptionsResolver(), 'string', 'The option "option" with value Symphony\Component\OptionsResolver\OptionsResolver is expected to be of type "string", but is of type "Symphony\Component\OptionsResolver\OptionsResolver".'),
    ...
    /**
     * @expectedException \Symphony\Component\OptionsResolver\Exception\OptionDefinitionException
     */
    ...
    /**
     * @expectedException \Symphony\Component\OptionsResolver\Exception\NoSuchOptionException
