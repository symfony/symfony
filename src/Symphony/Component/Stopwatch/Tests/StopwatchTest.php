...
class StopwatchTest extends TestCase
{
    ...
    public function testStart()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\Stopwatch\StopwatchEvent', $event);
    ...
    public function testIsNotStartedEvent()
    {
        ...
        $sections = new \ReflectionProperty('Symphony\Component\Stopwatch\Stopwatch', 'sections');
        $sections->setAccessible(true);
        $section = $sections->getValue($stopwatch);

        $events = new \ReflectionProperty('Symphony\Component\Stopwatch\Section', 'events');
        $events->setAccessible(true);

        $stopwatchMockEvent = $this->getMockBuilder('Symphony\Component\Stopwatch\StopwatchEvent')
