...
use Symphony\Component\Validator\Mapping\Loader\StaticMethodLoader;
...
class ValidatorBuilder implements ValidatorBuilderInterface
{
    ...
    public function getValidator()
    {
        ...
        if (null === $translator) {
            ...
            // This avoids depending on Intl or the stub implementation being available. It also ensures that Symphony
