...
class ExpressionLanguageTest extends TestCase
{
    ...
    {
        $anonymousTokenClass = 'Symphony\\Component\\Security\\Core\\Authentication\\Token\\AnonymousToken';
        $rememberMeTokenClass = 'Symphony\\Component\\Security\\Core\\Authentication\\Token\\RememberMeToken';
