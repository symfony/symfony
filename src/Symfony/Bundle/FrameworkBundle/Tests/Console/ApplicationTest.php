...
class ApplicationTest extends TestCase
{
    ...
    public function testApplicationIsAvailableAsService(): void
    {
    ...
    public function testApplicationIsNotRegisteredTwice(): void
    {
        $bundle = $this->createBundleMock([]);
        $kernel = $this->getKernel([$bundle], true);
    ...
    private function getKernel(array $bundles, bool $useDispatcher = false): KernelInterface
    {
