...
namespace Symfony\Component\OAuth\Tests\Provider;

use PHPUnit\Framework\TestCase;
use Symfony\Component\HttpClient\MockHttpClient;
use Symfony\Component\HttpClient\Response\MockResponse;
use Symfony\Component\OAuth\Exception\InvalidRequestException;
use Symfony\Component\OAuth\Provider\ClientCredentialsProvider;
...
final class ClientCredentialsProviderTest extends TestCase
{
    ...
    public function testErrorOnAuthorizationTokenRequest(array $options, string $scope)
    {
        ...
        static::expectExceptionMessage(\sprintf(
            'The %s does not support the authorization code process, the credentials should be obtained by the client, please refer to https://tools.ietf.org/html/rfc6749#section-4.4.1',
        ...
        $provider->fetchAuthorizationCode(['scope' => $scope]);
    }
    ...
    public function provideWrongOptions(): \Generator
    {
        yield 'Missing client_id option' => [
            [
                ...
                'accessToken_url' => 'https://bar.com/',
                'userDetails_url' => 'https://bar.com/',
            ],
        ];
    }
