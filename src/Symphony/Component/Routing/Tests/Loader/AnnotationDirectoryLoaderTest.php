...
class AnnotationDirectoryLoaderTest extends AbstractAnnotationLoaderTest
{
    ...
    public function testLoadIgnoresHiddenDirectories()
    {
        $this->expectAnnotationsToBeReadFrom(array(
            'Symphony\Component\Routing\Tests\Fixtures\AnnotatedClasses\BarClass',
            'Symphony\Component\Routing\Tests\Fixtures\AnnotatedClasses\BazClass',
            'Symphony\Component\Routing\Tests\Fixtures\AnnotatedClasses\BazClass',
            'Symphony\Component\Routing\Tests\Fixtures\AnnotatedClasses\FooClass',
        ));
