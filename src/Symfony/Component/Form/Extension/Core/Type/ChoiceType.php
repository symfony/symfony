...
class ChoiceType extends AbstractType
{
    ...
    {
        /** @var \Symfony\Component\Form\ChoiceList\View\ChoiceListView $choiceListView */
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        ...
        $resolver->setAllowedTypes(array(
            'choice_list' => array('null', 'Symfony\Component\Form\ChoiceList\ChoiceListInterface'),
            'choices' => array('null', 'array', '\Traversable'),
            'flip_choices' => 'bool',
            'choice_loader' => array('null', 'Symfony\Component\Form\ChoiceList\Loader\ChoiceLoaderInterface'),
            'choice_label' => array('null', 'callable', 'string', 'Symfony\Component\PropertyAccess\PropertyPath'),
            'choice_name' => array('null', 'callable', 'string', 'Symfony\Component\PropertyAccess\PropertyPath'),
            'choice_value' => array('null', 'callable', 'string', 'Symfony\Component\PropertyAccess\PropertyPath'),
            'choice_attr' => array('null', 'array', 'callable', 'string', 'Symfony\Component\PropertyAccess\PropertyPath'),
            'preferred_choices' => array('array', '\Traversable', 'callable', 'string', 'Symfony\Component\PropertyAccess\PropertyPath'),
            'group_by' => array('null', 'array', '\Traversable', 'string', 'callable', 'string', 'Symfony\Component\PropertyAccess\PropertyPath'),
        ));
    }
    ...
    private function createChoiceListView(ChoiceListInterface $choiceList, array $options)
    {
        ...
        if (!$options['group_by'] && $options['choices']) {
            $options['group_by'] = !$options['flip_choices']
