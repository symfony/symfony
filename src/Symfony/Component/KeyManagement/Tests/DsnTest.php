...
class DsnTest extends TestCase
{
    ...
    {
        $dsn = Dsn::fromString('hashicorp-vault-transit://AKIA:s%2Fcret@vault.example.com:8200/v1/?mount=transit&namespace=tenant-a');

        $this->assertSame('hashicorp-vault-transit', $dsn->scheme);
