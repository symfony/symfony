...
class HttpProfilerListener implements EventSubscriberInterface
{
     ...
     */
    public function __construct(HttpProfiler $profiler, RequestMatcherInterface $matcher = null, $onlyException = false, $onlyMasterRequests = false, RequestStack $requestStack = null)
    {
