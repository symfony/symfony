                    ...
                    ->children()
                        ...
                        ->arrayNode('mapping')
                            ...
                            ->children()
                                ...
                                ->end()
                            ->end()
                            ->arrayNode('namespaces', 'namespace')
                            ...
                            ->arrayNode('metadata')
                                ...
                                ->arrayPrototype()
                                    ->children()
                                        ->stringNode('class')->end()
                                        ->variableNode('group_sequence_provider')->end()
                                        ->arrayNode('group_sequence', 'group')
                                            ->scalarPrototype()->end()
                                        ->end()
                                        ->arrayNode('constraints', 'constraint')
                                            ->arrayPrototype()
                                                ->variablePrototype()->end()
                                            ->end()
                                        ->end()
                                        ->arrayNode('properties', 'property')
                                            ->useAttributeAsKey('name')
                                            ->arrayPrototype()
                                                ->arrayPrototype()
                                                    ->useAttributeAsKey('name')
