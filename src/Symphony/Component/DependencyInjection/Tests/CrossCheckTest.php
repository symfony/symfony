...
class CrossCheckTest extends TestCase
{
    ...
    {
        $loaderClass = 'Symphony\\Component\\DependencyInjection\\Loader\\'.ucfirst($type).'FileLoader';
        $dumperClass = 'Symphony\\Component\\DependencyInjection\\Dumper\\'.ucfirst($type).'Dumper';
