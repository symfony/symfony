            ...
            ->children()
                ->arrayNode('validation')
                    ...
                    ->beforeNormalization()
                        ...
                        ->then(function ($v) {
                            @trigger_error('The "framework.validation.strict_email" configuration key has been deprecated in Symphony 4.1. Use the "framework.validation.email_validation_mode" configuration key instead.', E_USER_DEPRECATED);
