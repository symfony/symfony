...
namespace Symphony\Bundle\WebProfilerBundle\Tests\Controller;

use PHPUnit\Framework\TestCase;
use Symphony\Bundle\WebProfilerBundle\Controller\ProfilerController;
...
class ProfilerControllerTest extends TestCase
{
    ...
    public function testEmptyToken($token)
    {
        ...
        $profiler = $this
            ->getMockBuilder('Symphony\Component\HttpKernel\Profiler\Profiler')
    ...
    public function getEmptyTokenCases()
    {
        return array(
            array(null),
            // "empty" is also a valid empty token case, see https://github.com/symphony/symphony/issues/10806
            array('empty'),
        );
    }
    ...
    private function createController($profiler, $twig, $withCSP)
    {
        ...
        if ($withCSP) {
            $nonceGenerator = $this->getMockBuilder('Symphony\Bundle\WebProfilerBundle\Csp\NonceGenerator')->getMock();
