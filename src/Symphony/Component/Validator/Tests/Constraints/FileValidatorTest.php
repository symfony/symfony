...
use Symphony\Component\Validator\Constraints\FileValidator;
...
abstract class FileValidatorTest extends ConstraintValidatorTestCase
{
    ...
    public function provideMaxSizeExceededTests()
    {
        ...
        // Prior to Symphony 2.5, violation messages are always displayed in the
        // same unit used to specify the limit.

        // As of Symphony 2.5, the above logic is implemented.
        return array(
            // limit in bytes
    ...
    {
        $file = $this
            ->getMockBuilder('Symphony\Component\HttpFoundation\File\File')
    ...
    public function uploadedFileErrorProvider()
    {
        ...
        if (class_exists('Symphony\Component\HttpFoundation\File\UploadedFile')) {
