...
/**
 * Compiles a call to {@link \Symphony\Component\Form\FormRendererInterface::renderBlock()}.
 *
...
class RenderBlockNode extends FunctionExpression
{
    public function compile(Compiler $compiler)
    {
        ...
        $compiler->write('$this->env->getRuntime(\'Symphony\Component\Form\FormRenderer\')->renderBlock(');
