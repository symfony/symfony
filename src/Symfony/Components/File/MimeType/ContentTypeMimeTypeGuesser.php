...
namespace Symfony\Components\File\MimeType;

use Symfony\Components\File\Exception\FileNotFoundException;
use Symfony\Components\File\Exception\AccessDeniedException;
