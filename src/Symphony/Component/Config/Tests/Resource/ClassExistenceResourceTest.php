...
use Symphony\Component\Config\Tests\Fixtures\Resource\ConditionalClass;
use Symphony\Component\Config\Tests\Fixtures\BadParent;
...
class ClassExistenceResourceTest extends TestCase
{
    ...
    {
        $res = new ClassExistenceResource('Symphony\Component\Config\Tests\Fixtures\BarClass');
...
EOF
    ...
    {
        $res = new ClassExistenceResource('Symphony\Component\Config\Tests\Resource\ClassExistenceResourceTest');
     ...
     * @expectedExceptionMessage Class Symphony\Component\Config\Tests\Fixtures\MissingParent not found
     */
