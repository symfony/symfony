...
class HelperSetTest extends TestCase
{
    ...
    public function testGet()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('Symphony\Component\Console\Exception\ExceptionInterface', $e, '->get() throws domain specific exception when helper not found');
    ...
    {
        $mock_helper = $this->getMockBuilder('\Symphony\Component\Console\Helper\HelperInterface')->getMock();
