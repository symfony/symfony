...
use Symphony\Component\DependencyInjection\Tests\Fixtures\Bar;
use Symphony\Component\DependencyInjection\Tests\Fixtures\BarInterface;
use Symphony\Component\DependencyInjection\Tests\Fixtures\CaseSensitiveClass;
use Symphony\Component\DependencyInjection\Tests\Fixtures\Prototype;
use Symphony\Component\DependencyInjection\Tests\Fixtures\NamedArgumentsDummy;
...
class XmlFileLoaderTest extends TestCase
{
    ...
    public function testParseFile()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('Symphony\\Component\\DependencyInjection\\Exception\\InvalidArgumentException', $e, '->parseFileToDOM() throws an InvalidArgumentException if the loaded file is not a valid XML file');
        ...
        try {
            ...
            $this->assertInstanceOf('Symphony\\Component\\DependencyInjection\\Exception\\InvalidArgumentException', $e, '->parseFileToDOM() throws an InvalidArgumentException if the loaded file does not validate the XSD');
    ...
    public function testLoadAnonymousServices()
    {
        ...
        $this->assertInstanceOf('Symphony\\Component\\DependencyInjection\\Reference', $args[0], '->load() converts anonymous services to references to "normal" services');
        ...
        $this->assertInstanceOf('Symphony\\Component\\DependencyInjection\\Reference', $property, '->load() converts anonymous services to references to "normal" services');
    ...
    public function testLoadServices()
    {
        ...
        $this->assertInstanceOf('Symphony\\Component\\DependencyInjection\\Definition', $services['foo'], '->load() converts <service> element to Definition instances');
    ...
    public function testExtensions()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('Symphony\\Component\\DependencyInjection\\Exception\\InvalidArgumentException', $e, '->load() throws an InvalidArgumentException if the configuration does not validate the XSD');
    ...
    public function testDocTypeIsNotAllowed()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('Symphony\\Component\\DependencyInjection\\Exception\\InvalidArgumentException', $e, '->load() throws an InvalidArgumentException if the configuration contains a document type');
    ...
    public function testPrototype()
    {
        ...
        $this->assertContains('reflection.Symphony\Component\DependencyInjection\Tests\Fixtures\Prototype\Foo', $resources);
        $this->assertContains('reflection.Symphony\Component\DependencyInjection\Tests\Fixtures\Prototype\Sub\Bar', $resources);
    }
