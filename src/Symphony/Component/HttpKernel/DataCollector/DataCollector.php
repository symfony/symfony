...
use Symphony\Component\VarDumper\Caster\CutStub;
    ...
    protected function cloneVar($var)
    {
        ...
        if (null === $this->cloner) {
            if (!class_exists(CutStub::class)) {
                throw new \LogicException(sprintf('The VarDumper component is needed for the %s() method. Install symphony/var-dumper version 3.4 or above.', __METHOD__));
            }
