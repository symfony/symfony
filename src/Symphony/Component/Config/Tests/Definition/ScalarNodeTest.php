...
use Symphony\Component\Config\Definition\ArrayNode;
use Symphony\Component\Config\Definition\ScalarNode;
...
class ScalarNodeTest extends TestCase
{
    ...
    public function testNormalizeThrowsExceptionWithoutHint()
    {
        ...
        if (method_exists($this, 'expectException')) {
            $this->expectException('Symphony\Component\Config\Definition\Exception\InvalidTypeException');
            $this->expectExceptionMessage('Invalid type for path "test". Expected scalar, but got array.');
        } else {
            $this->setExpectedException('Symphony\Component\Config\Definition\Exception\InvalidTypeException', 'Invalid type for path "test". Expected scalar, but got array.');
        }
     ...
     * @expectedException \Symphony\Component\Config\Definition\Exception\InvalidConfigurationException
     *
     * @param mixed $value
     */
