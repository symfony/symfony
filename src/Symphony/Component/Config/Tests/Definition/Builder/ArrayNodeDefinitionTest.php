...
use Symphony\Component\Config\Definition\Exception\InvalidDefinitionException;
...
class ArrayNodeDefinitionTest extends TestCase
{
    ...
    public function testNestedPrototypedArrayNodes()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\Config\Definition\PrototypedArrayNode', $node);
        $this->assertInstanceOf('Symphony\Component\Config\Definition\PrototypedArrayNode', $node->getPrototype());
    }
