...
class PercentToLocalizedStringTransformerTest extends TestCase
{
    ...
    public function testTransformExpectsNumeric()
    {
        ...
        $this->{method_exists($this, $_ = 'expectException') ? $_ : 'setExpectedException'}('Symphony\Component\Form\Exception\TransformationFailedException');
    ...
    public function testDecimalSeparatorMayBeCommaIfGroupingSeparatorIsCommaButNoGroupingUsed()
    {
        ...
        $transformer = $this->getMockBuilder('Symphony\Component\Form\Extension\Core\DataTransformer\PercentToLocalizedStringTransformer')
