...
use Symphony\Bridge\Twig\AppVariable;
...
class AppVariableTest extends TestCase
{
    ...
    {
        $this->setTokenStorage($user = $this->getMockBuilder('Symphony\Component\Security\Core\User\UserInterface')->getMock());
    ...
    {
        $requestStackMock = $this->getMockBuilder('Symphony\Component\HttpFoundation\RequestStack')->getMock();
