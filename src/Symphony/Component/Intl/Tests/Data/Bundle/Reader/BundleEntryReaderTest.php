...
class BundleEntryReaderTest extends TestCase
{
    ...
    {
        $this->readerImpl = $this->getMockBuilder('Symphony\Component\Intl\Data\Bundle\Reader\BundleEntryReaderInterface')->getMock();
    ...
    /**
     * @expectedException \Symphony\Component\Intl\Exception\MissingResourceException
     */
