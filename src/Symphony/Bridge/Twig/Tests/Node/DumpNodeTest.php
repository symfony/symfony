...
use Symphony\Bridge\Twig\Node\DumpNode;
use Twig\Compiler;
...
if ($this->env->isDebug()) {
    ...
    // line 7
    \Symphony\Component\VarDumper\VarDumper::dump($barvars);
}
...
if ($this->env->isDebug()) {
    // line 7
    \Symphony\Component\VarDumper\VarDumper::dump(%foo%);
}
...
if ($this->env->isDebug()) {
    // line 7
    \Symphony\Component\VarDumper\VarDumper::dump(array(
        "foo" => %foo%,
        "bar" => %bar%,
    ));
}
