...
class MongoDbTagAwareAdapter extends AbstractTagAwareAdapter implements PruneableInterface
{
    ...
    /**
     * @see MongoDbAdapter::__construct() for the list of available options
     */
    public function __construct(
        ...
        $this->init($mongo, $namespace, $defaultLifetime, $options, new TagAwareMarshaller($marshaller), $clock);
    }
