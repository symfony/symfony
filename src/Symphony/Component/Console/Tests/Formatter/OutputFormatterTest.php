...
namespace Symphony\Component\Console\Tests\Formatter;

use PHPUnit\Framework\TestCase;
use Symphony\Component\Console\Formatter\OutputFormatter;
use Symphony\Component\Console\Formatter\OutputFormatterStyle;
...
class OutputFormatterTest extends TestCase
{
    ...
    public function testLGCharEscaping()
    {
        ...
        $this->assertEquals(
            "\033[33mSymphony\\Component\\Console does work very well!\033[39m",
            $formatter->format('<comment>Symphony\Component\Console does work very well!</comment>')
        );
    }
