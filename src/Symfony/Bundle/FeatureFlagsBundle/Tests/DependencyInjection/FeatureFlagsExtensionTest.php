...
use Symfony\Bundle\FeatureFlagsBundle\DependencyInjection\FeatureFlagsExtension;
use Symfony\Component\DependencyInjection\ContainerBuilder;
use Symfony\Component\DependencyInjection\ParameterBag\ParameterBag;
use Symfony\Component\FeatureFlags\Strategy\StrategyInterface;

/**
 * @covers \Symfony\Bundle\FeatureFlagsBundle\DependencyInjection\FeatureFlagsExtension
 *
...
final class FeatureFlagsExtensionTest extends TestCase
{
    ...
    {
        $extension = new FeatureFlagsExtension();
        ...
        foreach ($expectedServiceIds as $expectedServiceId) {
            ...
            if (\in_array($expectedServiceId, $serviceIds, true)) {
                ...
                $tagConfigs = $serviceDefinition->getTag('feature_flags.feature_strategy');
