...
use Symphony\Component\DependencyInjection\Compiler\ResolveBindingsPass;
...
class ResolveBindingsPassTest extends TestCase
{
     ...
     * @expectedExceptionMessage Unused binding "$quz" in service "Symphony\Component\DependencyInjection\Tests\Fixtures\NamedArgumentsDummy".
     */
