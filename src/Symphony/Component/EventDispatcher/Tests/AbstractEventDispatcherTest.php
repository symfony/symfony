...
abstract class AbstractEventDispatcherTest extends TestCase
{
    ...
    public function testDispatch()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\EventDispatcher\Event', $this->dispatcher->dispatch('noevent'));
        $this->assertInstanceOf('Symphony\Component\EventDispatcher\Event', $this->dispatcher->dispatch(self::preFoo));
        $event = new Event();
    ...
    public function testAddSubscriberWithPriorities()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\EventDispatcher\Tests\TestEventSubscriberWithPriorities', $listeners[0][0]);
    }
