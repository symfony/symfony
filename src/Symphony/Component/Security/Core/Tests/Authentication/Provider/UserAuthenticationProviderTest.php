...
class UserAuthenticationProviderTest extends TestCase
{
    ...
    /**
     * @expectedException \Symphony\Component\Security\Core\Exception\CredentialsExpiredException
     */
    public function testAuthenticateWhenPreChecksFails()
    {
        ...
        $provider->expects($this->once())
                 ->method('retrieveUser')
                 ->will($this->returnValue($this->getMockBuilder('Symphony\Component\Security\Core\User\UserInterface')->getMock()))
        ;
    ...
    /**
     * @expectedException \Symphony\Component\Security\Core\Exception\AccountExpiredException
     */
    ...
    public function testAuthenticate()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\Security\Core\Authentication\Token\UsernamePasswordToken', $authToken);
    ...
    public function testAuthenticateWithPreservingRoleSwitchUserRole()
    {
        ...
        $switchUserRole = new SwitchUserRole('foo', $this->getMockBuilder('Symphony\Component\Security\Core\Authentication\Token\TokenInterface')->getMock());
        $token->expects($this->once())
              ->method('getRoles')
    ...
    {
        $mock = $this->getMockBuilder('Symphony\Component\Security\Core\Authentication\Token\UsernamePasswordToken')->setMethods(array('getCredentials', 'getProviderKey', 'getRoles'))->disableOriginalConstructor()->getMock();
        $mock
            ->expects($this->any())
    ...
    protected function getProvider($userChecker = false, $hide = true)
    {
        ...
        return $this->getMockForAbstractClass('Symphony\Component\Security\Core\Authentication\Provider\UserAuthenticationProvider', array($userChecker, 'key', $hide));
    }
}
