...
class ApplicationTest extends TestCase
{
    ...
    {
        $application = new Application();
        $this->assertStringEqualsFile(self::$fixturesPath.'/application_gethelp.txt', $application->getHelp(), '->getHelp() returns a help message');
    }
...
', $tester->getDisplay());
    ...
    public function testSetCatchExceptions()
    {
        ...
        $this->assertStringEqualsFile(self::$fixturesPath.'/application_renderexception1.txt', $tester->getErrorOutput(), '->setCatchExceptions() sets the catch exception flag');
    ...
    public function testRenderException()
    {
        ...
        $tester->run(array('command' => 'foo'), array('decorated' => false, 'capture_stderr_separately' => true));
        $this->assertStringEqualsFile(self::$fixturesPath.'/application_renderexception1.txt', $tester->getErrorOutput(), '->renderException() renders a pretty exception');
        ...
        $this->assertStringEqualsFile(self::$fixturesPath.'/application_renderexception2.txt', $tester->getErrorOutput(), '->renderException() renders the command synopsis when an exception occurs in the context of a command');

        $application->add(new \Foo3Command());
        $tester = new ApplicationTester($application);
        $tester->run(array('command' => 'foo3:bar'), array('decorated' => false, 'capture_stderr_separately' => true));
        $this->assertStringEqualsFile(self::$fixturesPath.'/application_renderexception3.txt', $tester->getErrorOutput(), '->renderException() renders a pretty exceptions with previous exceptions');
        ...
        $this->assertStringEqualsFile(self::$fixturesPath.'/application_renderexception3decorated.txt', $tester->getDisplay(), '->renderException() renders a pretty exceptions with previous exceptions');

        $tester->run(array('command' => 'foo3:bar'), array('decorated' => true, 'capture_stderr_separately' => true));
        $this->assertStringEqualsFile(self::$fixturesPath.'/application_renderexception3decorated.txt', $tester->getErrorOutput(), '->renderException() renders a pretty exceptions with previous exceptions');
        ...
        $tester->run(array('command' => 'foo'), array('decorated' => false,  'capture_stderr_separately' => true));
        $this->assertStringEqualsFile(self::$fixturesPath.'/application_renderexception4.txt', $tester->getErrorOutput(), '->renderException() wraps messages when they are bigger than the terminal');
        putenv('COLUMNS=120');
    }
    ...
    public function testRenderExceptionWithDoubleWidthCharacters()
    {
        ...
        $tester->run(array('command' => 'foo'), array('decorated' => false, 'capture_stderr_separately' => true));
        $this->assertStringMatchesFormatFile(self::$fixturesPath.'/application_renderexception_doublewidth1.txt', $tester->getErrorOutput(), '->renderException() renders a pretty exceptions with previous exceptions');

        $tester->run(array('command' => 'foo'), array('decorated' => true, 'capture_stderr_separately' => true));
        $this->assertStringMatchesFormatFile(self::$fixturesPath.'/application_renderexception_doublewidth1decorated.txt', $tester->getErrorOutput(), '->renderException() renders a pretty exceptions with previous exceptions');
        ...
        $tester = new ApplicationTester($application);
        $tester->run(array('command' => 'foo'), array('decorated' => false, 'capture_stderr_separately' => true));
        $this->assertStringMatchesFormatFile(self::$fixturesPath.'/application_renderexception_doublewidth2.txt', $tester->getErrorOutput(), '->renderException() wraps messages when they are bigger than the terminal');
        putenv('COLUMNS=120');
    }
    ...
    public function testRenderExceptionEscapesLines()
    {
        ...
        $tester->run(array('command' => 'foo'), array('decorated' => false));
        $this->assertStringMatchesFormatFile(self::$fixturesPath.'/application_renderexception_escapeslines.txt', $tester->getDisplay(), '->renderException() escapes lines containing formatting');
        putenv('COLUMNS=120');
    }
    ...
    public function testRenderExceptionLineBreaks()
    {
        ...
        $tester->run(array('command' => 'foo'), array('decorated' => false));
        $this->assertStringMatchesFormatFile(self::$fixturesPath.'/application_renderexception_linebreaks.txt', $tester->getDisplay(), '->renderException() keep multiple line breaks');
    }
    ...
    public function testRenderAnonymousException()
    {
        ...
        $tester->run(array('command' => 'foo'), array('decorated' => false));
        $this->assertContains('[InvalidArgumentException@anonymous]', $tester->getDisplay());
        ...
        $tester->run(array('command' => 'foo'), array('decorated' => false));
        $this->assertContains('Dummy type "@anonymous" is invalid.', $tester->getDisplay());
    }
    ...
    public function testRun()
    {
        ...
        $this->assertSame("called\n", $tester->getDisplay(), '->run() does not call interact() if --no-interaction is passed');

        $tester->run(array('command' => 'foo:bar', '-n' => true), array('decorated' => false));
        $this->assertSame("called\n", $tester->getDisplay(), '->run() does not call interact() if -n is passed');
    }
    ...
    public function testRunWithDispatcher()
    {
        ...
        $this->assertEquals("before.foo.after.\n", $tester->getDisplay());
    }
    ...
    public function testSetRunCustomDefaultCommand()
    {
        ...
        $this->assertEquals("called\n", $tester->getDisplay(), 'Application runs the default set command if different from \'list\' command');
