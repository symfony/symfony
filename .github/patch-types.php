...
foreach ($loader->getClassMap() as $class => $file) {
    switch (true) {
        ...
        case str_contains($file, '/src/Symfony/Component/PropertyInfo/Tests/Fixtures/Dummy.php'):
        case str_contains($file, '/src/Symfony/Component/PropertyInfo/Tests/Fixtures/ParentDummy.php'):
        case str_contains($file, '/src/Symfony/Component/PropertyInfo/Tests/Fixtures/TraitUsage/DummyUsingTrait.php'):
