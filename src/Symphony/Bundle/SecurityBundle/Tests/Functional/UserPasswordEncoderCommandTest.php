...
use Symphony\Bundle\SecurityBundle\Command\UserPasswordEncoderCommand;
use Symphony\Component\Console\Application as ConsoleApplication;
...
use Symphony\Component\Security\Core\Encoder\Pbkdf2PasswordEncoder;
...
class UserPasswordEncoderCommandTest extends WebTestCase
{
    ...
    public function testEncodePasswordEmptySalt()
    {
        $this->passwordEncoderCommandTester->execute(array(
            ...
            'password' => 'password',
            'user-class' => 'Symphony\Component\Security\Core\User\User',
            '--empty-salt' => true,
 ...
 For which user class would you like to encode a password? [Custom\Class\Bcrypt\User]:
  ...
  [3] Symphony\Component\Security\Core\User\User
EOTXT
    ...
    public function testNonInteractiveEncodePasswordUsesFirstUserClass()
    {
        ...
        $this->assertContains('Encoder used       Symphony\Component\Security\Core\Encoder\PlaintextPasswordEncoder', $this->passwordEncoderCommandTester->getDisplay());
    }
