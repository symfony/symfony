...
class FrameworkExtension extends Extension
{
    ...
    private function registerMailerConfiguration(array $config, ContainerBuilder $container, PhpFileLoader $loader, bool $webhookEnabled): void
    {
        ...
        if ($config['dkim_signer']['enabled']) {
            ...
            $container->getDefinition('mailer.dkim_signer.listener')->replaceArgument(0, $dkimSigner);
        } else {
        ...
        if ($config['smime_signer']['enabled']) {
            ...
            $container->getDefinition('mailer.smime_signer.listener')->replaceArgument(0, $smimeSigner);
        } else {
        ...
        if ($config['smime_encrypter']['enabled']) {
            ...
            $container->getDefinition('mailer.smime_encrypter.listener')->replaceArgument(0, $smimeSigner);
        } else {
