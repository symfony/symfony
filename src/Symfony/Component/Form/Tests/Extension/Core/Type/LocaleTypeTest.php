...
class LocaleTypeTest extends BaseTypeTest
{
    ...
    public function testLocalesAreSelectable()
    {
        ...
        self::assertContainsEquals(new ChoiceView('zh_Hant_HK', 'zh_Hant_HK', 'Chinese (Traditional, Hong Kong SAR China)'), $choices);
    }
    ...
    public function testChoiceTranslationLocaleOption()
    {
        ...
        self::assertContainsEquals(new ChoiceView('en_GB', 'en_GB', 'англійська (Велика Британія)'), $choices);
        self::assertContainsEquals(new ChoiceView('zh_Hant_TW', 'zh_Hant_TW', 'китайська (традиційна, Тайвань)'), $choices);
    }
