...
namespace Symphony\Component\Translation\Command;
...
EOF
    ...
    private function display(SymphonyStyle $io, array $files)
    {
        switch ($this->format) {
            case 'txt':
    ...
    private function displayTxt(SymphonyStyle $io, array $filesInfo)
    {
    ...
    private function displayJson(SymphonyStyle $io, array $filesInfo)
    {
        $errors = 0;
