...
namespace Symphony\Component\CssSelector\Tests\Parser;

use PHPUnit\Framework\TestCase;
use Symphony\Component\CssSelector\Exception\SyntaxErrorException;
use Symphony\Component\CssSelector\Node\FunctionNode;
use Symphony\Component\CssSelector\Node\SelectorNode;
use Symphony\Component\CssSelector\Parser\Parser;
...
class ParserTest extends TestCase
{
    ...
    public function testParseSeriesException($series)
    {
        ...
        /** @var FunctionNode $function */
        $function = $selectors[0]->getTree();
        $this->{method_exists($this, $_ = 'expectException') ? $_ : 'setExpectedException'}('Symphony\Component\CssSelector\Exception\SyntaxErrorException');
