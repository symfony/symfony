...
class Profile
{
     ...
     */
    public function addProfileData($name, ProfileDataInterface $profileData = null)
    {
        $this->data[$name] = $profileData;
    }

    /**
     * Returns true if a ProfileData for the given name exists.
     *
     * @param string $name A ProfileData name
     *
     * @return bool
     */
    public function hasProfileData($name)
    {
        return isset($this->data[$name]);
    }

    /**
     * Gets a ProfileData by name.
     *
     * @param string $name A ProfileData name
     *
     * @return ProfileDataInterface A ProfileDataInterface instance
     *
     * @throws \InvalidArgumentException if the collector does not exist
     */
    public function getProfileData($name)
    {
    ...
    public function setData(array $data)
    {
        ...
        foreach ($data as $name => $profileData) {
            $this->addProfileData($name, $profileData);
        }
    }
