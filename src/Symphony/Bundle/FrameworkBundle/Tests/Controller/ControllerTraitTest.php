...
use Symphony\Bundle\FrameworkBundle\Controller\ControllerTrait;
use Symphony\Component\DependencyInjection\Container;
use Symphony\Component\HttpFoundation\BinaryFileResponse;
...
abstract class ControllerTraitTest extends TestCase
{
    ...
    {
        $tokenStorage = $this->getMockBuilder('Symphony\Component\Security\Core\Authentication\Token\Storage\TokenStorage')->getMock();
        $tokenStorage
            ->expects($this->once())
            ->method('getToken')
    ...
    /**
     * @expectedException \Symphony\Component\HttpFoundation\File\Exception\FileNotFoundException
     */
    ...
    {
        $authorizationChecker = $this->getMockBuilder('Symphony\Component\Security\Core\Authorization\AuthorizationCheckerInterface')->getMock();
    ...
    public function testStreamTwig()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\HttpFoundation\StreamedResponse', $controller->stream('foo'));
    }
    ...
    public function testAddFlash()
    {
        ...
        $session = $this->getMockBuilder('Symphony\Component\HttpFoundation\Session\Session')->getMock();
    ...
    public function testCreateAccessDeniedException()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\Security\Core\Exception\AccessDeniedException', $controller->createAccessDeniedException());
    }

    public function testIsCsrfTokenValid()
    {
        $tokenManager = $this->getMockBuilder('Symphony\Component\Security\Csrf\CsrfTokenManagerInterface')->getMock();
    ...
    {
        $templating = $this->getMockBuilder('Symphony\Bundle\FrameworkBundle\Templating\EngineInterface')->getMock();
    ...
    public function testCreateNotFoundException()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\HttpKernel\Exception\NotFoundHttpException', $controller->createNotFoundException());
    }

    public function testCreateForm()
    {
        $form = $this->getMockBuilder('Symphony\Component\Form\FormInterface')->getMock();

        $formFactory = $this->getMockBuilder('Symphony\Component\Form\FormFactoryInterface')->getMock();
    ...
    {
        $formBuilder = $this->getMockBuilder('Symphony\Component\Form\FormBuilderInterface')->getMock();
