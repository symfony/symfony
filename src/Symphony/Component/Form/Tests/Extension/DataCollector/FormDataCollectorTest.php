...
use Symphony\Component\Form\Extension\DataCollector\FormDataCollector;
...
class FormDataCollectorTest extends TestCase
{
    ...
    {
        $this->dataExtractor = $this->getMockBuilder('Symphony\Component\Form\Extension\DataCollector\FormDataExtractorInterface')->getMock();
