...
class YamlFileLoaderTest extends TestCase
{
    ...
    public function testNonArrayTagsThrowsException()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('Symphony\Component\DependencyInjection\Exception\InvalidArgumentException', $e, '->load() throws an InvalidArgumentException if the tags key is not an array');
    ...
    public function testTagWithoutNameThrowsException()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('Symphony\Component\DependencyInjection\Exception\InvalidArgumentException', $e, '->load() throws an InvalidArgumentException if a tag is missing the name key');
    ...
    public function testTagWithAttributeArrayThrowsException()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('Symphony\Component\DependencyInjection\Exception\InvalidArgumentException', $e, '->load() throws an InvalidArgumentException if a tag-attribute is not a scalar');
