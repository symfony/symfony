...
namespace Symphony\Bundle\TwigBundle\DependencyInjection;
            ...
            ->children()
                ...
                ->booleanNode('strict_variables')
                    ->defaultValue(function () {
                        @trigger_error('Relying on the default value ("false") of the "twig.strict_variables" configuration option is deprecated since Symphony 4.1. You should use "%kernel.debug%" explicitly instead, which will be the new default in 5.0.', E_USER_DEPRECATED);
