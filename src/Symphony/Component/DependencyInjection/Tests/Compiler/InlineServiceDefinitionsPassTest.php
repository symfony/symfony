...
use Symphony\Component\DependencyInjection\Compiler\InlineServiceDefinitionsPass;
...
class InlineServiceDefinitionsPassTest extends TestCase
{
    public function testProcess()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\DependencyInjection\Definition', $arguments[0]);
