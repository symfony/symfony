...
class Symfony_Component_Serializer_Tests_Fixtures_CustomNormalizer_NoTypeHints_InheritanceChild implements NormalizerInterface, DenormalizerInterface, NormalizerAwareInterface
{
    ...
    */
    ...
    {
        return ['childCute' => $this->normalizeChild($object->getChildCute(), $format, $context, true), 'cute' => $this->normalizeChild($object->getCute(), $format, $context, true), 'childName' => $this->normalizeChild($object->childName, $format, $context, true), 'name' => $this->normalizeChild($object->name, $format, $context, true), 'childAge' => $this->normalizeChild($object->getChildAge(), $format, $context, true), 'childHeight' => $this->normalizeChild($object->getChildHeight(), $format, $context, true), 'age' => $this->normalizeChild($object->getAge(), $format, $context, true), 'height' => $this->normalizeChild($object->getHeight(), $format, $context, true), 'handsome' => $this->normalizeChild($object->getHandsome(), $format, $context, true)];
    }
