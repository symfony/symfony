...
use Symphony\Bridge\PhpUnit\DnsMock;
use Symphony\Component\Validator\Constraints\Email;
use Symphony\Component\Validator\Constraints\EmailValidator;
...
class EmailValidatorTest extends ConstraintValidatorTestCase
{
    ...
    /**
     * @expectedDeprecation Calling `new Symphony\Component\Validator\Constraints\EmailValidator(true)` is deprecated since Symphony 4.1, use `new Symphony\Component\Validator\Constraints\EmailValidator("strict")` instead.
     * @group legacy
     */
    ...
    /**
     * @expectedException \InvalidArgumentException
     * @expectedExceptionMessage The Symphony\Component\Validator\Constraints\Email::$mode parameter value is not valid.
     */
     ...
     * @expectedDeprecation The Symphony\Component\Validator\Constraints\Email::$strict property is deprecated since Symphony 4.1. Use Symphony\Component\Validator\Constraints\Email::mode="strict" instead.
     * @group legacy
     */
     ...
     * @requires function Symphony\Bridge\PhpUnit\DnsMock::withMockedHosts
     */
