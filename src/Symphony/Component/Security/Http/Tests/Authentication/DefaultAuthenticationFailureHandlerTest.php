...
namespace Symphony\Component\Security\Http\Tests\Authentication;
...
class DefaultAuthenticationFailureHandlerTest extends TestCase
{
    ...
    {
        $this->httpKernel = $this->getMockBuilder('Symphony\Component\HttpKernel\HttpKernelInterface')->getMock();
        $this->httpUtils = $this->getMockBuilder('Symphony\Component\Security\Http\HttpUtils')->getMock();
        $this->logger = $this->getMockBuilder('Psr\Log\LoggerInterface')->getMock();

        $this->session = $this->getMockBuilder('Symphony\Component\HttpFoundation\Session\SessionInterface')->getMock();
        ...
        $this->exception = $this->getMockBuilder('Symphony\Component\Security\Core\Exception\AuthenticationException')->setMethods(array('getMessage'))->getMock();
    }
    ...
    private function getRequest()
    {
        ...
        $request->attributes = $this->getMockBuilder('Symphony\Component\HttpFoundation\ParameterBag')->getMock();
