...
class ValidatorBuilderTest extends TestCase
{
    ...
    public function testAddObjectInitializer()
    {
        $this->assertSame($this->builder, $this->builder->addObjectInitializer(
            $this->getMockBuilder('Symphony\Component\Validator\ObjectInitializerInterface')->getMock()
        ));
    }
    ...
    public function testSetMetadataCache()
    {
        $this->assertSame($this->builder, $this->builder->setMetadataCache(
            $this->getMockBuilder('Symphony\Component\Validator\Mapping\Cache\CacheInterface')->getMock())
        );
    }
    ...
    public function testSetConstraintValidatorFactory()
    {
        $this->assertSame($this->builder, $this->builder->setConstraintValidatorFactory(
            $this->getMockBuilder('Symphony\Component\Validator\ConstraintValidatorFactoryInterface')->getMock())
        );
    }
    ...
    public function testSetTranslator()
    {
        $this->assertSame($this->builder, $this->builder->setTranslator(
            $this->getMockBuilder('Symphony\Component\Translation\TranslatorInterface')->getMock())
        );
    }
    ...
    {
        $this->assertInstanceOf('Symphony\Component\Validator\Validator\RecursiveValidator', $this->builder->getValidator());
    }
}
