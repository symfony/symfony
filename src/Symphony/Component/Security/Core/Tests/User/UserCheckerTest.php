...
class UserCheckerTest extends TestCase
{
    public function testCheckPostAuthNotAdvancedUserInterface()
    {
        ...
        $this->assertNull($checker->checkPostAuth($this->getMockBuilder('Symphony\Component\Security\Core\User\UserInterface')->getMock()));
    }
    ...
    /**
     * @group legacy
     * @expectedDeprecation Calling Symphony\Component\Security\Core\User\UserChecker::checkPostAuth with an AdvancedUserInterface is deprecated since Symphony 4.1. Create a custom user checker if you wish to keep this functionality.
     */
    public function testCheckPostAuthPassAdvancedUser()
    {
        $checker = new UserChecker();

        $account = $this->getMockBuilder('Symphony\Component\Security\Core\User\AdvancedUserInterface')->getMock();
    ...
    /**
     * @group legacy
     * @expectedDeprecation Calling Symphony\Component\Security\Core\User\UserChecker::checkPreAuth with an AdvancedUserInterface is deprecated since Symphony 4.1. Create a custom user checker if you wish to keep this functionality.
     */
