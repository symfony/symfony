...
class KernelTest extends TestCase
{
    ...
    public function testInitializeContainerClearsOldContainers()
    {
        ...
        $this->assertTrue(unlink(__DIR__.'/Fixtures/var/cache/custom/TestsSymfony_Component_Kernel_Tests_CustomProjectDirKernelCustomDebugContainer.php.meta'));
...
EOF;
    ...
    public function testSerialize()
    {
        ...
        $expected = 'O:53:"Symfony\\Component\\Kernel\\Tests\\Fixtures\\KernelForTest":2:{s:14:"'."\0".'*'."\0".'environment";s:8:"test_env";s:8:"'."\0".'*'."\0".'debug";b:1;}';
    ...
    public function testKernelReset()
    {
        ...
        unlink(__DIR__.'/Fixtures/var/cache/custom/TestsSymfony_Component_Kernel_Tests_CustomProjectDirKernelCustomDebugContainer.php.meta');
