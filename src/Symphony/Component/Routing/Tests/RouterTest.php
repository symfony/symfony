...
use Symphony\Component\Routing\Router;
...
class RouterTest extends TestCase
{
    ...
    {
        $this->loader = $this->getMockBuilder('Symphony\Component\Config\Loader\LoaderInterface')->getMock();
    ...
    public function testMatcherIsCreatedIfCacheIsNotConfigured($option)
    {
        ...
        $this->assertInstanceOf('Symphony\\Component\\Routing\\Matcher\\UrlMatcher', $this->router->getMatcher());
    }
    ...
    public function testGeneratorIsCreatedIfCacheIsNotConfigured($option)
    {
        ...
        $this->assertInstanceOf('Symphony\\Component\\Routing\\Generator\\UrlGenerator', $this->router->getGenerator());
    }
    ...
    {
        $matcher = $this->getMockBuilder('Symphony\Component\Routing\Matcher\UrlMatcherInterface')->getMock();
    ...
    {
        $matcher = $this->getMockBuilder('Symphony\Component\Routing\Matcher\RequestMatcherInterface')->getMock();
