...
class SodiumPasswordHasherTest extends TestCase
{
    ...
    {
        $hasher = new SodiumPasswordHasher();
        self::assertTrue($hasher->verify('$2y$04$M8GDODMoGQLQRpkYCdoJh.lbiZPee3SZI32RcYK49XYTolDGwoRMm', 'abc', null));
    }
    ...
    public function testCheckPasswordLength()
    {
        ...
        self::assertFalse($hasher->verify($result, str_repeat('a', 4097), null));
        self::assertTrue($hasher->verify($result, str_repeat('a', 4096), null));
    }
    ...
    public function testBcryptWithLongPassword()
    {
        ...
        self::assertTrue($hasher->verify((new NativePasswordHasher(null, null, 4, \PASSWORD_BCRYPT))->hash($plainPassword), $plainPassword, 'salt'));
    }
    ...
    public function testUserProvidedSaltIsNotUsed()
    {
        ...
        self::assertTrue($hasher->verify($result, 'password', 'anotherSalt'));
    }
