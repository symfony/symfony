...
use Symphony\Component\Validator\Constraints\Locale;
use Symphony\Component\Validator\Constraints\LocaleValidator;
...
class LocaleValidatorTest extends ConstraintValidatorTestCase
{
    ...
    /**
     * @group legacy
     * @expectedDeprecation The "canonicalize" option with value "false" is deprecated since Symphony 4.1, set it to "true" instead.
     *
