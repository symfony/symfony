 ...
 *
 * Each bridge defines its own scheme (`sodium://`, `hashicorp-vault-transit://`, ...).
 *
 * The object is a secret in itself, as it carries the password and any inline key material: every
 * parameter receiving one is `#[\SensitiveParameter]` so that it stays out of stack traces.
 *
