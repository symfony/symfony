...
use Symphony\Component\Form\FormFactory;
...
class FormFactoryTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->registry = $this->getMockBuilder('Symphony\Component\Form\FormRegistryInterface')->getMock();
        $this->builder = $this->getMockBuilder('Symphony\Component\Form\Test\FormBuilderInterface')->getMock();
    ...
    public function testCreateUsesBlockPrefixIfTypeGivenAsString()
    {
        ...
        $resolvedType = $this->getMockBuilder('Symphony\Component\Form\ResolvedFormType')
    ...
    {
        $registry = $this->getMockBuilder('Symphony\Component\Form\FormRegistryInterface')->getMock();
        $factory = $this->getMockBuilder('Symphony\Component\Form\FormFactory')
        ...
        $factory->expects($this->once())
            ...
            ->with('firstName', 'Symphony\Component\Form\Extension\Core\Type\TextType', null, array())
    ...
    public function testCreateBuilderForPropertyCreatesFormWithHighestConfidence()
    {
        ...
        $this->guesser2->expects($this->once())
            ...
            ->with('Application\Author', 'firstName')
            ->will($this->returnValue(new TypeGuess(
                'Symphony\Component\Form\Extension\Core\Type\PasswordType',
        ...
        $factory->expects($this->once())
            ->method('createNamedBuilder')
            ->with('firstName', 'Symphony\Component\Form\Extension\Core\Type\PasswordType', null, array('attr' => array('maxlength' => 7)))
            ->will($this->returnValue('builderInstance'));
    ...
    public function testCreateBuilderCreatesTextFormIfNoGuess()
    {
        ...
        $factory->expects($this->once())
            ->method('createNamedBuilder')
            ->with('firstName', 'Symphony\Component\Form\Extension\Core\Type\TextType')
            ->will($this->returnValue('builderInstance'));
    ...
    public function testOptionsCanBeOverridden()
    {
        ...
        $factory->expects($this->once())
            ->method('createNamedBuilder')
            ->with('firstName', 'Symphony\Component\Form\Extension\Core\Type\TextType', null, array('attr' => array('class' => 'foo', 'maxlength' => 11)))
            ->will($this->returnValue('builderInstance'));
    ...
    public function testCreateBuilderUsesMaxLengthIfFound()
    {
        ...
        $factory->expects($this->once())
            ->method('createNamedBuilder')
            ->with('firstName', 'Symphony\Component\Form\Extension\Core\Type\TextType', null, array('attr' => array('maxlength' => 20)))
            ->will($this->returnValue('builderInstance'));
    ...
    public function testCreateBuilderUsesMaxLengthAndPattern()
    {
        ...
        $factory->expects($this->once())
            ->method('createNamedBuilder')
            ->with('firstName', 'Symphony\Component\Form\Extension\Core\Type\TextType', null, array('attr' => array('maxlength' => 20, 'pattern' => '.{5,}', 'class' => 'tinymce')))
            ->will($this->returnValue('builderInstance'));
    ...
    public function testCreateBuilderUsesRequiredSettingWithHighestConfidence()
    {
        ...
        $factory->expects($this->once())
            ->method('createNamedBuilder')
            ->with('firstName', 'Symphony\Component\Form\Extension\Core\Type\TextType', null, array('required' => false))
            ->will($this->returnValue('builderInstance'));
    ...
    public function testCreateBuilderUsesPatternIfFound()
    {
        ...
        $factory->expects($this->once())
            ->method('createNamedBuilder')
            ->with('firstName', 'Symphony\Component\Form\Extension\Core\Type\TextType', null, array('attr' => array('pattern' => '[a-zA-Z]')))
            ->will($this->returnValue('builderInstance'));
    ...
    {
        return $this->getMockBuilder('Symphony\Component\Form\FormFactory')
            ->setMethods($methods)
    ...
    {
        return $this->getMockBuilder('Symphony\Component\Form\ResolvedFormTypeInterface')->getMock();
    }
}
