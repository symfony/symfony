...
class DigestAuthenticationListener implements ListenerInterface
{
    ...
    {
        @trigger_error(sprintf('The %s class and the whole HTTP digest authentication system is deprecated since Symfony 3.4 and will be removed in 4.0.', self::class), E_USER_DEPRECATED);
