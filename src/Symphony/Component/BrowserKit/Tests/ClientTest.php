...
use Symphony\Component\BrowserKit\Client;
use Symphony\Component\BrowserKit\History;
use Symphony\Component\BrowserKit\CookieJar;
use Symphony\Component\BrowserKit\Response;
...
class TestClient extends Client
{
    ...
    {
        $r = new \ReflectionClass('Symphony\Component\BrowserKit\Response');
        $path = $r->getFileName();
...
class ClientTest extends TestCase
{
    ...
    /**
     * @group legacy
     * @expectedDeprecation Calling the "Symphony\Component\BrowserKit\Client::getRequest()" method before the "request()" one is deprecated since Symphony 4.1 and will throw an exception in 5.0.
     */
    ...
    public function testGetResponse()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\BrowserKit\Response', $client->getResponse(), '->getCrawler() returns the Response of the last request');
    }

    /**
     * @group legacy
     * @expectedDeprecation Calling the "Symphony\Component\BrowserKit\Client::getResponse()" method before the "request()" one is deprecated since Symphony 4.1 and will throw an exception in 5.0.
     */
    ...
    public function testGetInternalResponse()
    {
        ...
        $this->assertNotInstanceOf('Symphony\Component\BrowserKit\Tests\SpecialResponse', $client->getInternalResponse());
        $this->assertInstanceOf('Symphony\Component\BrowserKit\Tests\SpecialResponse', $client->getResponse());
    }

    /**
     * @group legacy
     * @expectedDeprecation Calling the "Symphony\Component\BrowserKit\Client::getInternalResponse()" method before the "request()" one is deprecated since Symphony 4.1 and will throw an exception in 5.0.
     */
    ...
    /**
     * @group legacy
     * @expectedDeprecation Calling the "Symphony\Component\BrowserKit\Client::getCrawler()" method before the "request()" one is deprecated since Symphony 4.1 and will throw an exception in 5.0.
     */
    ...
    public function testFollowRedirectWithHeaders()
    {
        $headers = array(
            ...
            'HTTP_USER_AGENT' => 'Symphony BrowserKit',
    ...
    public function testInsulatedRequests()
    {
        $client = new TestClient();
        $client->insulate();
        $client->setNextScript("new Symphony\Component\BrowserKit\Response('foobar')");
        $client->request('GET', 'http://www.example.com/foo/foobar');
    ...
    public function testGetServerParameter()
    {
        ...
        $this->assertEquals('Symphony BrowserKit', $client->getServerParameter('HTTP_USER_AGENT'));
    ...
    /**
     * @group legacy
     * @expectedDeprecation Calling the "Symphony\Component\BrowserKit\Client::getInternalRequest()" method before the "request()" one is deprecated since Symphony 4.1 and will throw an exception in 5.0.
     */
