                        ...
                        ->arrayNode('pgp_encrypter')
                            ...
                            ->children()
                                ...
                                ->floatNode('timeout')
                                    ...
                                    ->defaultValue(60)
                                ->end()
                                ->booleanNode('fail_on_missing_key')
                                    ->info('Whether to throw an exception when a recipient has no PGP public key. If false, the message will be sent unencrypted.')
                                    ->defaultTrue()
                                ->end()
                            ->end()
                        ->end()
