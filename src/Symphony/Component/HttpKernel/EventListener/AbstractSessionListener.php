...
{
    const NO_AUTO_CACHE_CONTROL_HEADER = 'Symphony-Session-NoAutoCacheControl';
    ...
    public function onKernelResponse(FilterResponseEvent $event)
    {
        ...
        if ($session->isStarted()) {
             ...
             * Symphonys session implementation starts the session on demand. So writing to it after
