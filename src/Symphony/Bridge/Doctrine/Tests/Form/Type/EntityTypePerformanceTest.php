...
{
    const ENTITY_CLASS = 'Symphony\Bridge\Doctrine\Tests\Fixtures\SingleIntIdEntity';
    ...
    public function testCollapsedEntityField()
    {
        ...
        for ($i = 0; $i < 40; ++$i) {
            $form = $this->factory->create('Symphony\Bridge\Doctrine\Form\Type\EntityType', null, array(
