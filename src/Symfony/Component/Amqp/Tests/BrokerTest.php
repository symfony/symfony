...
class BrokerTest extends TestCase
{
    ...
    {
        $broker = Broker::createWithDsn('amqp://foo:bar@rabbitmq-3.lxc:1234/symfony_amqp');
    ...
    public function testConfigure()
    {
        ...
        $this->assertSame($config, array_values($broker->getConfiguration()->getQueuesConfiguration()));
    ...
    public function testPublishWithCustomBinding()
    {
        ...
        $this->assertFalse($broker->hasQueue('test_broker.extra.queue'));
    ...
    public function testPublishWithCustomBindingInConfig()
    {
        ...
        // Ensure we don't create extra queue
        $this->assertFalse($broker->hasQueue('test_broker.extra2.queue'));
    ...
    {
        return Broker::createWithDsn(getenv('AMQP_DSN'), new Configuration($queuesConfiguration, $exchangesConfiguration));
    }
}
