...
use Symphony\Component\PropertyAccess\PropertyPathInterface;
...
class ViolationPath implements \IteratorAggregate, PropertyPathInterface
{
     ...
     *
     * @param string $violationPath The property path of a {@link \Symphony\Component\Validator\ConstraintViolation} object
     */
