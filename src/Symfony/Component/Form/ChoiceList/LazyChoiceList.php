    ...
    public function getChoices()
    {
        if ($this->loaded) {
            ...
            if ($this->loadedList !== $this->loader->loadChoiceList($this->value)) {
                @trigger_error(sprintf('Caching the choice list in %s is deprecated since Symfony 3.1 and will not happen in 4.0. Cache the list in the %s instead.', self::class, ChoiceLoaderInterface::class), E_USER_DEPRECATED);
            }
