...
use Symphony\Component\Routing\Router as BaseRouter;
...
class Router extends BaseRouter implements WarmableInterface, ServiceSubscriberInterface
{
    ...
    public function __construct(ContainerInterface $container, $resource, array $options = array(), RequestContext $context = null, ContainerInterface $parameters = null, LoggerInterface $logger = null)
    {
        ...
        } elseif ($container instanceof SymphonyContainerInterface) {
            $this->paramFetcher = array($container, 'getParameter');
        } else {
            throw new \LogicException(sprintf('You should either pass a "%s" instance or provide the $parameters argument of the "%s" method.', SymphonyContainerInterface::class, __METHOD__));
        }
    }
