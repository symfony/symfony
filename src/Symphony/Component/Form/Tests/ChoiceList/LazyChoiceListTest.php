...
namespace Symphony\Component\Form\Tests\ChoiceList;
...
class LazyChoiceListTest extends TestCase
{
    ...
    {
        $this->loadedList = $this->getMockBuilder('Symphony\Component\Form\ChoiceList\ChoiceListInterface')->getMock();
        $this->loader = $this->getMockBuilder('Symphony\Component\Form\ChoiceList\Loader\ChoiceLoaderInterface')->getMock();
        $this->value = function () {};
