 ...
 * Improved error-handling of `\Symphony\Component\HttpFoundation\Session\Storage\Handler\PdoSessionHandler`
 ...
 * [BC BREAK] Moved all session related classes and interfaces into own namespace, as
   `Symphony\Component\HttpFoundation\Session` and renamed classes accordingly.
   Session handlers are located in the subnamespace `Symphony\Component\HttpFoundation\Session\Handler`.
 * SessionHandlers must implement `\SessionHandlerInterface` or extend from the
   `Symphony\Component\HttpFoundation\Storage\Handler\NativeSessionHandler` base class.
 ...
 * Added `AutoExpireFlashBag` (default) to replicate Symphony 2.0.x auto expire
   behaviour of messages auto expiring after one page page load.  Messages must
   be retrieved by `get()` or `all()`.
 * Added `Symphony\Component\HttpFoundation\Attribute\AttributeBag` to replicate
   attributes storage behaviour from 2.0.x (default).
 * Added `Symphony\Component\HttpFoundation\Attribute\NamespacedAttributeBag` for
