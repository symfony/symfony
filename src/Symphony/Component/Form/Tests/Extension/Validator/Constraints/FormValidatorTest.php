...
use Symphony\Component\Form\Extension\Validator\Constraints\FormValidator;
...
class FormValidatorTest extends ConstraintValidatorTestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->serverParams = $this->getMockBuilder('Symphony\Component\Form\Extension\Validator\Util\ServerParams')->setMethods(array('getNormalizedIniPostMaxSize', 'getContentLength'))->getMock();
    ...
    {
        $object = $this->getMockBuilder('\stdClass')->getMock();
        $constraint1 = $this->getMockBuilder('Symphony\Component\Validator\Constraint')->getMock();
        $constraint2 = $this->getMockBuilder('Symphony\Component\Validator\Constraint')->getMock();
    ...
    public function testDontValidateIfNotSynchronized()
    {
        ...
        $form = $this->getBuilder('name', '\stdClass', array(
                ...
                // see https://github.com/symphony/symphony/issues/5144
    ...
    // https://github.com/symphony/symphony/issues/4359
    ...
    {
        $context = $this->getMockBuilder('Symphony\Component\Validator\Context\ExecutionContextInterface')->getMock();
        $validator = $this->getMockBuilder('Symphony\Component\Validator\Validator\ValidatorInterface')->getMock();
        $contextualValidator = $this->getMockBuilder('Symphony\Component\Validator\Validator\ContextualValidatorInterface')->getMock();
