...
class CacheTokenVerifierTest extends TestCase
{
    public function testVerifyCurrentToken()
    {
        ...
        $token = new PersistentToken('user', 'series1@special:chars=/', 'value', new \DateTime());
    ...
    {
        $verifier = new CacheTokenVerifier(new ArrayAdapter());
        $outdatedToken = new PersistentToken('user', 'series1@special:chars=/', 'value', new \DateTime());
        $newToken = new PersistentToken('user', 'series1@special:chars=/', 'newvalue', new \DateTime());
