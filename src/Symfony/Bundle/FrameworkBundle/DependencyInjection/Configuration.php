                ...
                ->arrayNode('templating')
                    ...
                    ->children()
                        ->arrayNode('assets_base_urls')
                            ...
                            ->prototype('scalar')
                                ->beforeNormalization()
                                    ->ifTrue(function($v) { return (array)$v === $v && isset($v['value']); })
                    ...
                    ->children()
                        ->arrayNode('engines')
                            ...
                            ->beforeNormalization()
                                ->ifTrue(function($v){ return (array)$v !== $v; })
                                ->then(function($v){ return (array)$v === $v; })
                                ->end()
                            ->prototype('scalar')
                                ->beforeNormalization()
        ...
        $rootNode
            ->children()
                ->arrayNode('validation')
                    ...
                    ->beforeNormalization()
                        ->ifTrue(function($v) { return (array)$v === $v && !empty($v['annotations']) && !empty($v['namespace']); })
                        ->then(function($v){
                        ...
                        ->arrayNode('annotations')
                            ...
                            ->children()
                                ->arrayNode('namespaces')
                                    ...
                                    ->prototype('scalar')
                                        ->beforeNormalization()
                                            ->ifTrue(function($v) { return (array)$v === $v && isset($v['namespace']); })
