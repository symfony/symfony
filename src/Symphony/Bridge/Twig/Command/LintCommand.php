...
namespace Symphony\Bridge\Twig\Command;
...
EOF
    ...
    private function display(InputInterface $input, OutputInterface $output, SymphonyStyle $io, $files)
    {
    ...
    private function displayTxt(OutputInterface $output, SymphonyStyle $io, $filesInfo)
    {
        $errors = 0;
