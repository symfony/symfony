...
namespace Symphony\Component\VarDumper\Dumper;

use Symphony\Component\VarDumper\Cloner\Data;
use Symphony\Component\VarDumper\Cloner\DumperInterface;
...
abstract class AbstractDumper implements DataDumperInterface, DumperInterface
{
    ...
    protected function utf8Encode($s)
    {
        ...
        if (!function_exists('iconv')) {
            throw new \RuntimeException('Unable to convert a non-UTF-8 string to UTF-8: required function iconv() does not exist. You should install ext-iconv or symphony/polyfill-iconv.');
        }
