...
class ContainerTest extends TestCase
{
    ...
    public function testCompile()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\DependencyInjection\ParameterBag\FrozenParameterBag', $sc->getParameterBag(), '->compile() changes the parameter bag to a FrozenParameterBag instance');
    ...
    public function testGet()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('Symphony\Component\DependencyInjection\Exception\ServiceNotFoundException', $e, '->get() throws a ServiceNotFoundException exception if the service is empty');
        }
    ...
    public function testGetThrowServiceNotFoundException()
    {
        ...
        try {
            $sc->get('foo1');
            $this->fail('->get() throws an Symphony\Component\DependencyInjection\Exception\ServiceNotFoundException if the key does not exist');
        } catch (\Exception $e) {
            $this->assertInstanceOf('Symphony\Component\DependencyInjection\Exception\ServiceNotFoundException', $e, '->get() throws an Symphony\Component\DependencyInjection\Exception\ServiceNotFoundException if the key does not exist');
            $this->assertEquals('You have requested a non-existent service "foo1". Did you mean this: "foo"?', $e->getMessage(), '->get() throws an Symphony\Component\DependencyInjection\Exception\ServiceNotFoundException with some advices');
        }
        ...
        try {
            ...
            $this->assertInstanceOf('Symphony\Component\DependencyInjection\Exception\ServiceNotFoundException', $e, '->get() throws an Symphony\Component\DependencyInjection\Exception\ServiceNotFoundException if the key does not exist');
            $this->assertEquals('You have requested a non-existent service "bag". Did you mean one of these: "bar", "baz"?', $e->getMessage(), '->get() throws an Symphony\Component\DependencyInjection\Exception\ServiceNotFoundException with some advices');
        }
    }
    ...
    public function testGetCircularReference()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('\Symphony\Component\DependencyInjection\Exception\ServiceCircularReferenceException', $e, '->get() throws a ServiceCircularReferenceException if it contains circular reference');
    ...
    {
        $class = new \ReflectionClass('Symphony\Component\DependencyInjection\Container');
