...
class UsernamePasswordJsonAuthenticationListenerTest extends TestCase
{
    ...
    public function testHandleSuccessIfRequestContentTypeIsJson()
    {
        ...
        $event = new RequestEvent(self::createMock(KernelInterface::class), $request, KernelInterface::MAIN_REQUEST);
    ...
    public function testHandleFailure()
    {
        ...
        ($this->listener)($event);
        self::assertSame(['error' => 'An authentication exception occurred.'], json_decode($event->getResponse()->getContent(), true));
    }
    ...
    public function testTranslatedHandleFailure()
    {
        ...
        ($this->listener)($event);
        self::assertSame(['error' => 'foo'], json_decode($event->getResponse()->getContent(), true));
    }
    ...
    public function testAttemptAuthenticationNoJson()
    {
        ...
        self::expectExceptionMessage('Invalid JSON');
        $this->createListener();
        $request = new Request();
    ...
    {
        self::expectException(BadRequestHttpException::class);
        self::expectExceptionMessage('The key "username" must be provided');
        $this->createListener();
    ...
    {
        self::expectException(BadRequestHttpException::class);
        self::expectExceptionMessage('The key "password" must be provided');
        $this->createListener();
    ...
    {
        self::expectException(BadRequestHttpException::class);
        self::expectExceptionMessage('The key "username" must be a string.');
        $this->createListener();
    ...
    {
        self::expectException(BadRequestHttpException::class);
        self::expectExceptionMessage('The key "password" must be a string.');
        $this->createListener();
    ...
    public function testAttemptAuthenticationUsernameTooLong()
    {
        ...
        ($this->listener)($event);
        self::assertSame('ko', $event->getResponse()->getContent());
    }
    ...
    public function testMigratesViaSessionStrategy()
    {
        ...
        $sessionStrategy = self::createMock(SessionAuthenticationStrategyInterface::class);
