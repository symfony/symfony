...
use Symphony\Component\HttpKernel\HttpCache\ResponseCacheStrategy;
...
class ResponseCacheStrategyTest extends TestCase
{
    ...
    {
        /* When "expiration wins over validation" (https://symphony.com/doc/current/http_cache/validation.html)
