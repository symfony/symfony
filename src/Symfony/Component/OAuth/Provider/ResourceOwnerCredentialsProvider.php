...
use Symfony\Component\OAuth\Token\ResourceOwnerCredentialsGrantToken;
...
final class ResourceOwnerCredentialsProvider extends GenericProvider
{
    ...
    public function fetchAuthorizationCode(array $options, array $headers = [], string $method = 'GET')
    {
        throw new \RuntimeException(\sprintf(
            'The %s does not support the authorization code authentication, please refer to https://tools.ietf.org/html/rfc6749#section-4.3.1',
            self::class
        ));
    }
