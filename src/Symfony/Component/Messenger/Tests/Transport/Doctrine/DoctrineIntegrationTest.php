...
class DoctrineIntegrationTest extends TestCase
{
    ...
    public function testItRetrieveTheFirstAvailableMessage()
    {
        ...
        $this->driverConnection->insert('messenger_messages', [
            ...
            'queue_name' => 'default',
            'created_at' => $this->connection->formatDateTime(new \DateTime('2019-03-15 12:00:00')),
            'available_at' => $this->connection->formatDateTime(new \DateTime('2019-03-15 12:00:00')),
            'delivered_at' => $this->connection->formatDateTime(new \DateTime()),
        ]);
        // one available later
        $this->driverConnection->insert('messenger_messages', [
            ...
            'queue_name' => 'default',
            'created_at' => $this->connection->formatDateTime(new \DateTime('2019-03-15 12:00:00')),
            'available_at' => $this->connection->formatDateTime(new \DateTime('2019-03-15 13:00:00')),
        ]);
        // one available
        $this->driverConnection->insert('messenger_messages', [
            ...
            'queue_name' => 'default',
            'created_at' => $this->connection->formatDateTime(new \DateTime('2019-03-15 12:00:00')),
            'available_at' => $this->connection->formatDateTime(new \DateTime('2019-03-15 12:30:00')),
        ]);
    ...
    public function testItCountMessages()
    {
        ...
        $this->driverConnection->insert('messenger_messages', [
            ...
            'queue_name' => 'default',
            'created_at' => $this->connection->formatDateTime(new \DateTime('2019-03-15 12:00:00')),
            'available_at' => $this->connection->formatDateTime((new \DateTime())->modify('+1 minute')),
        ]);
        // one available
        $this->driverConnection->insert('messenger_messages', [
            'body' => '{"message": "Hi available"}',
    ...
    public function testItRetrieveTheMessageThatIsOlderThanRedeliverTimeout()
    {
        ...
        $this->driverConnection->insert('messenger_messages', [
            ...
            'created_at' => $this->connection->formatDateTime(new \DateTime('2019-03-15 12:00:00')),
            'available_at' => $this->connection->formatDateTime(new \DateTime('2019-03-15 12:00:00')),
            'delivered_at' => $this->connection->formatDateTime($twoHoursAgo),
        ]);
        $this->driverConnection->insert('messenger_messages', [
            'body' => '{"message": "Hi available"}',
            'headers' => json_encode(['type' => DummyMessage::class]),
