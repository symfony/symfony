...
namespace Symphony\Component\Yaml\Tests\Command;

use PHPUnit\Framework\TestCase;
use Symphony\Component\Yaml\Command\LintCommand;
...
bar';
    ...
    {
        $yaml = <<<YAML
!php/const 'Symphony\Component\Yaml\Tests\Command\Foo::TEST': bar
YAML;
