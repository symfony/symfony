...
use Symphony\Component\HttpKernel\EventListener\FragmentListener;
...
class FragmentListenerTest extends TestCase
{
    ...
    /**
     * @expectedException \Symphony\Component\HttpKernel\Exception\AccessDeniedHttpException
     */
    ...
    {
        return new GetResponseEvent($this->getMockBuilder('Symphony\Component\HttpKernel\HttpKernelInterface')->getMock(), $request, $requestType);
    }
}
