...
abstract class AbstractBootstrap3LayoutTest extends AbstractLayoutTest
{
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\DateType');
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\TextType');
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\TextType', null, array(
            'label' => 'Custom label',
        ));
        $html = $this->renderLabel($form->createView(), null, array(
            'label_attr' => array(
...
'
    ...
    public function testOverrideWidgetBlock()
    {
        ...
        $form = $this->factory->createNamed('text_id', 'Symphony\Component\Form\Extension\Core\Type\TextType');
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\CheckboxType', true);
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\CheckboxType', false);
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\CheckboxType', false, array(
            'value' => 'foo&bar',
        ));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\ChoiceType', '&a', array(
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\ChoiceType', null, array(
            'choices' => array('a', 'b'),
            'multiple' => false,
            'expanded' => false,
            'attr' => array('size' => 2),
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\ChoiceType', array('&a'), array(
            'choices' => array('Choice&A' => '&a', 'Choice&B' => '&b'),
            'required' => true,
            'multiple' => true,
            'expanded' => false,
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\ChoiceType', true, array(
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\ChoiceType', array('&a', '&c'), array(
            'choices' => array('Choice&A' => '&a', 'Choice&B' => '&b', 'Choice&C' => '&c'),
            'multiple' => true,
            'expanded' => true,
            'required' => true,
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\CountryType', 'AT');
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\CountryType', 'AT', array(
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\DateTimeType', date('Y').'-02-03 04:05:06', array(
            'input' => 'string',
            'with_seconds' => false,
        ));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\DateTimeType', null, array(
            'input' => 'string',
...
'
    ...
    public function testDateTimeWithHourAndMinute()
    {
        ...
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\DateTimeType', $data, array(
            'input' => 'array',
            'required' => false,
        ));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\DateTimeType', '2011-02-03 04:05:06', array(
            'input' => 'string',
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\DateType', date('Y').'-02-03', array(
            'input' => 'string',
            'widget' => 'choice',
        ));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\DateType', null, array(
            'input' => 'string',
            'widget' => 'choice',
            'placeholder' => 'Change&Me',
            'required' => false,
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\DateType', '2011-02-03', array(
            'input' => 'string',
            'widget' => 'text',
        ));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\BirthdayType', '2000-02-03', array(
            'input' => 'string',
        ));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\BirthdayType', '1950-01-01', array(
            'input' => 'string',
            'placeholder' => '',
            'required' => false,
        ));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\EmailType', 'foo&bar');
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\EmailType', 'foo&bar', array(
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\HiddenType', 'foo&bar');
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\IntegerType', 123);
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\LanguageType', 'de');
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\LocaleType', 'de_AT');
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\MoneyType', 1234.56, array(
            'currency' => 'EUR',
        ));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\NumberType', 1234.56);
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\PasswordType', 'foo&bar');
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\PasswordType', null, array(
            'always_empty' => false,
        ));
        $form->submit('foo&bar');
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\PasswordType', 'foo&bar', array(
            'attr' => array('maxlength' => 123),
        ));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\PercentType', 0.1);
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\RadioType', true);
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\RadioType', false);
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\RadioType', false, array(
            'value' => 'foo&bar',
        ));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\RangeType', 42, array('attr' => array('min' => 5)));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\RangeType', 42, array('attr' => array('min' => 5, 'max' => 57)));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\TextareaType', 'foo&bar', array(
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\TextType', 'foo&bar');
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\TextType', 'foo&bar', array(
            'attr' => array('maxlength' => 123),
        ));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\SearchType', 'foo&bar');
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\TimeType', '04:05:06', array(
            'input' => 'string',
            'with_seconds' => false,
        ));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\TimeType', null, array(
            'input' => 'string',
            'placeholder' => 'Change&Me',
            'required' => false,
        ));
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\TimezoneType', 'Europe/Vienna');
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\TimezoneType', null, array(
...
'
    ...
    public function testUrl()
    {
        ...
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\UrlType', $url);
...
'
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\ButtonType');
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\ButtonType', null, array(
            'translation_domain' => false,
        ));
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\SubmitType');
    ...
    {
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\ResetType');
    ...
    {
        $form = $this->factory->createNamed('text', 'Symphony\Component\Form\Extension\Core\Type\TextType', 'value', array(
            'required' => true,
            'disabled' => true,
    ...
    {
        $form = $this->factory->createNamed('button', 'Symphony\Component\Form\Extension\Core\Type\ButtonType', null, array(
            'disabled' => true,
    ...
    {
        $tel = '0102030405';
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\TelType', $tel);
...
'
    ...
    {
        $color = '#0000ff';
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\ColorType', $color);
