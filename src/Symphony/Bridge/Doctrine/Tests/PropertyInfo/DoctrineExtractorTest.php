...
namespace Symphony\Bridge\Doctrine\Tests\PropertyInfo;

use Doctrine\DBAL\Types\Type as DBALType;
use Doctrine\ORM\EntityManager;
use Doctrine\ORM\Tools\Setup;
use PHPUnit\Framework\TestCase;
use Symphony\Bridge\Doctrine\PropertyInfo\DoctrineExtractor;
...
class DoctrineExtractorTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        if (!DBALType::hasType('foo')) {
            DBALType::addType('foo', 'Symphony\Bridge\Doctrine\Tests\PropertyInfo\Fixtures\DoctrineFooType');
    ...
    public function testGetProperties()
    {
        $this->assertEquals(
            ...
            $this->extractor->getProperties('Symphony\Bridge\Doctrine\Tests\PropertyInfo\Fixtures\DoctrineDummy')
        );
    }
    ...
    public function testGetPropertiesWithEmbedded()
    {
        ...
        $this->assertEquals(
            ...
            $this->extractor->getProperties('Symphony\Bridge\Doctrine\Tests\PropertyInfo\Fixtures\DoctrineWithEmbedded')
        );
    }
    ...
    {
        $this->assertEquals($type, $this->extractor->getTypes('Symphony\Bridge\Doctrine\Tests\PropertyInfo\Fixtures\DoctrineDummy', $property, array()));
    }
    ...
    public function testExtractWithEmbedded()
    {
        ...
        $expectedTypes = array(new Type(
            ...
            false,
            'Symphony\Bridge\Doctrine\Tests\PropertyInfo\Fixtures\DoctrineEmbeddable'
        ));

        $actualTypes = $this->extractor->getTypes(
            'Symphony\Bridge\Doctrine\Tests\PropertyInfo\Fixtures\DoctrineWithEmbedded',
            'embedded',
            array()
        );
    ...
    public function typesProvider()
    {
        return array(
            ...
            array('foo', array(new Type(Type::BUILTIN_TYPE_OBJECT, true, 'Symphony\Bridge\Doctrine\Tests\PropertyInfo\Fixtures\DoctrineRelation'))),
            array('bar', array(new Type(
                ...
                new Type(Type::BUILTIN_TYPE_OBJECT, false, 'Symphony\Bridge\Doctrine\Tests\PropertyInfo\Fixtures\DoctrineRelation')
            ))),
