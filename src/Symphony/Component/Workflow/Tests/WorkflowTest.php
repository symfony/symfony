...
class WorkflowTest extends TestCase
{
     ...
     * @expectedExceptionMessage The value returned by the MarkingStore is not an instance of "Symphony\Component\Workflow\Marking" for workflow "unnamed".
     */
    ...
    /**
     * @expectedException \Symphony\Component\Workflow\Exception\UndefinedTransitionException
...
class EventDispatcherMock implements \Symphony\Component\EventDispatcher\EventDispatcherInterface
{
    public $dispatchedEvents = array();

    public function dispatch($eventName, \Symphony\Component\EventDispatcher\Event $event = null)
    {
    ...
    public function addSubscriber(\Symphony\Component\EventDispatcher\EventSubscriberInterface $subscriber)
    {
    }
    ...
    public function removeSubscriber(\Symphony\Component\EventDispatcher\EventSubscriberInterface $subscriber)
    {
    }
