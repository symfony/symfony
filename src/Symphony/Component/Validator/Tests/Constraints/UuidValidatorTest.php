...
use Symphony\Component\Validator\Constraints\Uuid;
use Symphony\Component\Validator\Constraints\UuidValidator;
...
class UuidValidatorTest extends ConstraintValidatorTestCase
{
    ...
    {
        $constraint = $this->getMockForAbstractClass('Symphony\\Component\\Validator\\Constraint');
