...
class KernelTest extends TestCase
{
    ...
    public function testConstructor()
    {
        ...
        self::assertEquals($env, $kernel->getEnvironment());
        self::assertEquals($debug, $kernel->isDebug());
        self::assertFalse($kernel->isBooted());
        self::assertLessThanOrEqual(microtime(true), $kernel->getStartTime());
    }

    public function testEmptyEnv()
    {
        self::expectException(\InvalidArgumentException::class);
        self::expectExceptionMessage(sprintf('Invalid environment provided to "%s": the environment cannot be empty.', KernelForTest::class));
    ...
    public function testClone()
    {
        ...
        self::assertEquals($env, $clone->getEnvironment());
        self::assertEquals($debug, $clone->isDebug());
        self::assertFalse($clone->isBooted());
        self::assertLessThanOrEqual(microtime(true), $clone->getStartTime());
    }

    public function testClassNameValidityGetter()
    {
        self::expectException(\InvalidArgumentException::class);
        self::expectExceptionMessage('The environment "test.env" contains invalid characters, it can only contain characters allowed in PHP class names.');
    ...
    public function testInitializeContainerClearsOldContainers()
    {
        ...
        self::assertTrue(unlink(__DIR__.'/Fixtures/var/cache/custom/Symfony_Component_HttpKernel_Tests_CustomProjectDirKernelCustomDebugContainer.php.meta'));
        self::assertFileExists($containerDir);
        self::assertFileDoesNotExist($containerDir.'.legacy');

        $kernel = new CustomProjectDirKernel(function ($container) { $container->register('foo', 'stdClass')->setPublic(true); });
        $kernel->boot();

        self::assertFileExists($containerDir);
        self::assertFileExists($containerDir.'.legacy');

        self::assertFileDoesNotExist($legacyContainerDir);
        self::assertFileDoesNotExist($legacyContainerDir.'.legacy');
    }
    ...
    {
        $bundle = self::createMock(Bundle::class);
        $bundle->expects(self::exactly(2))
            ->method('setContainer')
            ->withConsecutive(
                [self::isInstanceOf(ContainerInterface::class)],
                [null]
            );
    ...
    public function testHandleCallsHandleOnHttpKernel()
    {
        ...
        $httpKernelMock = self::getMockBuilder(HttpKernel::class)
...
EOF
    ...
    public function testSerialize()
    {
        ...
        self::assertEquals($expected, serialize($kernel));
    }
    ...
    public function testLocateResourceReturnsTheFirstThatMatches()
    {
        ...
        self::assertEquals(__DIR__.'/Fixtures/Bundle1Bundle/foo.txt', $kernel->locateResource('@Bundle1Bundle/foo.txt'));
    }
    ...
    public function testLocateResourceOnDirectories()
    {
        ...
        self::assertEquals(__DIR__.'/Fixtures/Bundle1Bundle/Resources/', $kernel->locateResource('@Bundle1Bundle/Resources/'));
        self::assertEquals(__DIR__.'/Fixtures/Bundle1Bundle/Resources', $kernel->locateResource('@Bundle1Bundle/Resources'));
    }
    ...
    public function testInitializeBundleThrowsExceptionWhenRegisteringTwoBundlesWithTheSameName()
    {
        ...
        self::expectExceptionMessage('Trying to register two bundles with the same name "DuplicateName"');
    ...
    public function testTerminateDelegatesTerminationOnlyForTerminableInterface()
    {
        ...
        self::assertFalse($httpKernel->terminateCalled, 'terminate() is never called if the kernel class does not implement TerminableInterface');
    ...
    public function testKernelWithoutBundles()
    {
        ...
        self::assertTrue($kernel->getContainer()->getParameter('test_executed'));
    }
    ...
    public function testProjectDirExtension()
    {
        ...
        self::assertSame(__DIR__.'/Fixtures', $kernel->getProjectDir());
        self::assertSame(__DIR__.\DIRECTORY_SEPARATOR.'Fixtures', $kernel->getContainer()->getParameter('kernel.project_dir'));
    }
    ...
    public function testKernelReset()
    {
        ...
        self::assertInstanceOf($containerClass, $kernel->getContainer());
        self::assertFileExists($containerFile);
        unlink(__DIR__.'/Fixtures/var/cache/custom/Symfony_Component_HttpKernel_Tests_CustomProjectDirKernelCustomDebugContainer.php.meta');

        $kernel = new CustomProjectDirKernel(function ($container) { $container->register('foo', 'stdClass')->setPublic(true); });
        $kernel->boot();

        self::assertNotInstanceOf($containerClass, $kernel->getContainer());
        self::assertFileExists($containerFile);
        self::assertFileExists(\dirname($containerFile).'.legacy');
    }
    ...
    public function testKernelExtension()
    {
        ...
        self::assertTrue($kernel->getContainer()->getParameter('test.extension-registered'));
    }
    ...
    public function testKernelPass()
    {
        ...
        self::assertTrue($kernel->getContainer()->getParameter('test.processed'));
    }
    ...
    public function testWarmup()
    {
        ...
        self::assertTrue($kernel->warmedUp);
    }

    public function testServicesResetter()
    {
        $httpKernelMock = self::getMockBuilder(HttpKernelInterface::class)
            ->disableOriginalConstructor()
            ->getMock();
        $httpKernelMock
            ->expects(self::exactly(2))
        ...
        self::assertEquals(0, ResettableService::$counter);
        self::assertFalse($kernel->getContainer()->initialized('services_resetter'));

        $kernel->handle($request);

        self::assertEquals(1, ResettableService::$counter);
    }
    ...
    public function testKernelStartTimeIsResetWhileBootingAlreadyBootedKernel()
    {
        ...
        self::assertGreaterThan($preReBoot, $kernel->getStartTime());
    }
    ...
    public function testAnonymousKernelGeneratesValidContainerClass()
    {
        ...
        self::assertMatchesRegularExpression('/^[a-zA-Z_\x80-\xff][a-zA-Z0-9_\x80-\xff]*TestDebugContainer$/', $kernel->getContainerClass());
    }
    ...
    protected function getKernel(array $methods = [], array $bundles = [], bool $debug = false): Kernel
    {
        ...
        $kernel = self::getMockBuilder(KernelForTest::class)
            ->setMethods($methods)
