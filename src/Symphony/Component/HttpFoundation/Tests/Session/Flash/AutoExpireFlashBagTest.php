...
namespace Symphony\Component\HttpFoundation\Tests\Session\Flash;

use PHPUnit\Framework\TestCase;
use Symphony\Component\HttpFoundation\Session\Flash\AutoExpireFlashBag as FlashBag;
...
{
    /**
     * @var \Symphony\Component\HttpFoundation\Session\Flash\AutoExpireFlashBag
     */
    private $bag;
    ...
    {
        $this->assertEquals('_symphony_flashes', $this->bag->getStorageKey());
