...
namespace Symfony\Component\Kernel\Tests\Bundle;

use PHPUnit\Framework\TestCase;
use Symfony\Component\Kernel\Bundle\Bundle;
use Symfony\Component\Kernel\Tests\Fixtures\ExtensionNotValidBundle\ExtensionNotValidBundle;
use Symfony\Component\Kernel\Tests\Fixtures\ExtensionPresentBundle\ExtensionPresentBundle;
...
class BundleTest extends TestCase
{
    public function testGetContainerExtension()
    {
        ...
        $this->assertInstanceOf(
            'Symfony\Component\Kernel\Tests\Fixtures\ExtensionPresentBundle\DependencyInjection\ExtensionPresentExtension',
    ...
    public function testBundleNameIsGuessedFromClass()
    {
        ...
        $this->assertSame('Symfony\Component\Kernel\Tests\Bundle', $bundle->getNamespace());
