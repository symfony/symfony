...
namespace Symphony\Component\Security\Guard\Tests\Provider;
...
use Symphony\Component\Security\Guard\Provider\GuardAuthenticationProvider;
...
class GuardAuthenticationProviderTest extends TestCase
{
    ...
    public function testCheckCredentialsReturningNonTrueFailsAuthentication()
    {
        ...
        $mockedUser = $this->getMockBuilder('Symphony\Component\Security\Core\User\UserInterface')->getMock();
    ...
    /**
     * @expectedException \Symphony\Component\Security\Core\Exception\AuthenticationExpiredException
     */
    ...
    protected function setUp()
    {
        ...
        $this->preAuthenticationToken = $this->getMockBuilder('Symphony\Component\Security\Guard\Token\PreAuthenticationGuardToken')
