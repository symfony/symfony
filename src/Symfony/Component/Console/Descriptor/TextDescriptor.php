...
class TextDescriptor extends Descriptor
{
    ...
    {
        if (null !== $argument->getDefault() && (!is_array($argument->getDefault()) || $argument->getDefault())) {
    ...
    {
        if ($option->acceptValue() && null !== $option->getDefault() && (!is_array($option->getDefault()) || $option->getDefault())) {
