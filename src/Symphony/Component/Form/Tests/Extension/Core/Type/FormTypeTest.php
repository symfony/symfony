...
{
    const TESTED_TYPE = 'Symphony\Component\Form\Extension\Core\Type\FormType';

    public function testCreateFormInstances()
    {
        $this->assertInstanceOf('Symphony\Component\Form\Form', $this->factory->create(static::TESTED_TYPE));
    }
    ...
    {
        $this->assertInstanceOf('Symphony\Component\Form\FormBuilderInterface', $this->factory->createBuilder(static::TESTED_TYPE, null, array(
            'data_class' => null,
        )));
    }
    ...
    {
        $this->assertInstanceOf('Symphony\Component\Form\FormBuilderInterface', $this->factory->createBuilder(static::TESTED_TYPE, null, array(
            'data_class' => 'Symphony\Component\Form\Tests\Fixtures\AbstractAuthor',
        )));
    }
    ...
    {
        $this->assertInstanceOf('Symphony\Component\Form\FormBuilderInterface', $this->factory->createBuilder(static::TESTED_TYPE, null, array(
            'data_class' => 'Symphony\Component\Form\Tests\Fixtures\AuthorInterface',
        )));
    }
    ...
    // https://github.com/symphony/symphony/issues/6862
