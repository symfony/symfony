...
namespace Symphony\Bridge\Doctrine;
...
abstract class ManagerRegistry extends AbstractManagerRegistry
{
    ...
    protected function resetService($name)
    {
        ...
        if (!$manager instanceof LazyLoadingInterface) {
            throw new \LogicException(sprintf('Resetting a non-lazy manager service is not supported. Set the "%s" service as lazy and require "symphony/proxy-manager-bridge" in your composer.json file instead.', $name));
        }
