...
use Symphony\Component\Security\Http\Firewall\ContextListener;
...
class ContextListenerTest extends TestCase
{
    ...
    /**
     * @expectedException \InvalidArgumentException
     * @expectedExceptionMessage User provider "stdClass" must implement "Symphony\Component\Security\Core\User\UserProviderInterface
     */
    ...
    public function testOnKernelResponseWillAddSession()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\Security\Core\Authentication\Token\UsernamePasswordToken', $token);
    ...
    public function testHandleAddsKernelResponseListener()
    {
        ...
        $event->expects($this->any())
            ->method('getRequest')
            ->will($this->returnValue($this->getMockBuilder('Symphony\Component\HttpFoundation\Request')->getMock()));
    ...
    private function handleEventWithPreviousSession(TokenStorageInterface $tokenStorage, $userProviders, UserInterface $user = null)
    {
        ...
        $listener->handle(new GetResponseEvent($this->getMockBuilder('Symphony\Component\HttpKernel\HttpKernelInterface')->getMock(), $request, HttpKernelInterface::MASTER_REQUEST));
    }
}
...
class SupportingUserProvider implements UserProviderInterface
{
    ...
    public function supportsClass($class)
    {
        return 'Symphony\Component\Security\Core\User\User' === $class;
    }
}
