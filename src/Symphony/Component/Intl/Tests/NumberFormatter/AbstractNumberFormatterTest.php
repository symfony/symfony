...
abstract class AbstractNumberFormatterTest extends TestCase
{
    ...
    public function testGetSymbol()
    {
        ...
        $r = new \ReflectionProperty('Symphony\Component\Intl\NumberFormatter\NumberFormatter', 'enSymbols');
        $r->setAccessible(true);
        $expected = $r->getValue('Symphony\Component\Intl\NumberFormatter\NumberFormatter');
    ...
    public function testGetTextAttribute()
    {
        ...
        $r = new \ReflectionProperty('Symphony\Component\Intl\NumberFormatter\NumberFormatter', 'enTextAttributes');
        $r->setAccessible(true);
        $expected = $r->getValue('Symphony\Component\Intl\NumberFormatter\NumberFormatter');
