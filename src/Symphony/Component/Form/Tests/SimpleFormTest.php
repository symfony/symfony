...
use Symphony\Component\Form\Tests\Fixtures\FixedFilterListener;
...
class SimpleFormTest extends AbstractFormTest
{
    ...
    // https://github.com/symphony/symphony/commit/d4f4038f6daf7cf88ca7c7ab089473cce5ebf7d8#commitcomment-1632879
    ...
    // https://github.com/symphony/symphony/pull/7789
    ...
    public function testEmptyDataFromClosure()
    {
        $form = $this->getBuilder()
            ->setEmptyData(function ($form) {
                ...
                $this->assertInstanceOf('Symphony\Component\Form\FormInterface', $form);
    ...
    public function testCreateView()
    {
        ...
        $view = $this->getMockBuilder('Symphony\Component\Form\FormView')->getMock();
    ...
    public function testCreateViewWithParent()
    {
        $type = $this->getMockBuilder('Symphony\Component\Form\ResolvedFormTypeInterface')->getMock();
        $view = $this->getMockBuilder('Symphony\Component\Form\FormView')->getMock();
        $parentForm = $this->getMockBuilder('Symphony\Component\Form\Test\FormInterface')->getMock();
        $parentView = $this->getMockBuilder('Symphony\Component\Form\FormView')->getMock();
        $form = $this->getBuilder()->setType($type)->getForm();
    ...
    // see https://github.com/symphony/symphony/issues/3903
    ...
    {
        $handler = $this->getMockBuilder('Symphony\Component\Form\RequestHandlerInterface')->getMock();
    ...
    public function testInitializeSetsDefaultData()
    {
        ...
        $form = $this->getMockBuilder('Symphony\Component\Form\Form')->setMethods(array('setData'))->setConstructorArgs(array($config))->getMock();
