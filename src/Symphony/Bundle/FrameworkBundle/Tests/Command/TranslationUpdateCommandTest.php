...
use Symphony\Bundle\FrameworkBundle\Command\TranslationUpdateCommand;
use Symphony\Component\Filesystem\Filesystem;
use Symphony\Component\HttpKernel;
...
class TranslationUpdateCommandTest extends TestCase
{
    ...
    {
        $translator = $this->getMockBuilder('Symphony\Component\Translation\Translator')
        ...
        $extractor = $this->getMockBuilder('Symphony\Component\Translation\Extractor\ExtractorInterface')->getMock();
        $extractor
            ->expects($this->any())
            ->method('extract')
            ->will(
        ...
        $loader = $this->getMockBuilder('Symphony\Component\Translation\Reader\TranslationReader')->getMock();
        $loader
            ->expects($this->any())
            ->method('read')
            ->will(
        ...
        $writer = $this->getMockBuilder('Symphony\Component\Translation\Writer\TranslationWriter')->getMock();
        $writer
            ->expects($this->any())
            ->method('getFormats')
            ->will(
        ...
        $kernel
            ->expects($this->any())
            ->method('getContainer')
            ->will($this->returnValue($this->getMockBuilder('Symphony\Component\DependencyInjection\ContainerInterface')->getMock()));
    ...
    {
        $bundle = $this->getMockBuilder('Symphony\Component\HttpKernel\Bundle\BundleInterface')->getMock();
        $bundle
            ->expects($this->any())
            ->method('getPath')
