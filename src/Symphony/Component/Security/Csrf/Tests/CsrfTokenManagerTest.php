...
namespace Symphony\Component\Security\Csrf\Tests;
...
class CsrfTokenManagerTest extends TestCase
{
    ...
    public function testGetNonExistingToken($namespace, $manager, $storage, $generator)
    {
        ...
        $this->assertInstanceOf('Symphony\Component\Security\Csrf\CsrfToken', $token);
    ...
    {
        $generator = $this->getMockBuilder('Symphony\Component\Security\Csrf\TokenGenerator\TokenGeneratorInterface')->getMock();
        $storage = $this->getMockBuilder('Symphony\Component\Security\Csrf\TokenStorage\TokenStorageInterface')->getMock();
    ...
    {
        return array(
            $this->getMockBuilder('Symphony\Component\Security\Csrf\TokenGenerator\TokenGeneratorInterface')->getMock(),
            $this->getMockBuilder('Symphony\Component\Security\Csrf\TokenStorage\TokenStorageInterface')->getMock(),
        );
    }
