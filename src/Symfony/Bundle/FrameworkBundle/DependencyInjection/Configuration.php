        ...
        $rootNode
            ->children()
                ->arrayNode('csrf_protection')
                    ...
                    ->addDefaultsIfNotSet()
                    ->children()
                        // defaults to framework.session.enabled && interface_exists(CsrfTokenManagerInterface::class)
        ...
        $rootNode
            ->children()
                ->arrayNode('form')
                    ...
                    ->{class_exists(Form::class) ? 'canBeDisabled' : 'canBeEnabled'}()
                    ->children()
                        ->arrayNode('csrf_protection')
                            ->treatFalseLike(['enabled' => false])
                            ->treatTrueLike(['enabled' => true])
        ...
        $rootNode
            ->children()
                ->arrayNode('assets')
                    ...
                    ->{class_exists(Package::class) ? 'canBeDisabled' : 'canBeEnabled'}()
        ...
        $rootNode
            ->children()
                ->arrayNode('translator')
                    ...
                    ->{class_exists(Translator::class) ? 'canBeDisabled' : 'canBeEnabled'}()
        ...
        $rootNode
            ->children()
                ->arrayNode('validation')
                    ...
                    ->{class_exists(Validation::class) ? 'canBeDisabled' : 'canBeEnabled'}()
                    ->children()
        ...
        $rootNode
            ->children()
                ->arrayNode('serializer')
                    ...
                    ->{class_exists(Serializer::class) ? 'canBeDisabled' : 'canBeEnabled'}()
                    ->children()
                        ->booleanNode('enable_annotations')->{class_exists(Annotation::class) ? 'defaultTrue' : 'defaultFalse'}()->end()
        ...
        $rootNode
            ->children()
                ->arrayNode('property_info')
                    ...
                    ->{interface_exists(PropertyInfoExtractorInterface::class) ? 'canBeDisabled' : 'canBeEnabled'}()
                ->end()
            ->end()
        ;
    }
        ...
        $rootNode
            ->children()
                ->arrayNode('lock')
                    ...
                    ->{class_exists(Lock::class) ? 'canBeDisabled' : 'canBeEnabled'}()
                    ->beforeNormalization()
        ...
        $rootNode
            ->children()
                ->arrayNode('web_link')
                    ...
                    ->{class_exists(HttpHeaderSerializer::class) ? 'canBeDisabled' : 'canBeEnabled'}()
                ->end()
            ->end()
        ;
    }
