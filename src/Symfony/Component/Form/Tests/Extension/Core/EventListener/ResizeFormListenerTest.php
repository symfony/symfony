...
class ResizeFormListenerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testPreSetDataResizesForm()
    {
        ...
        $this->factory->expects($this->at(0))
            ->method('createNamed')
            ->with(1, 'text', null, array('map_to' => '[1]', 'attr' => array('maxlength' => 10), 'auto_initialize' => false))
            ->will($this->returnValue($this->getForm('1')));
        $this->factory->expects($this->at(1))
            ->method('createNamed')
            ->with(2, 'text', null, array('map_to' => '[2]', 'attr' => array('maxlength' => 10), 'auto_initialize' => false))
