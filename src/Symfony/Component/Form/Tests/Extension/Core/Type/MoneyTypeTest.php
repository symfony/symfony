...
class MoneyTypeTest extends TestCase
{
    ...
    public function testMoneyPatternWorksForYen()
    {
        ...
        $form = $this->factory->create(MoneyType::class, null, array('currency' => 'JPY'));
        $view = $form->createView();
    ...
    public function testPassDifferentPatternsForDifferentCurrencies()
    {
        ...
        $form1 = $this->factory->create(MoneyType::class, null, array('currency' => 'GBP'));
        $form2 = $this->factory->create(MoneyType::class, null, array('currency' => 'EUR'));
