...
namespace Symphony\Component\Debug\Tests\Exception;

use PHPUnit\Framework\TestCase;
use Symphony\Component\Debug\Exception\FatalThrowableError;
use Symphony\Component\Debug\Exception\FlattenException;
use Symphony\Component\HttpFoundation\Exception\SuspiciousOperationException;
...
use Symphony\Component\HttpKernel\Exception\UnauthorizedHttpException;
...
use Symphony\Component\HttpKernel\Exception\ServiceUnavailableHttpException;
use Symphony\Component\HttpKernel\Exception\TooManyRequestsHttpException;
use Symphony\Component\HttpKernel\Exception\UnsupportedMediaTypeHttpException;
...
class FlattenExceptionTest extends TestCase
{
    ...
    public function testArguments()
    {
        ...
        $this->assertSame(array('object', 'Symphony\Component\HttpKernel\Exception\NotFoundHttpException'), $array[$i++]);
