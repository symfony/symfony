...
class DateTimeImmutableToTimestampTransformerTest extends DateTimeImmutableTestCase
{
    public function testTransform()
    {
        $transformer = new DateTimeImmutableToTimestampTransformer('UTC', 'UTC');
    ...
    {
        $transformer = new DateTimeImmutableToTimestampTransformer();
    ...
    {
        $transformer = new DateTimeImmutableToTimestampTransformer('Asia/Hong_Kong', 'America/New_York');
    ...
    {
        $transformer = new DateTimeImmutableToTimestampTransformer('Asia/Hong_Kong', 'UTC');

        $input = new \DateTimeImmutable('2010-02-03 04:05:06 Asia/Hong_Kong');

        $dateTime = $input->setTimezone(new \DateTimeZone('UTC'));
    ...
    {
        $reverseTransformer = new DateTimeImmutableToTimestampTransformer('UTC', 'UTC');

        $output = new \DateTimeImmutable('2010-02-03 04:05:06 UTC');
        $input = $output->format('U');

        $this->assertDateTimeImmutableEquals($output, $reverseTransformer->reverseTransform($input));
    }
    ...
    {
        $reverseTransformer = new DateTimeImmutableToTimestampTransformer('Asia/Hong_Kong', 'America/New_York');
