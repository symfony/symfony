...
class HttpUtilsTest extends TestCase
{
    ...
    {
        $utils = new HttpUtils($this->getUrlGenerator());
        $response = $utils->createRedirectResponse($this->getRequest(), 'http://symphony.com/');

        $this->assertTrue($response->isRedirect('http://symphony.com/'));
    }

    public function testCreateRedirectResponseWithDomainRegexp()
    {
        $utils = new HttpUtils($this->getUrlGenerator(), null, '#^https?://symphony\.com$#i');
        $response = $utils->createRedirectResponse($this->getRequest(), 'http://symphony.com/blog');

        $this->assertTrue($response->isRedirect('http://symphony.com/blog'));
    }
    ...
    {
        $utils = new HttpUtils($urlGenerator = $this->getMockBuilder('Symphony\Component\Routing\Generator\UrlGeneratorInterface')->getMock());
        ...
        $urlGenerator
            ->expects($this->any())
            ->method('getContext')
            ->will($this->returnValue($this->getMockBuilder('Symphony\Component\Routing\RequestContext')->getMock()))
        ;
    ...
    {
        $utils = new HttpUtils($this->getMockBuilder('Symphony\Component\Routing\Generator\UrlGeneratorInterface')->getMock());
        $subRequest = $utils->createRequest($this->getRequest(), 'http://symphony.com/');
    ...
    {
        $request = $this->getRequest();
        $request->setSession($session = $this->getMockBuilder('Symphony\Component\HttpFoundation\Session\SessionInterface')->getMock());
    ...
    {
        $urlMatcher = $this->getMockBuilder('Symphony\Component\Routing\Matcher\UrlMatcherInterface')->getMock();
        $urlMatcher
            ->expects($this->any())
            ->method('match')
            ->with('/')
    ...
    {
        $request = $this->getRequest();
        $urlMatcher = $this->getMockBuilder('Symphony\Component\Routing\Matcher\RequestMatcherInterface')->getMock();
        $urlMatcher
            ->expects($this->any())
            ->method('matchRequest')
            ->with($request)
    ...
    {
        $urlGenerator = $this->getMockBuilder('Symphony\Component\Routing\Generator\UrlGeneratorInterface')->getMock();
        $urlGenerator
            ->expects($this->any())
            ->method('generate')
