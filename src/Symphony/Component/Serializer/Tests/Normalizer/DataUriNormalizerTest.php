...
class DataUriNormalizerTest extends TestCase
{
    ...
    public function testSupportsDenormalization()
    {
        ...
        $this->assertTrue($this->normalizer->supportsDenormalization(self::TEST_TXT_DATA, 'Symphony\Component\HttpFoundation\File\File'));
    }
    ...
    {
        $file = $this->normalizer->denormalize(self::TEST_GIF_DATA, 'Symphony\Component\HttpFoundation\File\File');

        $this->assertInstanceOf('Symphony\Component\HttpFoundation\File\File', $file);
    ...
    public function validUriProvider()
    {
        return array(
            ...
            array('data:text/plain;charset=utf-8;base64,SGVsbG8gV29ybGQh'),
        );
    }
