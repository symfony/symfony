...
class Regex extends Constraint
{
     ...
     * @param                                 $htmlPattern The pattern to use in the HTML5 pattern attribute
     * @param                                 $match       Whether to validate the value matches the configured pattern or not (defaults to false)
