...
class Symfony_Component_Serializer_Tests_Fixtures_CustomNormalizer_FullTypeHints_ComplexTypesSetter implements NormalizerInterface, DenormalizerInterface, NormalizerAwareInterface, DenormalizerAwareInterface
{
    ...
    */
    ...
    {
        return ['simple' => $this->normalizeChild($object->getSimple(), $format, $context, false), 'array' => $this->normalizeChild($object->getArray(), $format, $context, true), 'union' => $this->normalizeChild($object->getUnion(), $format, $context, false), 'nested' => $this->normalizeChild($object->getNested(), $format, $context, false), 'unionArray' => $this->normalizeChild($object->getUnionArray(), $format, $context, true)];
    }
