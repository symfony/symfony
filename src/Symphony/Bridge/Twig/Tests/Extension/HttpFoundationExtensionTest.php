...
use Symphony\Bridge\Twig\Extension\HttpFoundationExtension;
...
class HttpFoundationExtensionTest extends TestCase
{
    ...
    {
        if (!class_exists('Symphony\Component\Routing\RequestContext')) {
    ...
    {
        if (!method_exists('Symphony\Component\HttpFoundation\Request', 'getRelativeUriForPath')) {
            $this->markTestSkipped('Your version of Symphony HttpFoundation is too old.');
        }
