...
use Symphony\Bridge\Doctrine\ContainerAwareEventManager;
...
use Symphony\Component\Cache\Adapter\RedisAdapter;
...
use Symphony\Component\Serializer\Normalizer\DataUriNormalizer;
...
abstract class FrameworkExtensionTest extends TestCase
{
    ...
    public function testSession()
    {
        ...
        $this->assertEquals('_SYMPHONY', $options['name']);
    ...
    public function testTranslator()
    {
        ...
        $ref = new \ReflectionClass('Symphony\Component\Validator\Validation');
        $this->assertContains(
            strtr(dirname($ref->getFileName()).'/Resources/translations/validators.en.xlf', '/', DIRECTORY_SEPARATOR),
            $files,
            '->registerTranslatorConfiguration() finds Validator translation resources'
        );
        $ref = new \ReflectionClass('Symphony\Component\Form\Form');
        $this->assertContains(
            strtr(dirname($ref->getFileName()).'/Resources/translations/validators.en.xlf', '/', DIRECTORY_SEPARATOR),
            $files,
            '->registerTranslatorConfiguration() finds Form translation resources'
        );
        $ref = new \ReflectionClass('Symphony\Component\Security\Core\Security');
        $this->assertContains(
    ...
    public function testValidation()
    {
        ...
        $this->assertEquals(array(new Reference('validator.mapping.cache.symphony')), $calls[$i][1]);
    }
    ...
    public function testValidationService()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\Validator\Validator\ValidatorInterface', $container->get('validator'));
    }
    ...
    public function testValidationAnnotations()
    {
        ...
        $this->assertEquals(array(new Reference('validator.mapping.cache.symphony')), $calls[6][1]);
        // no cache this time
    }
    ...
    public function testValidationPaths()
    {
        ...
        $container = $this->createContainerFromFile('validation_annotations', array(
            'kernel.bundles' => array('TestBundle' => 'Symphony\\Bundle\\FrameworkBundle\\Tests\\TestBundle'),
            'kernel.bundles_metadata' => array('TestBundle' => array('namespace' => 'Symphony\\Bundle\\FrameworkBundle\\Tests', 'path' => __DIR__.'/Fixtures/TestBundle')),
        ));
        ...
        $this->assertEquals(array(new Reference('validator.mapping.cache.symphony')), $calls[7][1]);

        $xmlMappings = $calls[3][1][0];
        $this->assertCount(3, $xmlMappings);
        try {
            // Testing symphony/symphony
            $this->assertStringEndsWith('Component'.DIRECTORY_SEPARATOR.'Form/Resources/config/validation.xml', $xmlMappings[0]);
        } catch (\Exception $e) {
            // Testing symphony/framework-bundle with deps=high
            $this->assertStringEndsWith('symphony'.DIRECTORY_SEPARATOR.'form/Resources/config/validation.xml', $xmlMappings[0]);
        }
    ...
    public function testValidationPathsUsingCustomBundlePath()
    {
        ...
        $container = $this->createContainerFromFile('validation_annotations', array(
            'kernel.bundles' => array('CustomPathBundle' => 'Symphony\\Bundle\\FrameworkBundle\\Tests\\CustomPathBundle'),
            'kernel.bundles_metadata' => array('TestBundle' => array('namespace' => 'Symphony\\Bundle\\FrameworkBundle\\Tests', 'path' => __DIR__.'/Fixtures/CustomPathBundle')),
        ));
    ...
    /**
     * @group legacy
     * @expectedDeprecation The "framework.validation.strict_email" configuration key has been deprecated in Symphony 4.1. Use the "framework.validation.email_validation_mode" configuration key instead.
     * @expectedException \Symphony\Component\Config\Definition\Exception\InvalidConfigurationException
    ...
    public function testSerializerEnabled()
    {
        ...
        $this->assertEquals('Symphony\Component\Serializer\Mapping\Loader\AnnotationLoader', $argument[0]->getClass());
    ...
    public function testObjectNormalizerRegistered()
    {
        ...
        $this->assertEquals('Symphony\Component\Serializer\Normalizer\ObjectNormalizer', $definition->getClass());
    ...
    public function testSerializerCacheActivated()
    {
        ...
        $this->assertEquals(new Reference('serializer.mapping.cache.symphony'), $cache);
    }
    ...
    {
        $container = $this->createContainerFromFile('serializer_mapping', array('kernel.bundles_metadata' => array('TestBundle' => array('namespace' => 'Symphony\\Bundle\\FrameworkBundle\\Tests', 'path' => __DIR__.'/Fixtures/TestBundle'))));
        $projectDir = $container->getParameter('kernel.project_dir');
    ...
    protected function createContainer(array $data = array())
    {
        return new ContainerBuilder(new ParameterBag(array_merge(array(
            ...
            'kernel.bundles_metadata' => array('FrameworkBundle' => array('namespace' => 'Symphony\\Bundle\\FrameworkBundle', 'path' => __DIR__.'/../..')),
