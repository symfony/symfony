 ...
 * @internal
 */
final class TraceableNormalizer implements NormalizerInterface, DenormalizerInterface, SerializerAwareInterface, NormalizerAwareInterface, DenormalizerAwareInterface, CacheableSupportsMethodInterface
{
    ...
    public function normalize(mixed $object, string $format = null, array $context = [])
    {
        if (!$this->normalizer instanceof NormalizerInterface) {
            throw new BadMethodCallException(sprintf('%s() cannot be called as nested normalizer doesn\'t implements "%s"', __METHOD__, NormalizerInterface::class));
        }
    ...
    public function denormalize(mixed $data, string $type, string $format = null, array $context = [])
    {
        if (!$this->normalizer instanceof DenormalizerInterface) {
            throw new BadMethodCallException(sprintf('%s() cannot be called as nested normalizer doesn\'t implements "%s"', __METHOD__, DenormalizerInterface::class));
        }
