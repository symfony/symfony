...
use Symphony\Component\Form\Test\FormIntegrationTestCase;
...
abstract class AbstractLayoutTest extends FormIntegrationTestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->csrfTokenManager = $this->getMockBuilder('Symphony\Component\Security\Csrf\CsrfTokenManagerInterface')->getMock();
...
'
    ...
    public function testLabelFormatName()
    {
        $form = $this->factory->createNamedBuilder('myform')
            ->add('myfield', 'Symphony\Component\Form\Extension\Core\Type\TextType')
            ->getForm();
...
'
    ...
    public function testLabelFormatAsFormOption()
    {
        ...
        $form = $this->factory->createNamedBuilder('myform', 'Symphony\Component\Form\Extension\Core\Type\FormType', null, $options)
            ->add('myfield', 'Symphony\Component\Form\Extension\Core\Type\TextType')
            ->getForm();
        $view = $form->get('myfield')->createView();
        $html = $this->renderLabel($view);
...
'
    ...
    public function testLabelFormatOverriddenOption()
    {
        ...
        $form = $this->factory->createNamedBuilder('myform', 'Symphony\Component\Form\Extension\Core\Type\FormType', null, $options)
            ->add('myfield', 'Symphony\Component\Form\Extension\Core\Type\TextType', array('label_format' => 'field.%name%'))
            ->getForm();
        $view = $form->get('myfield')->createView();
        $html = $this->renderLabel($view);
...
'
    ...
    {
        $form = $this->factory->createNamedBuilder('myform', 'Symphony\Component\Form\Extension\Core\Type\FormType', null, array(
                'translation_domain' => false,
            ))
            ->add('mybutton', 'Symphony\Component\Form\Extension\Core\Type\ButtonType')
            ->getForm();
...
'
    ...
    public function testSingleChoice()
    {
        ...
        // https://github.com/symphony/symphony/issues/8942
...
'
    ...
    public function testSingleChoiceRequiredWithPlaceholder()
    {
        ...
        // See https://github.com/symphony/symphony/pull/7678
        $this->assertWidgetMatchesXpath($form->createView(), array(),
'/select
    [@name="name"]
    [@required="required"]
...
'
    ...
    public function testDateErrorBubbling()
    {
        $form = $this->factory->createNamedBuilder('form', 'Symphony\Component\Form\Extension\Core\Type\FormType')
            ->add('date', 'Symphony\Component\Form\Extension\Core\Type\DateType')
            ->getForm();
...
'
    ...
    {
        $form = $this->factory->createNamedBuilder('form', 'Symphony\Component\Form\Extension\Core\Type\FormType')
            ->add('time', 'Symphony\Component\Form\Extension\Core\Type\TimeType')
            ->getForm();
...
'
    ...
    {
        $form = $this->factory->createNamedBuilder('name', 'Symphony\Component\Form\Extension\Core\Type\FormType', array('items' => array('one', 'two', 'three')))
            ->add('items', 'Symphony\Component\Form\Extension\Core\Type\CollectionType', array('allow_add' => true))
            ->getForm()
            ->createView();
    ...
    {
        $form = $this->factory->createNamedBuilder('', 'Symphony\Component\Form\Extension\Core\Type\FormType')
...
'/form
    ...
    {
        $form = $this->factory->createBuilder('Symphony\Component\Form\Extension\Core\Type\FormType', null, array(
                'method' => 'get',
                'action' => 'http://example.com/directory',
            ))
            ->add('file', 'Symphony\Component\Form\Extension\Core\Type\FileType')
            ->getForm();
    ...
    {
        $form = $this->factory->createNamed('textarea', 'Symphony\Component\Form\Extension\Core\Type\TextareaType', '  ');
    ...
    {
        $form = $this->factory->createBuilder('Symphony\Component\Form\Extension\Core\Type\FormType', array('textarea' => '  '))
            ->add('textarea', 'Symphony\Component\Form\Extension\Core\Type\TextareaType')
            ->getForm();
    ...
    public function testTranslatedAttributes()
    {
        $view = $this->factory->createNamedBuilder('name', 'Symphony\Component\Form\Extension\Core\Type\FormType')
            ->add('firstName', 'Symphony\Component\Form\Extension\Core\Type\TextType', array('attr' => array('title' => 'Foo')))
            ->add('lastName', 'Symphony\Component\Form\Extension\Core\Type\TextType', array('attr' => array('placeholder' => 'Bar')))
            ->getForm()
            ->createView();
    ...
    {
        $view = $this->factory->createNamedBuilder('name', 'Symphony\Component\Form\Extension\Core\Type\FormType', null, array(
                'translation_domain' => false,
            ))
            ->add('firstName', 'Symphony\Component\Form\Extension\Core\Type\TextType', array('attr' => array('title' => 'Foo')))
            ->add('lastName', 'Symphony\Component\Form\Extension\Core\Type\TextType', array('attr' => array('placeholder' => 'Bar')))
