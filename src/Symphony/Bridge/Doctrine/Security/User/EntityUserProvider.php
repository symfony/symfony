...
namespace Symphony\Bridge\Doctrine\Security\User;
    ...
    public function loadUserByUsername($username)
    {
        ...
        if (null !== $this->property) {
            ...
            if (!$repository instanceof UserLoaderInterface) {
                throw new \InvalidArgumentException(sprintf('You must either make the "%s" entity Doctrine Repository ("%s") implement "Symphony\Bridge\Doctrine\Security\User\UserLoaderInterface" or set the "property" option in the corresponding entity provider configuration.', $this->classOrAlias, get_class($repository)));
            }
