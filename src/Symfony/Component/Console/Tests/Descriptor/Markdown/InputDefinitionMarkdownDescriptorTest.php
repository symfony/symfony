...
use Symfony\Component\Console\Descriptor\Markdown\InputDefinitionMarkdownDescriptor;
...
class InputDefinitionMarkdownDescriptorTest extends AbstractDescriptorTest
{
    protected function getDescriptor()
    {
        return new InputDefinitionMarkdownDescriptor();
    }
