...
namespace Symphony\Component\Routing\Tests\Generator;

use PHPUnit\Framework\TestCase;
use Symphony\Component\Routing\RouteCollection;
use Symphony\Component\Routing\Route;
use Symphony\Component\Routing\Generator\UrlGenerator;
...
class UrlGeneratorTest extends TestCase
{
    ...
    /**
     * @expectedException \Symphony\Component\Routing\Exception\InvalidParameterException
     */
    ...
    /**
     * @expectedException \Symphony\Component\Routing\Exception\MissingMandatoryParametersException
     */
    ...
    public function testAdjacentVariables()
    {
        ...
        $this->{method_exists($this, $_ = 'expectException') ? $_ : 'setExpectedException'}('Symphony\Component\Routing\Exception\InvalidParameterException');
    ...
    public function testGenerateRelativePath()
    {
        ...
        $generator = $this->getGenerator($routes, array('host' => 'example.com', 'pathInfo' => '/fabien/symphony-is-great/'));

        $this->assertSame('comments', $generator->generate('comments',
            array('author' => 'fabien', 'article' => 'symphony-is-great'), UrlGeneratorInterface::RELATIVE_PATH)
        );
        $this->assertSame('comments?page=2', $generator->generate('comments',
            array('author' => 'fabien', 'article' => 'symphony-is-great', 'page' => 2), UrlGeneratorInterface::RELATIVE_PATH)
        );
