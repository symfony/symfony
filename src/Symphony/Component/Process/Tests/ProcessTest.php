...
use Symphony\Component\Process\Exception\LogicException;
use Symphony\Component\Process\Exception\ProcessTimedOutException;
use Symphony\Component\Process\Exception\RuntimeException;
use Symphony\Component\Process\InputStream;
use Symphony\Component\Process\PhpExecutableFinder;
use Symphony\Component\Process\Pipes\PipesInterface;
...
class ProcessTest extends TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$phpBin = getenv('SYMPHONY_PROCESS_PHP_TEST_BINARY') ?: ('phpdbg' === PHP_SAPI ? 'php' : $phpBin->find());
    ...
    /**
     * @expectedException \Symphony\Component\Process\Exception\RuntimeException
    ...
    /**
     * @expectedException \Symphony\Component\Process\Exception\InvalidArgumentException
     */
    ...
    /**
     * @expectedException \Symphony\Component\Process\Exception\LogicException
     ...
     * @expectedException \Symphony\Component\Process\Exception\InvalidArgumentException
     * @expectedExceptionMessage Symphony\Component\Process\Process::setInput only accepts strings, Traversable objects or stream resources.
     */
    ...
    /**
     * @expectedException \Symphony\Component\Process\Exception\ProcessFailedException
     */
    ...
    /**
     * @expectedException \Symphony\Component\Process\Exception\ProcessSignaledException
    ...
    /**
     * @expectedException \Symphony\Component\Process\Exception\ProcessTimedOutException
    ...
    public function testMethodsThatNeedARunningProcess($method)
    {
        ...
        if (method_exists($this, 'expectException')) {
            $this->expectException('Symphony\Component\Process\Exception\LogicException');
            $this->expectExceptionMessage(sprintf('Process must be started before calling %s.', $method));
        } else {
            $this->setExpectedException('Symphony\Component\Process\Exception\LogicException', sprintf('Process must be started before calling %s.', $method));
        }
