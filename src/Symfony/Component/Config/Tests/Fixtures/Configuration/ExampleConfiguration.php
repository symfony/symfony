    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ...
            ->children()
                ...
                ->datetimeNode('datetime')->end()
                ->datetimeNode('datetime_with_timezone')->timezone('Japan')->end()
                ->datetimeNode('datetime_with_format_and_timezone')->format('d/m/Y')->timezone('Japan')->end()
                ->arrayNode('array')
                    ->info('some info')
                    ->canBeUnset()
                    ->children()
