...
class TestServiceContainerRefPassesTest extends TestCase
{
    public function testProcess()
    {
        ...
        $container->register('Test\public_service')
            ->setPublic(true)
            ->addArgument(new Reference('Test\private_used_service'));

        $container->register('Test\private_used_service');
        $container->register('Test\private_unused_service');

        $container->compile();

        $expected = array(
            'Test\private_used_service' => new ServiceClosureArgument(new Reference('Test\private_used_service')),
