...
use Symphony\Component\Form\Tests\Fixtures\FixedDataTransformer;
...
class CompoundFormTest extends AbstractFormTest
{
    ...
    public function testSubmitDoesNotAddExtraFieldForNullValues()
    {
        ...
        $child = $factory->createNamed('file', 'Symphony\Component\Form\Extension\Core\Type\FileType', null, array('auto_initialize' => false));
    ...
    public function testAddUsingNameAndType()
    {
        ...
        $this->form->add('foo', 'Symphony\Component\Form\Extension\Core\Type\TextType', array('bar' => 'baz'));
    ...
    public function testAddUsingIntegerNameAndType()
    {
        ...
        $this->factory->expects($this->once())
            ->method('createNamed')
            ->with('0', 'Symphony\Component\Form\Extension\Core\Type\TextType', null, array(
                'bar' => 'baz',
                'auto_initialize' => false,
            ))
            ->will($this->returnValue($child));
        ...
        $this->form->add(0, 'Symphony\Component\Form\Extension\Core\Type\TextType', array('bar' => 'baz'));
    ...
    public function testAddMapsViewDataToFormIfInitialized()
    {
        ...
        $mapper->expects($this->once())
            ...
            ->will($this->returnCallback(function ($data, \RecursiveIteratorIterator $iterator) use ($child) {
                $this->assertInstanceOf('Symphony\Component\Form\Util\InheritDataAwareIterator', $iterator->getInnerIterator());
    ...
    /*
     * https://github.com/symphony/symphony/issues/4480
     */
    ...
    public function testGetErrorsDeepRecursive()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\Form\FormErrorIterator', $errorsAsArray[2]);
    ...
    {
        $type = $this->getMockBuilder('Symphony\Component\Form\ResolvedFormTypeInterface')->getMock();
    ...
    {
        $button = $this->getMockBuilder('Symphony\Component\Form\SubmitButton')
    ...
    public function testClickedButtonFromNestedForm()
    {
        ...
        $nestedForm = $this->getMockBuilder('Symphony\Component\Form\Form')
    ...
    public function testClickedButtonFromParentForm()
    {
        ...
        $parentForm = $this->getMockBuilder('Symphony\Component\Form\Form')
