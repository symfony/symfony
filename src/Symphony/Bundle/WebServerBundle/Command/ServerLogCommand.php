...
class ServerLogCommand extends Command
{
    ...
    public function isEnabled()
    {
        ...
        // based on a symphony/symphony package, it crashes due a missing FormatterInterface from monolog/monolog
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if ($filter) {
            if (!class_exists(ExpressionLanguage::class)) {
                throw new \LogicException('Package "symphony/expression-language" is required to use the "filter" option.');
            }
