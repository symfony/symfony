...
{
    const TESTED_TYPE = 'Symphony\Component\Form\Extension\Core\Type\TimeType';
    ...
    /**
     * @expectedException \Symphony\Component\Form\Exception\InvalidConfigurationException
     */
