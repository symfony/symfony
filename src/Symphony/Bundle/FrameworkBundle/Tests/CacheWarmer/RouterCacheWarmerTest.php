...
use Symphony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer;
...
class RouterCacheWarmerTest extends TestCase
{
    ...
    /**
     * @expectedDeprecation Passing a Symphony\Component\Routing\RouterInterface without implementing Symphony\Component\HttpKernel\CacheWarmer\WarmableInterface is deprecated since Symphony 4.1.
     * @group legacy
     */
