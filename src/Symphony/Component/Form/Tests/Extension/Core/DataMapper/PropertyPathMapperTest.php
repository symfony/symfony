...
namespace Symphony\Component\Form\Tests\Extension\Core\DataMapper;

use PHPUnit\Framework\TestCase;
use Symphony\Component\Form\FormConfigBuilder;
use Symphony\Component\Form\FormConfigInterface;
use Symphony\Component\Form\Extension\Core\DataMapper\PropertyPathMapper;
...
class PropertyPathMapperTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->propertyAccessor = $this->getMockBuilder('Symphony\Component\PropertyAccess\PropertyAccessorInterface')->getMock();
    ...
    {
        return $this->getMockBuilder('Symphony\Component\PropertyAccess\PropertyPath')
    ...
    {
        $form = $this->getMockBuilder('Symphony\Component\Form\Form')
