...
- Keep the PR's metadata true: push to the PR's real head (the fork's repository name can differ from the upstream name; query it), update base, milestone, title and body together, and describe post-review changes in the body.
