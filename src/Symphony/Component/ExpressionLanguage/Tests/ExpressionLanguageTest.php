...
use Symphony\Component\ExpressionLanguage\Tests\Fixtures\TestProvider;
...
class ExpressionLanguageTest extends TestCase
{
    ...
    public function testProviders()
    {
        ...
        $this->assertEquals('\Symphony\Component\ExpressionLanguage\Tests\Fixtures\fn_namespaced()', $expressionLanguage->compile('fn_namespaced()'));
    }
    ...
    /**
     * @expectedException \Symphony\Component\ExpressionLanguage\SyntaxError
