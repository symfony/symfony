            ...
            ->children()
                ->arrayNode('cache')
                    ...
                    ->children()
                        ...
                        ->scalarNode('default_mongodb_provider')
                            ->info('DSN of the MongoDB collection to use when a cache pool does not define its own "provider"; it has no default value.')
                            ->example('mongodb://localhost:27017/db_name?collection_name=cache')
                        ->end()
