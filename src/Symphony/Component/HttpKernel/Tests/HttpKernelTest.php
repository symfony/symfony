...
class HttpKernelTest extends TestCase
{
    ...
    {
        $dispatcher = new EventDispatcher();
        $kernel = $this->getHttpKernel($dispatcher, 'Symphony\Component\HttpKernel\Tests\controller_func');
    ...
    {
        $dispatcher = new EventDispatcher();
        $kernel = $this->getHttpKernel($dispatcher, array('Symphony\Component\HttpKernel\Tests\Controller', 'staticcontroller'));
    ...
    public function testVerifyRequestStackPushPopDuringHandle()
    {
        ...
        $stack = $this->getMockBuilder('Symphony\Component\HttpFoundation\RequestStack')->setMethods(array('push', 'pop'))->getMock();
