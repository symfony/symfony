...
namespace Symphony\Bridge\Doctrine\Tests\Validator\Constraints;
...
use Symphony\Bridge\Doctrine\Test\DoctrineTestHelper;
use Symphony\Bridge\Doctrine\Test\TestRepositoryFactory;
use Symphony\Bridge\Doctrine\Tests\Fixtures\Employee;
use Symphony\Bridge\Doctrine\Tests\Fixtures\Person;
use Symphony\Bridge\Doctrine\Tests\Fixtures\CompositeObjectNoToStringIdEntity;
use Symphony\Bridge\Doctrine\Tests\Fixtures\SingleIntIdEntity;
use Symphony\Bridge\Doctrine\Tests\Fixtures\DoubleNameEntity;
use Symphony\Bridge\Doctrine\Tests\Fixtures\DoubleNullableNameEntity;
use Symphony\Bridge\Doctrine\Tests\Fixtures\AssociationEntity;
use Symphony\Bridge\Doctrine\Tests\Fixtures\AssociationEntity2;
use Symphony\Bridge\Doctrine\Tests\Fixtures\SingleIntIdNoToStringEntity;
use Symphony\Bridge\Doctrine\Tests\Fixtures\SingleIntIdStringWrapperNameEntity;
use Symphony\Bridge\Doctrine\Tests\Fixtures\Type\StringWrapper;
use Symphony\Bridge\Doctrine\Validator\Constraints\UniqueEntity;
use Symphony\Bridge\Doctrine\Validator\Constraints\UniqueEntityValidator;
...
class UniqueEntityValidatorTest extends ConstraintValidatorTestCase
{
    ...
    protected function setUp()
    {
        ...
        if (!Type::hasType('string_wrapper')) {
            Type::addType('string_wrapper', 'Symphony\Bridge\Doctrine\Tests\Fixtures\Type\StringWrapperType');
        }
    ...
    private function createSchema(ObjectManager $em)
    {
        ...
        $schemaTool->createSchema(array(
            $em->getClassMetadata('Symphony\Bridge\Doctrine\Tests\Fixtures\SingleIntIdEntity'),
            $em->getClassMetadata('Symphony\Bridge\Doctrine\Tests\Fixtures\SingleIntIdNoToStringEntity'),
            $em->getClassMetadata('Symphony\Bridge\Doctrine\Tests\Fixtures\DoubleNameEntity'),
            $em->getClassMetadata('Symphony\Bridge\Doctrine\Tests\Fixtures\DoubleNullableNameEntity'),
            $em->getClassMetadata('Symphony\Bridge\Doctrine\Tests\Fixtures\CompositeIntIdEntity'),
            $em->getClassMetadata('Symphony\Bridge\Doctrine\Tests\Fixtures\AssociationEntity'),
            $em->getClassMetadata('Symphony\Bridge\Doctrine\Tests\Fixtures\AssociationEntity2'),
            $em->getClassMetadata('Symphony\Bridge\Doctrine\Tests\Fixtures\Person'),
            $em->getClassMetadata('Symphony\Bridge\Doctrine\Tests\Fixtures\Employee'),
            $em->getClassMetadata('Symphony\Bridge\Doctrine\Tests\Fixtures\CompositeObjectNoToStringIdEntity'),
            $em->getClassMetadata('Symphony\Bridge\Doctrine\Tests\Fixtures\SingleIntIdStringWrapperNameEntity'),
        ));
    }
    ...
    public function testAssociatedEntity()
    {
        ...
        $this->buildViolation('myMessage')
            ...
            ->setParameter('{{ value }}', 'object("Symphony\Bridge\Doctrine\Tests\Fixtures\SingleIntIdEntity") identified by (id => 1)')
    ...
    public function testValidateUniquenessNotToStringEntityWithAssociatedEntity()
    {
        ...
        $expectedValue = 'object("Symphony\Bridge\Doctrine\Tests\Fixtures\SingleIntIdNoToStringEntity") identified by (id => 1)';
    ...
    {
        $repository = $this->createRepositoryMock();
        $this->repositoryFactory->setRepository($this->em, 'Symphony\Bridge\Doctrine\Tests\Fixtures\SingleIntIdEntity', $repository);
    ...
    /**
     * @expectedException \Symphony\Component\Validator\Exception\ConstraintDefinitionException
     * @expectedExceptionMessage Unable to find the object manager associated with an entity of class "Symphony\Bridge\Doctrine\Tests\Fixtures\SingleIntIdEntity"
     */
    ...
    public function testValidateInheritanceUniqueness()
    {
        $constraint = new UniqueEntity(array(
            ...
            'fields' => array('name'),
            'em' => self::EM_NAME,
            'entityClass' => 'Symphony\Bridge\Doctrine\Tests\Fixtures\Person',
        ));
    ...
    /**
     * @expectedException \Symphony\Component\Validator\Exception\ConstraintDefinitionException
     * @expectedExceptionMessage The "Symphony\Bridge\Doctrine\Tests\Fixtures\SingleStringIdEntity" entity repository does not support the "Symphony\Bridge\Doctrine\Tests\Fixtures\Person" entity. The entity should be an instance of or extend "Symphony\Bridge\Doctrine\Tests\Fixtures\SingleStringIdEntity".
     */
    public function testInvalidateRepositoryForInheritance()
    {
        $constraint = new UniqueEntity(array(
            ...
            'fields' => array('name'),
            'em' => self::EM_NAME,
            'entityClass' => 'Symphony\Bridge\Doctrine\Tests\Fixtures\SingleStringIdEntity',
        ));
    ...
    public function testValidateUniquenessWithCustomDoctrineTypeValue()
    {
        ...
        $expectedValue = 'object("Symphony\Bridge\Doctrine\Tests\Fixtures\Type\StringWrapper")';
