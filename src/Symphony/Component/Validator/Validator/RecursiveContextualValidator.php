...
use Symphony\Component\Validator\ConstraintValidatorFactoryInterface;
...
use Symphony\Component\Validator\Exception\UnsupportedMetadataException;
use Symphony\Component\Validator\Exception\ValidatorException;
use Symphony\Component\Validator\Mapping\CascadingStrategy;
use Symphony\Component\Validator\Mapping\ClassMetadataInterface;
use Symphony\Component\Validator\Mapping\GenericMetadata;
...
use Symphony\Component\Validator\Mapping\TraversalStrategy;
    ...
    public function validateProperty($object, $propertyName, $groups = null)
    {
        ...
        if (!$classMetadata instanceof ClassMetadataInterface) {
            throw new ValidatorException(sprintf(
                ...
                '"\Symphony\Component\Validator\Mapping\ClassMetadataInterface", '.
                'got: "%s".',
        ...
        foreach ($groups as $key => $group) {
            ...
            if (Constraint::DEFAULT_GROUP === $group) {
                if ($metadata->hasGroupSequence()) {
                    ...
                    // object
                    /* @var \Symphony\Component\Validator\GroupSequenceProviderInterface $object */
            ...
            foreach ($metadata->getPropertyMetadata($propertyName) as $propertyMetadata) {
                if (!$propertyMetadata instanceof PropertyMetadataInterface) {
                    throw new UnsupportedMetadataException(sprintf(
                        ...
                        '"Symphony\Component\Validator\Mapping\PropertyMetadataInterface", '.
                        'got: "%s".',
