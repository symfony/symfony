...
use Symphony\Component\Security\Http\RememberMe\PersistentTokenBasedRememberMeServices;
...
class PersistentTokenBasedRememberMeServicesTest extends TestCase
{
    ...
    public function testAutoLoginThrowsExceptionOnNonExistentToken()
    {
        ...
        $tokenProvider = $this->getMockBuilder('Symphony\Component\Security\Core\Authentication\RememberMe\TokenProviderInterface')->getMock();
        $tokenProvider
            ->expects($this->once())
