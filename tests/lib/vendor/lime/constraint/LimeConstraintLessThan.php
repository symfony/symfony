...
/**
 * Tests that a value is less than another.
 *
 * @package    Lime
 * @author     Bernhard Schussek <bernhard.schussek@symfony-project.com>
 * @version    SVN: $Id: LimeConstraintLessThan.php 23701 2009-11-08 21:23:40Z bschussek $
 */
class LimeConstraintLessThan extends LimeConstraint
{
  /**
   * (non-PHPdoc)
