...
namespace Symphony\Component\Form\Tests\Extension\Validator\EventListener;
...
class ValidationListenerTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->validator = $this->getMockBuilder('Symphony\Component\Validator\Validator\ValidatorInterface')->getMock();
        $this->violationMapper = $this->getMockBuilder('Symphony\Component\Form\Extension\Validator\ViolationMapper\ViolationMapperInterface')->getMock();
