...
use Symphony\Component\Workflow\Exception\InvalidTokenConfigurationException;
...
class GuardListener
{
    ...
    // code should be sync with Symphony\Component\Security\Core\Authorization\Voter\ExpressionVoter
