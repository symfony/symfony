...
interface ExecutionContextInterface
{
     ...
     * @api
     */
    function addViolation($message, array $params = array(), $invalidValue = null, $pluralization = null, $code = null);
     ...
     * @api
     */
    function addViolationAt($subPath, $message, array $params = array(), $invalidValue = null, $pluralization = null, $code = null);
     ...
     */
    function validate($value, $subPath = '', $groups = null, $traverse = false, $deep = false);
     ...
     *                                             will be used.
     */
    function validateValue($value, $constraints, $subPath = '', $groups = null);
     ...
     */
    function getPropertyPath($subPath = '');
}
