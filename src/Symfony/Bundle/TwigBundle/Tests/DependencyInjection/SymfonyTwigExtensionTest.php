...
use Symfony\Bundle\TwigBundle\DependencyInjection\SymfonyTwigExtension;
...
class SymfonyTwigExtensionTest extends TestCase
{
    /**
    ...
    public function testLoadEmptyConfiguration($format)
    {
        ...
        $container->registerExtension(new SymfonyTwigExtension());
    ...
    public function testGlobalsWithDifferentTypesAndValues()
    {
        ...
        $container = $this->createContainer();
        $container->registerExtension(new SymfonyTwigExtension());
        $container->loadFromExtension('symfony_twig', array('globals' => $globals));
        $this->compileContainer($container);
