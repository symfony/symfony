...
To prepare, you need to install the development dependencies of the component.
    ...
    $ cd /path/to/Symphony/Component/Intl
    $ composer install
...
* If you updated the Icu component, you need to push that change and create a
  pull request in the `symphony/Icu` repository. Make sure to submit the pull
...
* If you updated the stub files of the Intl component, you need to push that
  change and create a pull request in the `symphony/symphony` repository. The
...
3. You can now move region.dat to replace the version bundled with Symphony.
