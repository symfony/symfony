...
use Symphony\Component\CssSelector\CssSelectorConverter;
...
class Crawler implements \Countable, \IteratorAggregate
{
     ...
     *                        http://symphony.com/blog/security-release-symphony-2-0-17-released
     */
     ...
     *
     * This method only works if you have installed the CssSelector Symphony Component.
     *
    ...
    public function filter($selector)
    {
        if (!class_exists(CssSelectorConverter::class)) {
            throw new \RuntimeException('To filter with a CSS selector, install the CssSelector component ("composer require symphony/css-selector"). Or use filterXpath instead.');
        }
