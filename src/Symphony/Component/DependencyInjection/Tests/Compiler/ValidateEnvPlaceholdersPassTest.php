...
use Symphony\Component\DependencyInjection\Compiler\ValidateEnvPlaceholdersPass;
...
class ValidateEnvPlaceholdersPassTest extends TestCase
{
     ...
     * @expectedExceptionMessage A dynamic value is not compatible with a "Symphony\Component\Config\Definition\EnumNode" node type at path "env_extension.enum_node".
     */
    ...
    /**
     * @expectedException \Symphony\Component\Config\Definition\Exception\InvalidConfigurationException
     * @expectedExceptionMessage A dynamic value is not compatible with a "Symphony\Component\Config\Definition\ArrayNode" node type at path "env_extension.simple_array_node".
     */
