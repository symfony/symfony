...
use Symphony\Component\Form\ChoiceList\View\ChoiceListView;
...
use Symphony\Component\Form\Extension\Core\DataMapper\RadioListMapper;
use Symphony\Component\Form\Extension\Core\DataMapper\CheckboxListMapper;
...
use Symphony\Component\Form\Extension\Core\EventListener\MergeCollectionListener;
use Symphony\Component\Form\Extension\Core\DataTransformer\ChoiceToValueTransformer;
use Symphony\Component\Form\Extension\Core\DataTransformer\ChoicesToValuesTransformer;
...
class ChoiceType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        ...
        $resolver->setDefaults(array(
            ...
            // See https://github.com/symphony/symphony/pull/5582
            'data_class' => null,
        ...
        $resolver->setAllowedTypes('choice_loader', array('null', 'Symphony\Component\Form\ChoiceList\Loader\ChoiceLoaderInterface'));
        $resolver->setAllowedTypes('choice_label', array('null', 'bool', 'callable', 'string', 'Symphony\Component\PropertyAccess\PropertyPath'));
        $resolver->setAllowedTypes('choice_name', array('null', 'callable', 'string', 'Symphony\Component\PropertyAccess\PropertyPath'));
        $resolver->setAllowedTypes('choice_value', array('null', 'callable', 'string', 'Symphony\Component\PropertyAccess\PropertyPath'));
        $resolver->setAllowedTypes('choice_attr', array('null', 'array', 'callable', 'string', 'Symphony\Component\PropertyAccess\PropertyPath'));
        $resolver->setAllowedTypes('preferred_choices', array('array', '\Traversable', 'callable', 'string', 'Symphony\Component\PropertyAccess\PropertyPath'));
        $resolver->setAllowedTypes('group_by', array('null', 'callable', 'string', 'Symphony\Component\PropertyAccess\PropertyPath'));
    }
