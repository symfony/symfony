 ...
 * @experimental in 5.2
 */
class SodiumEncryption implements SymmetricEncryptionInterface
{
    /**
    ...
    public function decrypt(string $message): string
    {
        ...
        try {
            ...
            throw new EncryptionException(sprintf('Failed to decrypt key with algorithm "%s".', $algorithm), 0, $exception);
        }
    }
