...
class RequestDataCollectorTest extends TestCase
{
    public function testCollect()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\HttpFoundation\ParameterBag', $c->getRequestHeaders());
        $this->assertInstanceOf('Symphony\Component\HttpFoundation\ParameterBag', $c->getRequestServer());
        $this->assertInstanceOf('Symphony\Component\HttpFoundation\ParameterBag', $c->getRequestCookies());
        $this->assertInstanceOf('Symphony\Component\HttpFoundation\ParameterBag', $attributes);
        $this->assertInstanceOf('Symphony\Component\HttpFoundation\ParameterBag', $c->getRequestRequest());
        $this->assertInstanceOf('Symphony\Component\HttpFoundation\ParameterBag', $c->getRequestQuery());
        ...
        $this->assertInstanceOf('Symphony\Component\HttpFoundation\ParameterBag', $c->getResponseHeaders());
    ...
    public function provideControllerCallables()
    {
        ...
        return array(
            ...
            array(
                ...
                array(
                    'class' => 'Symphony\Component\HttpKernel\Tests\DataCollector\RequestDataCollectorTest',
            ...
            array(
                ...
                array('Symphony\Component\HttpKernel\Tests\DataCollector\RequestDataCollectorTest', 'staticControllerMethod'),
                array(
                    'class' => 'Symphony\Component\HttpKernel\Tests\DataCollector\RequestDataCollectorTest',
                    'method' => 'staticControllerMethod',
                    'file' => __FILE__,
            ...
            array(
                ...
                array('Symphony\Component\HttpKernel\Tests\DataCollector\RequestDataCollectorTest', 'magicMethod'),
                array(
                    'class' => 'Symphony\Component\HttpKernel\Tests\DataCollector\RequestDataCollectorTest',
                    'method' => 'magicMethod',
                    'file' => 'n/a',
    ...
    {
        $resolver = $this->getMockBuilder('Symphony\\Component\\HttpKernel\\Controller\\ControllerResolverInterface')->getMock();
