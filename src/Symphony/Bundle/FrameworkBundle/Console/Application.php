...
namespace Symphony\Bundle\FrameworkBundle\Console;
...
use Symphony\Component\Console\Application as BaseApplication;
...
class Application extends BaseApplication
{
    ...
    public function __construct(KernelInterface $kernel)
    {
        ...
        parent::__construct('Symphony', Kernel::VERSION);
    ...
    private function renderRegistrationErrors(InputInterface $input, OutputInterface $output)
    {
        ...
        (new SymphonyStyle($input, $output))->warning('Some commands could not be registered:');
