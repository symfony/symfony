...
namespace Symphony\Component\Translation\Tests\DataCollector;

use PHPUnit\Framework\TestCase;
use Symphony\Component\Translation\DataCollectorTranslator;
use Symphony\Component\Translation\DataCollector\TranslationDataCollector;

class TranslationDataCollectorTest extends TestCase
{
    protected function setUp()
    {
        if (!class_exists('Symphony\Component\HttpKernel\DataCollector\DataCollector')) {
    ...
    {
        $translator = $this
            ->getMockBuilder('Symphony\Component\Translation\DataCollectorTranslator')
