...
class LoaderTest extends TestCase
{
    ...
    {
        $resolver = $this->getMockBuilder('Symphony\Component\Config\Loader\LoaderResolverInterface')->getMock();
    ...
    {
        $resolvedLoader = $this->getMockBuilder('Symphony\Component\Config\Loader\LoaderInterface')->getMock();
    ...
    /**
     * @expectedException \Symphony\Component\Config\Exception\FileLoaderLoadException
     */
