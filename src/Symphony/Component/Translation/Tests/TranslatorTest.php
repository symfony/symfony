...
class TranslatorTest extends TestCase
{
    ...
    {
        $loaderClass = 'Symphony\\Component\\Translation\\Loader\\'.$loader;
        $translator = new Translator('en');
    ...
    /**
     * @expectedException \Symphony\Component\Translation\Exception\RuntimeException
     */
    ...
    {
        $translator = new Translator('en_GB');
        $translator->addLoader('yml', new \Symphony\Component\Translation\Loader\YamlFileLoader());
    ...
    {
        return array(
            array('Symphony est super !', 'Symphony is great!', 'Symphony est super !', array(), 'fr', ''),
            array('Symphony est awesome !', 'Symphony is %what%!', 'Symphony est %what% !', array('%what%' => 'awesome'), 'fr', ''),
            array('Symphony est super !', new StringClass('Symphony is great!'), 'Symphony est super !', array(), 'fr', ''),
        );
    }
    ...
    public function getFlattenedTransTests()
    {
        ...
        return array(
            array('Symphony est super!', $messages, 'symphony.is.great'),
