...
class ProgressBarTest extends TestCase
{
    ...
    public function testDisplayWithoutStart()
    {
        ...
        rewind($output->getStream());
        self::assertEquals('  0/50 [>---------------------------]   0%', stream_get_contents($output->getStream()));
    }
    ...
    public function testFinishWithoutStart()
    {
        ...
        rewind($output->getStream());
        self::assertEquals(' 50/50 [============================] 100%', stream_get_contents($output->getStream()));
    }
    ...
    public function testOverwriteWithSectionOutput()
    {
        ...
        rewind($output->getStream());
        self::assertEquals('  0/50 [>---------------------------]   0%'.\PHP_EOL.
        "\x1b[1A\x1b[0J".'  1/50 [>---------------------------]   2%'.\PHP_EOL.
        "\x1b[1A\x1b[0J".'  2/50 [=>--------------------------]   4%'.\PHP_EOL, stream_get_contents($output->getStream()));
    }
    ...
    public function testOverwriteWithAnsiSectionOutput()
    {
        ...
        rewind($output->getStream());
        self::assertSame(" \033[44;37m 0/50\033[0m [>---------------------------]   0%".\PHP_EOL.
        "\x1b[1A\x1b[0J"." \033[44;37m 1/50\033[0m [>---------------------------]   2%".\PHP_EOL.
        "\x1b[1A\x1b[0J"." \033[44;37m 2/50\033[0m [=>--------------------------]   4%".\PHP_EOL, stream_get_contents($output->getStream()));
        putenv('COLUMNS=120');
    }
    ...
    public function testOverwriteMultipleProgressBarsWithSectionOutputs()
    {
        ...
        "\x1b[1A\x1b[0J".'  1/50 [>---------------------------]   2%'.\PHP_EOL.
        '  1/50 [>---------------------------]   2%'.\PHP_EOL, stream_get_contents($stream->getStream()));
    }
    ...
    public function testOverwriteWithSectionOutputWithNewlinesInMessage()
    {
        ...
        rewind($output->getStream());
        self::assertEquals(' 0/50 [>]   0% %message% Fruitcake marzipan toffee. Cupcake gummi bears tart dessert ice cream chupa chups cupcake chocolate bar sesame snaps. Croissant halvah cookie jujubes powder macaroon. Fruitcake bear claw bonbon jelly beans oat cake pie muffin Fruitcake marzipan toffee.'.\PHP_EOL.
...
And, as in uffish thought he stood, The Jabberwock, with eyes of flame, Came whiffling through the tulgey wood, And burbled as it came! Fruitcake marzipan toffee. Cupcake gummi bears tart dessert ice cream chupa chups cupcake chocolate bar sesame snaps. Croissant halvah cookie jujubes powder macaroon. Fruitcake bear claw bonbon jelly beans oat cake pie muffin Fruitcake marzipan toffee.".\PHP_EOL, stream_get_contents($output->getStream()));
    ...
    public function testMultipleSectionsWithCustomFormat()
    {
        ...
        self::assertEquals('  0/50 [>---------------------------]   0%'.\PHP_EOL.
            ...
            ' 0/50 [>]   0% Fruitcake marzipan toffee. Cupcake gummi bears tart dessert ice cream chupa chups cupcake chocolate bar sesame snaps. Croissant halvah cookie jujubes powder macaroon. Fruitcake bear claw bonbon jelly beans oat cake pie muffin Fruitcake marzipan toffee.'.\PHP_EOL.
            "\x1b[3A\x1b[0J".' 1/50 [>]   2% Fruitcake marzipan toffee. Cupcake gummi bears tart dessert ice cream chupa chups cupcake chocolate bar sesame snaps. Croissant halvah cookie jujubes powder macaroon. Fruitcake bear claw bonbon jelly beans oat cake pie muffin Fruitcake marzipan toffee.'.\PHP_EOL, stream_get_contents($stream->getStream()));
    }
    ...
    public function testSetCurrentBeforeStarting()
    {
        ...
        $bar->setProgress(15);
        self::assertNotNull($bar->getStartTime());
    }
    ...
    public function testRedrawFrequency()
    {
        ...
        rewind($output->getStream());
        self::assertEquals(' 0/6 [>---------------------------]   0%'.
        $this->generateOutput(' 3/6 [==============>-------------]  50%').
        $this->generateOutput(' 5/6 [=======================>----]  83%').
        $this->generateOutput(' 6/6 [============================] 100%'), stream_get_contents($output->getStream()));
    }
    ...
    public function testNonDecoratedOutput()
    {
        ...
        rewind($output->getStream());
        self::assertEquals('   0/200 [>---------------------------]   0%'.\PHP_EOL.
        '  20/200 [==>-------------------------]  10%'.\PHP_EOL.
        '  40/200 [=====>----------------------]  20%'.\PHP_EOL.
        '  60/200 [========>-------------------]  30%'.\PHP_EOL.
        '  80/200 [===========>----------------]  40%'.\PHP_EOL.
    ...
    public function testSettingMaxStepsDuringProgressing()
    {
        ...
        rtrim($this->generateOutput(' 100/100 [============================] 100%')), stream_get_contents($output->getStream()));
    }
    ...
    public function testAnsiColorsAndEmojis()
    {
        ...
        rewind($output->getStream());
        self::assertEquals(" \033[44;37m Starting the demo... fingers crossed  \033[0m\n".
        ...
        rewind($output->getStream());
        self::assertEquals($this->generateOutput(
    ...
    public function testSetFormat()
    {
        ...
        $bar->start();
        rewind($output->getStream());
        self::assertEquals('    0 [>---------------------------]', stream_get_contents($output->getStream()));

        $bar = new ProgressBar($output = $this->getOutputStream(), 10, 0);
        $bar->setFormat(ProgressBar::FORMAT_NORMAL);
        $bar->start();
        rewind($output->getStream());
        self::assertEquals('  0/10 [>---------------------------]   0%', stream_get_contents($output->getStream()));
    }
    ...
    public function testUnicode()
    {
        ...
        $bar->start();
        rewind($output->getStream());
        self::assertStringContainsString(' 0/10 [💧]   0%', stream_get_contents($output->getStream()));
        $bar->finish();
    }
    ...
    public function testIterate()
    {
        ...
        self::assertEquals([1, 2], iterator_to_array($bar->iterate([1, 2])));

        rewind($output->getStream());
        self::assertEquals(' 0/2 [>---------------------------]   0%'.
        $this->generateOutput(' 1/2 [==============>-------------]  50%').
        $this->generateOutput(' 2/2 [============================] 100%'), stream_get_contents($output->getStream()));
    }
    ...
    public function testIterateUncountable()
    {
        ...
        self::assertEquals([1, 2], iterator_to_array($bar->iterate((function () {
            yield 1;
            yield 2;
        })())));
        ...
        $this->generateOutput('    1 [->--------------------------]').
        $this->generateOutput('    2 [-->-------------------------]').
        $this->generateOutput('    2 [============================]'), stream_get_contents($output->getStream()));
    }
    ...
    public function testBarWidthWithMultilineFormat()
    {
        ...
        // before starting
        $bar->setBarWidth(5);
        self::assertEquals(5, $bar->getBarWidth());

        // after starting
        $bar->start();
        rewind($output->getStream());
        self::assertEquals(5, $bar->getBarWidth(), stream_get_contents($output->getStream()));
        putenv('COLUMNS=120');
    }
    ...
    public function testMaxSecondsBetweenRedraws()
    {
        ...
        $this->generateOutput('    3 [--->------------------------]').
        $this->generateOutput('    4 [---->-----------------------]').
        $this->generateOutput('    7 [------->--------------------]'), stream_get_contents($output->getStream()));
    }
    ...
    public function testMinSecondsBetweenRedraws()
    {
        ...
        self::assertEquals('    0 [>---------------------------]'.
        $this->generateOutput('    2 [-->-------------------------]').
        $this->generateOutput('    4 [---->-----------------------]'), stream_get_contents($output->getStream()));
    }
    ...
    public function testNoWriteWhenMessageIsSame()
    {
        ...
        rewind($output->getStream());
        self::assertEquals(' 0/2 [>---------------------------]   0%'.
        $this->generateOutput(' 1/2 [==============>-------------]  50%'), stream_get_contents($output->getStream()));
    }
