...
use Symphony\Component\Form\SubmitButtonBuilder;
...
class FormBuilderTest extends TestCase
{
    ...
    {
        $this->{method_exists($this, $_ = 'expectException') ? $_ : 'setExpectedException'}('Symphony\Component\Form\Exception\UnexpectedTypeException');
    ...
    {
        $builder = $this->builder->add('foo', 'Symphony\Component\Form\Extension\Core\Type\TextType', array('bar' => 'baz'));
        $this->assertSame($builder, $this->builder);
    }
    ...
    public function testAdd()
    {
        ...
        $this->builder->add('foo', 'Symphony\Component\Form\Extension\Core\Type\TextType');
    ...
    public function testAddIntegerName()
    {
        ...
        $this->builder->add(0, 'Symphony\Component\Form\Extension\Core\Type\TextType');
    ...
    public function testAll()
    {
        $this->factory->expects($this->once())
            ...
            ->with('foo', 'Symphony\Component\Form\Extension\Core\Type\TextType')
    ...
    /*
     * https://github.com/symphony/symphony/issues/4693
     */
    public function testMaintainOrderOfLazyAndExplicitChildren()
    {
        $this->builder->add('foo', 'Symphony\Component\Form\Extension\Core\Type\TextType');
        $this->builder->add($this->getFormBuilder('bar'));
        $this->builder->add('baz', 'Symphony\Component\Form\Extension\Core\Type\TextType');
    ...
    {
        $this->assertFalse($this->builder->has('foo'));
        $this->builder->add('foo', $this->getMockBuilder('Symphony\Component\Form\FormTypeInterface')->getMock());
        $this->assertTrue($this->builder->has('foo'));
    }
    ...
    // https://github.com/symphony/symphony/pull/4826
    public function testRemoveAndGetForm()
    {
        $this->builder->add('foo', 'Symphony\Component\Form\Extension\Core\Type\TextType');
        $this->builder->remove('foo');
        $form = $this->builder->getForm();
        $this->assertInstanceOf('Symphony\Component\Form\Form', $form);
    }
    ...
    public function testCreateNoTypeNo()
    {
        $this->factory->expects($this->once())
            ->method('createNamedBuilder')
            ->with('foo', 'Symphony\Component\Form\Extension\Core\Type\TextType', null, array())
        ;
    ...
    public function testGetUnknown()
    {
        if (method_exists($this, 'expectException')) {
            $this->expectException('Symphony\Component\Form\Exception\InvalidArgumentException');
            $this->expectExceptionMessage('The child with the name "foo" does not exist.');
        } else {
            $this->setExpectedException('Symphony\Component\Form\Exception\InvalidArgumentException', 'The child with the name "foo" does not exist.');
        }
    ...
    {
        $expectedType = 'Symphony\Component\Form\Extension\Core\Type\TextType';
        $expectedName = 'foo';
    ...
    {
        $mock = $this->getMockBuilder('Symphony\Component\Form\FormBuilder')
