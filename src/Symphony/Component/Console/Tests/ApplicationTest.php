...
namespace Symphony\Component\Console\Tests;
...
use Symphony\Component\Console\Exception\NamespaceNotFoundException;
use Symphony\Component\Console\Helper\HelperSet;
use Symphony\Component\Console\Helper\FormatterHelper;
...
use Symphony\Component\Console\Output\StreamOutput;
use Symphony\Component\Console\Tester\ApplicationTester;
use Symphony\Component\Console\Event\ConsoleCommandEvent;
use Symphony\Component\Console\Event\ConsoleErrorEvent;
use Symphony\Component\Console\Event\ConsoleTerminateEvent;
...
class ApplicationTest extends TestCase
{
    ...
    public function testAll()
    {
        ...
        $this->assertInstanceOf('Symphony\\Component\\Console\\Command\\HelpCommand', $commands['help'], '->all() returns the registered commands');
    ...
    public function testHasGet()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\Console\Command\HelpCommand', $command, '->get() returns the help command if --help is provided as the input');
    }
    ...
    /**
     * @expectedException        \Symphony\Component\Console\Exception\NamespaceNotFoundException
    ...
    public function testFind()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\Console\Command\HelpCommand', $application->find('h'), '->find() returns a command if its name exists');
    ...
    {
        if (method_exists($this, 'expectException')) {
            $this->expectException('Symphony\Component\Console\Exception\CommandNotFoundException');
            $this->expectExceptionMessage($expectedExceptionMessage);
        } else {
            $this->setExpectedException('Symphony\Component\Console\Exception\CommandNotFoundException', $expectedExceptionMessage);
        }
...
', $tester->getDisplay(true));
    ...
    public function testFindAlternativeExceptionMessageMultiple()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('Symphony\Component\Console\Exception\CommandNotFoundException', $e, '->find() throws a CommandNotFoundException if command does not exist, with alternatives');
        ...
        try {
            ...
            $this->fail('->find() should throw an Symphony\Component\Console\Exception\CommandNotFoundException if a command is ambiguous because of a subnamespace, with alternatives');
        } catch (\Exception $e) {
            $this->assertInstanceOf('Symphony\Component\Console\Exception\CommandNotFoundException', $e);
    ...
    public function testFindAlternativeCommands()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('Symphony\Component\Console\Exception\CommandNotFoundException', $e, '->find() throws a CommandNotFoundException if command does not exist');
    ...
    public function testFindAlternativeNamespace()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('Symphony\Component\Console\Exception\CommandNotFoundException', $e, '->find() throws a CommandNotFoundException if namespace does not exist');
            $this->assertSame(array(), $e->getAlternatives());
        ...
        try {
            ...
            $this->assertInstanceOf('Symphony\Component\Console\Exception\NamespaceNotFoundException', $e, '->find() throws a NamespaceNotFoundException if namespace does not exist');
            $this->assertInstanceOf('Symphony\Component\Console\Exception\CommandNotFoundException', $e, 'NamespaceNotFoundException extends from CommandNotFoundException');
    ...
    public function testFindAlternativesOutput()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('Symphony\Component\Console\Exception\CommandNotFoundException', $e, '->find() throws a CommandNotFoundException if command is not defined');
    ...
    {
        $application = $this->getMockBuilder('Symphony\Component\Console\Application')->setMethods(array('getNamespaces'))->getMock();
    ...
    {
        $application = $this->getMockBuilder('Symphony\Component\Console\Application')->setMethods(array('getTerminalWidth'))->getMock();
        $application->setAutoExit(false);
    ...
    public function testRun()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\Console\Input\ArgvInput', $command->input, '->run() creates an ArgvInput by default if none is given');
        $this->assertInstanceOf('Symphony\Component\Console\Output\ConsoleOutput', $command->output, '->run() creates a ConsoleOutput by default if none is given');
    ...
    public function testRunReturnsIntegerExitCode()
    {
        ...
        $application = $this->getMockBuilder('Symphony\Component\Console\Application')->setMethods(array('doRun'))->getMock();
        $application->setAutoExit(false);
        $application->expects($this->once())
            ->method('doRun')
