...
namespace Symphony\Bundle\WebProfilerBundle\Tests\Csp;
...
class ContentSecurityPolicyHandlerTest extends TestCase
{
    ...
    public function testOnKernelResponse($nonce, $expectedNonce, Request $request, Response $response, array $expectedCsp)
    {
        ...
        $this->assertFalse($response->headers->has('X-SymphonyProfiler-Script-Nonce'));
        $this->assertFalse($response->headers->has('X-SymphonyProfiler-Style-Nonce'));
    ...
    public function provideRequestAndResponses()
    {
        ...
        $requestNonceHeaders = array(
            'X-SymphonyProfiler-Script-Nonce' => $requestScriptNonce,
            'X-SymphonyProfiler-Style-Nonce' => $requestStyleNonce,
        );
        $responseNonceHeaders = array(
            'X-SymphonyProfiler-Script-Nonce' => $responseScriptNonce,
            'X-SymphonyProfiler-Style-Nonce' => $responseStyleNonce,
        );
    ...
    {
        $generator = $this->getMockBuilder('Symphony\Bundle\WebProfilerBundle\Csp\NonceGenerator')->getMock();
