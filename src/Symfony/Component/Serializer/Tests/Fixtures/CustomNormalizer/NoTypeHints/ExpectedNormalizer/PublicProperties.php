...
class Symfony_Component_Serializer_Tests_Fixtures_CustomNormalizer_NoTypeHints_PublicProperties implements NormalizerInterface, DenormalizerInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $object, ?string $format = NULL, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        return [
            ...
            'age' => $this->normalizeChild($object->age, $format, $context, true),
            'height' => $this->normalizeChild($object->height, $format, $context, true),
            'handsome' => $this->normalizeChild($object->handsome, $format, $context, true),
            'nameOfFriends' => $this->normalizeChild($object->nameOfFriends, $format, $context, true),
            'picture' => $this->normalizeChild($object->picture, $format, $context, true),
            'pet' => $this->normalizeChild($object->pet, $format, $context, true),
            'relation' => $this->normalizeChild($object->relation, $format, $context, true),
            'notSet' => $this->normalizeChild($object->notSet, $format, $context, true),
        ];
    }
