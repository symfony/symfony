...
{
    public static function getResolver(array $chainableResolvers = [], ?array $namedResolvers = null): ControllerArgumentResolver
    {
        if (null !== $namedResolvers) {
            $namedResolvers = new ServiceLocator(array_map(fn ($resolver) => fn () => $resolver, $namedResolvers));
        }

        return new ControllerArgumentResolver(new ArgumentMetadataFactory(), $chainableResolvers, $namedResolvers);
    }

    public function testDefaultState()
    {
        $this->assertEquals(self::getResolver(), new ControllerArgumentResolver());
        $this->assertNotEquals(self::getResolver(), new ControllerArgumentResolver(null, [new RequestAttributeValueResolver()]));
    }
    ...
    public function testGetArguments()
    {
        ...
        $controller = [new ControllerArgumentResolverTestController(), 'controllerWithFoo'];
    ...
    {
        $request = Request::create('/');
        $controller = [new ControllerArgumentResolverTestController(), 'controllerWithoutArguments'];
    ...
    public function testGetArgumentsUsesDefaultValue()
    {
        $request = Request::create('/');
        $request->attributes->set('foo', 'foo');
        $controller = [new ControllerArgumentResolverTestController(), 'controllerWithFooAndDefaultBar'];
    ...
    public function testGetArgumentsFromInvokableObject()
    {
        $request = Request::create('/');
        $request->attributes->set('foo', 'foo');
        $controller = new ControllerArgumentResolverTestController();
    ...
    {
        $request = Request::create('/');
        $controller = [new ControllerArgumentResolverTestController(), 'controllerWithRequest'];
    ...
    public function testGetArgumentsInjectsExtendingRequest()
    {
        ...
        $controller = [new ControllerArgumentResolverTestController(), 'controllerWithExtendingRequest'];
    ...
    public function testGetVariadicArguments()
    {
        ...
        $values = self::getResolver()->getArguments($request, $controller);

        $this->assertEquals(['foo', 'foo', 'bar'], $values);
    }
    ...
    public function testGetSessionArguments()
    {
        ...
        $controller = (new ControllerArgumentResolverTestController())->controllerWithSession(...);
    ...
    public function testGetSessionArgumentsWithExtendedSession()
    {
        ...
        $request = Request::create('/');
        $request->setSession($session);
        $controller = (new ControllerArgumentResolverTestController())->controllerWithExtendingSession(...);
    ...
    public function testGetSessionArgumentsWithInterface()
    {
        ...
        $request = Request::create('/');
        $request->setSession($session);
        $controller = (new ControllerArgumentResolverTestController())->controllerWithSessionInterface(...);
    ...
    public function testTargetedResolver()
    {
        ...
        $controller = (new ControllerArgumentResolverTestController())->controllerTargetingResolver(...);
    ...
    public function testTargetedResolverWithDefaultValue()
    {
        ...
        $request = Request::create('/');
        $controller = (new ControllerArgumentResolverTestController())->controllerTargetingResolverWithDefaultValue(...);
    ...
    public function testTargetedResolverWithNullableValue()
    {
        ...
        $request = Request::create('/');
        $controller = (new ControllerArgumentResolverTestController())->controllerTargetingResolverWithNullableValue(...);
    ...
    public function testTargetedResolverWithRequestAttributeValue()
    {
        ...
        $controller = (new ControllerArgumentResolverTestController())->controllerTargetingResolverWithTestEntity(...);
    ...
    public function testDisabledResolver()
    {
        ...
        $request = Request::create('/');
        $request->attributes->set('foo', 'bar');
        $controller = (new ControllerArgumentResolverTestController())->controllerDisablingResolver(...);
    ...
    public function testManyTargetedResolvers()
    {
        ...
        $request = Request::create('/');
        $controller = (new ControllerArgumentResolverTestController())->controllerTargetingManyResolvers(...);
    ...
    public function testUnknownTargetedResolver()
    {
        ...
        $request = Request::create('/');
        $controller = (new ControllerArgumentResolverTestController())->controllerTargetingUnknownResolver(...);
    ...
    public function testExceptionListSingle()
    {
        ...
        $this->expectException(\RuntimeException::class);
        $this->expectExceptionMessage('Controller "Symfony\Component\HttpKernel\Tests\Controller\ArgumentResolver\ControllerArgumentResolverTestController::controllerWithFoo" requires the "$foo" argument that could not be resolved. Some reason why value could not be resolved.');
        $resolver->getArguments($request, $controller);
    }
...
class ControllerArgumentResolverTestController
{
