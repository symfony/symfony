...
class FinderTest extends Iterator\RealIteratorTestCase
{
    ...
    {
        $finder = $this->buildFinder($adapter);
        $finder->in(__DIR__.DIRECTORY_SEPARATOR.'Fixtures'.DIRECTORY_SEPARATOR.'r+e.g?ex[c]a(r)s')
            ->path('/^dir/');

        $expected = array('r+e.g?ex[c]a(r)s'.DIRECTORY_SEPARATOR.'dir',
                          'r+e.g?ex[c]a(r)s'.DIRECTORY_SEPARATOR.'dir'.DIRECTORY_SEPARATOR.'bar.dat',);
        $this->assertIterator($this->toAbsoluteFixtures($expected), $finder);
    }
