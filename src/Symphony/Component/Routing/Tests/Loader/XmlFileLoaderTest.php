...
use Symphony\Component\Routing\Tests\Fixtures\CustomXmlFileLoader;

class XmlFileLoaderTest extends TestCase
{
    public function testSupports()
    {
        $loader = new XmlFileLoader($this->getMockBuilder('Symphony\Component\Config\FileLocator')->getMock());
    ...
    public function testLoadWithRoute()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\Routing\Route', $route);
