...
class AboutCommand extends Command
{
    ...
    protected function configure()
    {
        $this
            ...
            ->setHelp(<<<'EOT'
The <info>%command.name%</info> command displays information about the current Symphony project.

The <info>PHP</info> section displays important configuration that could affect your application. The values might
be different between web and CLI.

The <info>Environment</info> section displays the current environment variables managed by Symphony Dotenv. It will not
...
EOT
    ...
    {
        $vars = array();
        foreach (explode(',', getenv('SYMPHONY_DOTENV_VARS')) as $name) {
