...
class CheckboxTypeTest extends TypeTestCase
{
    ...
    {
        $form = $this->factory->create(CheckboxType::class, null, array('value' => 'foobar'));
    ...
    {
        $form = $this->factory->create(CheckboxType::class, null, array('value' => ''));
        $form->setData(true);
        $view = $form->createView();
    ...
    {
        $form = $this->factory->create(CheckboxType::class, null, array(
            'value' => 'foobar',
        ));
        $form->submit('foobar');
    ...
    public function testCustomModelTransformer($data, $checked)
    {
        ...
        $form = $this->factory->createBuilder(CheckboxType::class)
