...
class RequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetClientIpProvider()
    {
        return array(
            ...
            array('87.65.43.21',              true,  '123.45.67.89', '87.65.43.21',                         array('123.45.67.0/24')),
            array('123.45.67.89',             true,  '::1',          '123.45.67.89',                        array('::1')),
            array('127.0.0.1',                true,  '::1',          '127.0.0.1, 2620:0:1cfe:face:b00c::3', array('::1', '2620::/32')),
        );
    }
