...
class Autoconfigure
{
     ...
     * @param                                                $lazy         Whether the service is lazy-loaded
     * @param                                                $public       Whether to declare the service as public
     * @param                                                $shared       Whether to declare the service as shared
     * @param                                                $autowire     Whether to declare the service as autowired
     ...
     * @param                                                $constructor  The public static method to use to instantiate the service
     */
