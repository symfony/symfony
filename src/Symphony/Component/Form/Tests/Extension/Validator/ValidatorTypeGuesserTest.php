...
use Symphony\Component\Form\Extension\Validator\ValidatorTypeGuesser;
...
use Symphony\Component\Validator\Constraints\Type;
...
{
    const TEST_CLASS = 'Symphony\Component\Form\Tests\Extension\Validator\ValidatorTypeGuesserTest_TestClass';
    ...
    protected function setUp()
    {
        ...
        $this->metadataFactory = $this->getMockBuilder('Symphony\Component\Validator\Mapping\Factory\MetadataFactoryInterface')->getMock();
    ...
    public function testGuessMaxLengthForConstraintWithMaxValue()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\Form\Guess\ValueGuess', $result);
