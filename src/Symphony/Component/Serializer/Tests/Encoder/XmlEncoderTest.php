...
use Symphony\Component\Serializer\Encoder\XmlEncoder;
...
XML;
    ...
    public function testDecodeEmptyXml()
    {
        if (method_exists($this, 'expectException')) {
            $this->expectException('Symphony\Component\Serializer\Exception\UnexpectedValueException');
            $this->expectExceptionMessage('Invalid XML data, it can not be empty.');
        } else {
            $this->setExpectedException('Symphony\Component\Serializer\Exception\UnexpectedValueException', 'Invalid XML data, it can not be empty.');
        }
...
XML;
    ...
    {
        $mock = $this->getMockBuilder('\Symphony\Component\Serializer\Normalizer\CustomNormalizer')->getMock();
