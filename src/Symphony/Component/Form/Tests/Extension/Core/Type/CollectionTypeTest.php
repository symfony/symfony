...
use Symphony\Component\Form\Tests\Fixtures\Author;
use Symphony\Component\Form\Tests\Fixtures\AuthorType;

class CollectionTypeTest extends BaseTypeTest
{
    const TESTED_TYPE = 'Symphony\Component\Form\Extension\Core\Type\CollectionType';
    ...
    public function testSetDataAdjustsSize()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\Form\Form', $form[0]);
        $this->assertInstanceOf('Symphony\Component\Form\Form', $form[1]);
    ...
    {
        $form = $this->factory->create(static::TESTED_TYPE, null, array(
            'entry_type' => 'Symphony\Component\Form\Tests\Fixtures\AuthorType',
            // If the field is not required, no new Author will be created if the
            // form is completely empty
