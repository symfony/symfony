...
namespace Symphony\Bundle\SecurityBundle\DependencyInjection;

use Symphony\Bundle\SecurityBundle\DependencyInjection\Security\Factory\AbstractFactory;
    ...
    private function addFirewallsSection(ArrayNodeDefinition $rootNode, array $factories)
    {
        ...
        $firewallNodeBuilder
            ...
            ->booleanNode('logout_on_user_change')
                ...
                ->setDeprecated('The "%path%.%node%" configuration key has been deprecated in Symphony 4.1.')
            ->end()
            ->arrayNode('logout')
                ->treatTrueLike(array())
                ->canBeUnset()
