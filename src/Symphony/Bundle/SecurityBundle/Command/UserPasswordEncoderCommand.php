...
namespace Symphony\Bundle\SecurityBundle\Command;
...
use Symphony\Component\Security\Core\Encoder\SelfSaltingEncoderInterface;
...
security:
    encoders:
        Symphony\Component\Security\Core\User\User: plaintext
...
EOF
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $errorIo = $output instanceof ConsoleOutputInterface ? new SymphonyStyle($input, $output->getErrorOutput()) : $io;

        $input->isInteractive() ? $errorIo->title('Symphony Password Encoder Utility') : $errorIo->newLine();
    ...
    private function getUserClass(InputInterface $input, SymphonyStyle $io)
    {
