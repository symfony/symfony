...
namespace Symphony\Component\Dotenv;

use Symphony\Component\Dotenv\Exception\FormatException;
use Symphony\Component\Dotenv\Exception\FormatExceptionContext;
use Symphony\Component\Dotenv\Exception\PathException;
use Symphony\Component\Process\Exception\ExceptionInterface as ProcessException;
...
final class Dotenv
{
    ...
    {
        $loadedVars = array_flip(explode(',', getenv('SYMPHONY_DOTENV_VARS')));
        unset($loadedVars['']);
        ...
        if ($loadedVars) {
            ...
            putenv("SYMPHONY_DOTENV_VARS=$loadedVars");
            $_ENV['SYMPHONY_DOTENV_VARS'] = $loadedVars;
            $_SERVER['SYMPHONY_DOTENV_VARS'] = $loadedVars;
        }
    }
    ...
    private function resolveCommands($value)
    {
        ...
        return preg_replace_callback($regex, function ($matches) {
            ...
            if (!class_exists(Process::class)) {
                throw new \LogicException('Resolving commands requires the Symphony Process component.');
            }
