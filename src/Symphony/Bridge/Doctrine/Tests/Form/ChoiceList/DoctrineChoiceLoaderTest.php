...
namespace Symphony\Bridge\Doctrine\Tests\Form\ChoiceList;

use Doctrine\Common\Persistence\ObjectManager;
use Doctrine\Common\Persistence\ObjectRepository;
use Doctrine\ORM\Mapping\ClassMetadata;
use PHPUnit\Framework\TestCase;
use Symphony\Bridge\Doctrine\Form\ChoiceList\DoctrineChoiceLoader;
use Symphony\Bridge\Doctrine\Form\ChoiceList\EntityLoaderInterface;
use Symphony\Bridge\Doctrine\Form\ChoiceList\IdReader;
...
class DoctrineChoiceLoaderTest extends TestCase
{
    ...
    {
        $this->factory = $this->getMockBuilder('Symphony\Component\Form\ChoiceList\Factory\ChoiceListFactoryInterface')->getMock();
        ...
        $this->class = 'stdClass';
        $this->idReader = $this->getMockBuilder('Symphony\Bridge\Doctrine\Form\ChoiceList\IdReader')
            ->disableOriginalConstructor()
            ->getMock();
        $this->objectLoader = $this->getMockBuilder('Symphony\Bridge\Doctrine\Form\ChoiceList\EntityLoaderInterface')->getMock();
