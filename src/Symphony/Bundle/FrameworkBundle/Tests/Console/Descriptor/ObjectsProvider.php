...
class ObjectsProvider
{
    ...
    public static function getContainerParameter()
    {
        ...
        $builder->setParameter('database_name', 'symphony');
    ...
    public static function getCallables()
    {
        return array(
            ...
            'callable_2' => array('Symphony\\Bundle\\FrameworkBundle\\Tests\\Console\\Descriptor\\CallableClass', 'staticMethod'),
            'callable_3' => array(new CallableClass(), 'method'),
            'callable_4' => 'Symphony\\Bundle\\FrameworkBundle\\Tests\\Console\\Descriptor\\CallableClass::staticMethod',
            'callable_5' => array('Symphony\\Bundle\\FrameworkBundle\\Tests\\Console\\Descriptor\\ExtendedCallableClass', 'parent::staticMethod'),
