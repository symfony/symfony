...
class ProcessBuilderTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @group legacy
     * @expectedDeprecation Delayed variables are deprecated since Symfony 3.3 and will be left unresolved in 4.0. Resolve the !FOO! variable before calling ProcessUtils::escapeArgument().
     */
    public function testDelayedVars()
    {
        ...
        $proc->run();
        $this->assertSame('BAR', trim($proc->getOutput()));
    }
