        ...
        $rootNode
            ->children()
                ->arrayNode('session')
                    ...
                    ->canBeUnset()
                    ->children()
                        ->booleanNode('auto_start')->defaultValue(true)->end()
                        ->booleanNode('start_on_demand')->defaultValue(true)->end()
                        ->booleanNode('emulation_mode')->defaultValue(true)->end()
                        ->booleanNode('mock_name')->defaultValue('MOCKSESSID')->end()
