...
namespace Symphony\Component\Form\Tests\DependencyInjection;
...
use Symphony\Component\Form\FormRegistryInterface;
...
class FormPassTest extends TestCase
{
    ...
    public function testAddTaggedTypesToDebugCommand()
    {
        ...
        $this->assertEquals(
            array(
                'Symphony\Component\Form\Extension\Core\Type',
                __NAMESPACE__,
            ),
    ...
    public function privateTaggedServicesProvider()
    {
        return array(
            ...
            array(
                ...
                function (ContainerBuilder $container) {
                    $this->assertEquals(
                        array('Symphony\Component\Form\Extension\Core\Type\FormType' => new IteratorArgument(array(new Reference('my.type_extension')))),
                        $container->getDefinition('form.extension')->getArgument(1)
                    );
                },
                array('extended_type' => 'Symphony\Component\Form\Extension\Core\Type\FormType'),
            ),
    ...
    {
        $definition = new Definition('Symphony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension');
    ...
    {
        $definition = new Definition('Symphony\Component\Form\Command\DebugCommand');
        $definition->setPublic(true);
        $definition->setArguments(array(
            $formRegistry = $this->getMockBuilder(FormRegistryInterface::class)->getMock(),
            array(),
            array('Symphony\Component\Form\Extension\Core\Type'),
        ));
