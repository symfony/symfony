...
class IntersectionTypeTest extends TestCase
{
    ...
    public function testCannotCreateWithIntersectionTypePart(): void
    {
        $this->expectException(InvalidArgumentException::class);
    ...
    public function testCannotCreateWithNonObjectTypePart(): void
    {
        $this->expectException(InvalidArgumentException::class);
        new IntersectionType(Type::object(\DateTime::class), Type::int());
    }

    public function testCannotCreateWithNullableTypePart(): void
    {
        $this->expectException(InvalidArgumentException::class);
        new IntersectionType(Type::object(\DateTime::class), Type::nullable(Type::object(\Stringable::class)));
    }

    public function testCanCreateWithWrappingTypes(): void
    {
