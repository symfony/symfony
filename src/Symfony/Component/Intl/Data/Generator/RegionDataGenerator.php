...
{
    public const UNKNOWN_REGION_ID = 'ZZ';

    public const OUTLYING_OCEANIA_REGION_ID = 'QO';

    public const EUROPEAN_UNION_ID = 'EU';

    public const NETHERLANDS_ANTILLES_ID = 'AN';

    public const BOUVET_ISLAND_ID = 'BV';

    public const HEARD_MCDONALD_ISLANDS_ID = 'HM';

    public const CLIPPERTON_ISLAND_ID = 'CP';
