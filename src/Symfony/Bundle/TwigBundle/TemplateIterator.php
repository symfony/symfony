...
class TemplateIterator implements \IteratorAggregate
{
    ...
    public function getIterator()
    {
        ...
        $templates = null !== $this->rootDir ? $this->findTemplatesInDirectory($this->rootDir.'/Resources/views') : [];
        ...
        foreach ($this->kernel->getBundles() as $bundle) {
            ...
            $templates = array_merge(
                ...
                null !== $this->rootDir ? $this->findTemplatesInDirectory($this->rootDir.'/Resources/'.$bundle->getName().'/views', $name) : []
            );
            if (null !== $this->defaultPath) {
                $templates = array_merge(
                    $templates,
