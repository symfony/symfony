...
class MailerSendSignedRequestParserTest extends AbstractRequestParserTestCase
{
    ...
    public static function getPayloads(): iterable
    {
        ...
        $requestContent = file_get_contents($currentDir.'/Fixtures/sent.json');
        $signingSecret = 'PnzMUKGNoNUPwuHj4yythmoI7h6teiC2';
    ...
    {
        return 'PnzMUKGNoNUPwuHj4yythmoI7h6teiC2';
    }
    ...
    protected function createRequest(string $payload): Request
    {
        return Request::create(
            ...
            server: [
                ...
                'HTTP_Signature' => '213b4053b0e3d44466eb39970f24f15cb178750d55c0ccd4c2e898d69b0f820d',
            ],
            content: str_replace("\n", '', $payload)
        );
    }
