...
use Symphony\Component\Yaml\Dumper as YmlDumper;
...
class YamlDumper extends Dumper
{
    ...
    {
        if (!class_exists('Symphony\Component\Yaml\Dumper')) {
            throw new RuntimeException('Unable to dump the container as the Symphony Yaml Component is not installed.');
        }
