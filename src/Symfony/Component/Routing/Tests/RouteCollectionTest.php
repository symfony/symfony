...
class RouteCollectionTest extends TestCase
{
    ...
    {
        $collection = new RouteCollection();
        $collection->add('foo', $foo = new Route('/foo', ['_canonical_route' => 'foo']));
        $collection->add('bar', $bar = new Route('/bar', ['_canonical_route' => 'bar']));
        $collection->add('api_foo', $apiFoo = new Route('/api/foo', ['_canonical_route' => 'api_foo']));
        $collection->addNamePrefix('api_');
