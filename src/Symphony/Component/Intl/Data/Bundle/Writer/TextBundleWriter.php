...
namespace Symphony\Component\Intl\Data\Bundle\Writer;

use Symphony\Component\Intl\Exception\UnexpectedTypeException;

/**
 * Writes .txt resource bundles.
 *
 * The resulting files can be converted to binary .res files using a
 * {@link \Symphony\Component\Intl\ResourceBundle\Compiler\BundleCompilerInterface}
 * implementation.
 *
