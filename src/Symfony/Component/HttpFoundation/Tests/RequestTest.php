...
class RequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $request = new Request();
        $this->assertEmpty($request->getCharsets());
        $request->headers->set('Accept-Charset', 'ISO-8859-1, US-ASCII, UTF-8; q=0.8, ISO-10646-UCS-2; q=0.6');
        $this->assertEmpty($request->getCharsets()); // testing caching
    ...
    public function testGetAcceptableContentTypes()
    {
        ...
        $this->assertEmpty($request->getAcceptableContentTypes()); // testing caching
    ...
    {
        $request = new Request();
        $this->assertEmpty($request->getLanguages());
