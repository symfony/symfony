...
namespace Symphony\Bridge\Doctrine\Tests\DataCollector;

use Doctrine\DBAL\Platforms\MySqlPlatform;
use PHPUnit\Framework\TestCase;
use Symphony\Bridge\Doctrine\DataCollector\DoctrineDataCollector;
    ...
    public function paramProvider()
    {
        return array(
            ...
            array(
                ...
                array(),
                '/* Object(Symphony\Bridge\Doctrine\Tests\DataCollector\StringRepresentableClass): */"string representation"',
                false,
            ),
        );
    }
