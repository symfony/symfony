...
namespace Symphony\Component\EventDispatcher\Tests\DependencyInjection;
...
class RegisterListenersPassTest extends TestCase
{
    ...
    public function testValidEventSubscriber()
    {
        ...
        $builder->register('my_event_subscriber', 'Symphony\Component\EventDispatcher\Tests\DependencyInjection\SubscriberService')
            ->addTag('kernel.event_subscriber');
    ...
    public function testEventSubscriberResolvableClassName()
    {
        ...
        $container->setParameter('subscriber.class', 'Symphony\Component\EventDispatcher\Tests\DependencyInjection\SubscriberService');
...
class SubscriberService implements \Symphony\Component\EventDispatcher\EventSubscriberInterface
{
