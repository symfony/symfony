...
use Symphony\Component\Form\Util\InheritDataAwareIterator;
use Symphony\Component\PropertyAccess\PropertyPathIterator;
use Symphony\Component\PropertyAccess\PropertyPathBuilder;
use Symphony\Component\PropertyAccess\PropertyPathIteratorInterface;
...
class ViolationMapper implements ViolationMapperInterface
{
    ...
    private function reconstructPath(ViolationPath $violationPath, FormInterface $origin)
    {
        ...
        for ($it->rewind(); $it->valid() && $it->mapsForm(); $it->next()) {
            ...
            if ($scope->getConfig()->getInheritData()) {
                ...
                /* @var \Symphony\Component\PropertyAccess\PropertyPathInterface $propertyPath */
    ...
    private function acceptsErrors(FormInterface $form)
    {
        ...
        // requests.
        // https://github.com/symphony/symphony/pull/10567
