...
namespace Symphony\Component\Security\Guard\Tests\Authenticator;
...
use Symphony\Component\Security\Guard\Authenticator\AbstractFormLoginAuthenticator;
...
class FormLoginAuthenticatorTest extends TestCase
{
    ...
    public function testAuthenticationFailureWithoutSession()
    {
        ...
        $this->assertInstanceOf('Symphony\\Component\\HttpFoundation\\RedirectResponse', $failureResponse);
