...
use Symphony\Component\Validator\Tests\Fixtures\PropertyConstraint;
...
class ClassMetadataTest extends TestCase
{
    ...
    const PROVIDERCLASS = 'Symphony\Component\Validator\Tests\Fixtures\GroupSequenceProviderEntity';
    const PROVIDERCHILDCLASS = 'Symphony\Component\Validator\Tests\Fixtures\GroupSequenceProviderChildEntity';
    ...
    public function testGroupSequencesWorkIfContainingDefaultGroup()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\Validator\Constraints\GroupSequence', $this->metadata->getGroupSequence());
    }

    /**
     * @expectedException \Symphony\Component\Validator\Exception\GroupDefinitionException
     */
