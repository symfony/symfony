...
use Symphony\Component\Form\Exception\BadMethodCallException;
...
class FormBuilder extends FormConfigBuilder implements \IteratorAggregate, FormBuilderInterface
{
    ...
    public function add($child, $type = null, array $options = array())
    {
        ...
        if (!is_string($child) && !is_int($child)) {
            throw new UnexpectedTypeException($child, 'string, integer or Symphony\Component\Form\FormBuilderInterface');
        }

        if (null !== $type && !is_string($type) && !$type instanceof FormTypeInterface) {
            throw new UnexpectedTypeException($type, 'string or Symphony\Component\Form\FormTypeInterface');
        }
