...
class EntityTypeTest extends TypeTestCase
{
    ...
    {
        $this->factory->createNamed('name', 'entity', array(
            'class' => 'foo',
        ));
    }
    ...
    public function testSetDataToUninitializedEntityWithNonRequired()
    {
        ...
        $field = $this->factory->createNamed('name', 'entity', array(
            'em' => 'default',
    ...
    public function testCacheChoiceLists()
    {
        ...
        $field1 = $this->factory->createNamed('name', 'entity', array(
            'em' => 'default',
            'class' => self::SINGLE_IDENT_CLASS,
            'required' => false,
            'choice_label' => 'name',
        ...
        $field2 = $this->factory->createNamed('name', 'entity', array(
            'em' => 'default',
            'class' => self::SINGLE_IDENT_CLASS,
            'required' => false,
            'choice_label' => 'name',
