...
use Symphony\Component\Security\Core\Exception\InvalidArgumentException;
use Symphony\Component\Security\Csrf\TokenGenerator\UriSafeTokenGenerator;
use Symphony\Component\Security\Csrf\TokenGenerator\TokenGeneratorInterface;
use Symphony\Component\Security\Csrf\TokenStorage\NativeSessionTokenStorage;
use Symphony\Component\Security\Csrf\TokenStorage\TokenStorageInterface;
