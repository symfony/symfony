...
namespace Symphony\Bridge\Doctrine\Security\RememberMe;

use Symphony\Component\Security\Core\Authentication\RememberMe\TokenProviderInterface;
use Symphony\Component\Security\Core\Authentication\RememberMe\PersistentTokenInterface;
use Symphony\Component\Security\Core\Authentication\RememberMe\PersistentToken;
use Symphony\Component\Security\Core\Exception\TokenNotFoundException;
