...
class FilesystemTest extends FilesystemTestCase
{
    ...
    /**
     * @expectedException \Symphony\Component\Filesystem\Exception\IOException
     */
    ...
    {
        $sourceFilePath = 'http://symphony.com/images/common/logo/logo_symphony_header.png';
        $targetFilePath = $this->workspace.DIRECTORY_SEPARATOR.'copy_target_file';
    ...
    {
        $paths = array(
            array('/var/lib/symphony/src/Symphony/', '/var/lib/symphony/src/Symphony/Component', '../'),
            array('/var/lib/symphony/src/Symphony/', '/var/lib/symphony/src/Symphony/Component/', '../'),
            array('/var/lib/symphony/src/Symphony', '/var/lib/symphony/src/Symphony/Component', '../'),
            array('/var/lib/symphony/src/Symphony', '/var/lib/symphony/src/Symphony/Component/', '../'),
            array('/usr/lib/symphony/', '/var/lib/symphony/src/Symphony/Component', '../../../../../../usr/lib/symphony/'),
            array('/var/lib/symphony/src/Symphony/', '/var/lib/symphony/', 'src/Symphony/'),
            array('/aa/bb', '/aa/bb', './'),
            array('/aa/bb', '/aa/bb/', './'),
            array('/aa/bb/', '/aa/bb', './'),
            array('/aa/bb/', '/aa/bb/', './'),
        ...
        if ('\\' === DIRECTORY_SEPARATOR) {
            $paths[] = array('c:\var\lib/symphony/src/Symphony/', 'c:/var/lib/symphony/', 'src/Symphony/');
        }
    ...
    /**
     * @expectedException \Symphony\Component\Filesystem\Exception\InvalidArgumentException
     * @expectedExceptionMessage The start path "var/lib/symphony/src/Symphony/Component" is not absolute.
     */
    public function testMakePathRelativeWithRelativeStartPath()
    {
        $this->assertSame('../../../', $this->filesystem->makePathRelative('/var/lib/symphony/', 'var/lib/symphony/src/Symphony/Component'));
    }

    /**
     * @expectedException \Symphony\Component\Filesystem\Exception\InvalidArgumentException
     * @expectedExceptionMessage The end path "var/lib/symphony/" is not absolute.
     */
    ...
    {
        stream_wrapper_register('mock', 'Symphony\Component\Filesystem\Tests\Fixtures\MockStream\MockStream');
