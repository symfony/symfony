...
use Symphony\Component\Security\Core\Encoder\MessageDigestPasswordEncoder;
use Symphony\Component\Security\Core\Encoder\EncoderFactory;
use Symphony\Component\Security\Core\Encoder\EncoderAwareInterface;
...
class EncoderFactoryTest extends TestCase
{
    ...
    {
        $factory = new EncoderFactory(array('Symphony\Component\Security\Core\User\UserInterface' => array(
            'class' => 'Symphony\Component\Security\Core\Encoder\MessageDigestPasswordEncoder',
            'arguments' => array('sha512', true, 5),
        )));

        $encoder = $factory->getEncoder($this->getMockBuilder('Symphony\Component\Security\Core\User\UserInterface')->getMock());
    ...
    public function testGetEncoderWithService()
    {
        $factory = new EncoderFactory(array(
            'Symphony\Component\Security\Core\User\UserInterface' => new MessageDigestPasswordEncoder('sha1'),
        ));
    ...
    public function testGetEncoderWithClassName()
    {
        ...
        $encoder = $factory->getEncoder('Symphony\Component\Security\Core\Tests\Encoder\SomeChildUser');
        $expectedEncoder = new MessageDigestPasswordEncoder('sha1');
        $this->assertEquals($expectedEncoder->encodePassword('foo', ''), $encoder->encodePassword('foo', ''));
    }
    ...
    {
        $factory = new EncoderFactory(array(
            'Symphony\Component\Security\Core\User\User' => new MessageDigestPasswordEncoder('sha1'),
        ));
    ...
    {
        $factory = new EncoderFactory(array(
            'Symphony\Component\Security\Core\Tests\Encoder\SomeUser' => new MessageDigestPasswordEncoder('sha1'),
        ));
    ...
    {
        $factory = new EncoderFactory(array(
            'Symphony\Component\Security\Core\Tests\Encoder\EncAwareUser' => new MessageDigestPasswordEncoder('sha256'),
    ...
    {
        $factory = new EncoderFactory(array(
            'Symphony\Component\Security\Core\Tests\Encoder\EncAwareUser' => new MessageDigestPasswordEncoder('sha1'),
    ...
    public function testGetEncoderForEncoderAwareWithClassName()
    {
        ...
        $encoder = $factory->getEncoder('Symphony\Component\Security\Core\Tests\Encoder\EncAwareUser');
        $expectedEncoder = new MessageDigestPasswordEncoder('sha1');
        $this->assertEquals($expectedEncoder->encodePassword('foo', ''), $encoder->encodePassword('foo', ''));
    }
}
