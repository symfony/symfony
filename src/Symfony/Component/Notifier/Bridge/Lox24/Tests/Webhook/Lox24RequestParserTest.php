...
class Lox24RequestParserTest extends TestCase
{
    ...
    public function testInvalidNotificationName(): void
    {
    ...
    public function testMissingMsgId(): void
    {
        $this->expectException(RejectWebhookException::class);
    ...
    public function testMissingMsgStatusCode(): void
    {
        $this->expectException(RejectWebhookException::class);
        $this->expectExceptionMessage('Payload is malformed.');
    ...
    public function testStatusCode100(): void
    {
        $payload = [
            'name' => 'sms.delivery',
            'data' => [
    ...
    public function testStatusCode0(): void
    {
    ...
    public function testStatusCodeUnknown(): void
    {
        $payload = [
            'name' => 'sms.delivery',
            'data' => [
