...
namespace Symphony\Component\Finder\Tests;
...
class FinderTest extends Iterator\RealIteratorTestCase
{
    ...
    {
        $this->assertInstanceOf('Symphony\Component\Finder\Finder', Finder::create());
    }
    ...
    {
        $this->assertInstanceOf('Symphony\\Component\\Finder\\Finder', Finder::create()->append(array()));
    }
    ...
    public function testAccessDeniedException()
    {
        ...
        if (false === $couldRead = is_readable($testDir)) {
            try {
                ...
                $expectedExceptionClass = 'Symphony\\Component\\Finder\\Exception\\AccessDeniedException';
