...
use Symphony\Component\Validator\Exception\GroupDefinitionException;
...
class ClassMetadata extends GenericMetadata implements ClassMetadataInterface
{
    ...
    public function setGroupSequenceProvider($active)
    {
        ...
        if (!$this->getReflectionClass()->implementsInterface('Symphony\Component\Validator\GroupSequenceProviderInterface')) {
