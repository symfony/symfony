...
class SwitchUserTest extends WebTestCase
{
    ...
    public function testSwitchUser($originalUser, $targetUser, $expectedUser, $expectedStatus)
    {
        ...
        $this->assertEquals($expectedUser, $client->getProfile()->get('security')->getUser());
    }
    ...
    public function testSwitchedUserCannotSwitchToOther()
    {
        ...
        $this->assertEquals('user_cannot_switch_1', $client->getProfile()->get('security')->getUser());
    }
    ...
    public function testSwitchedUserExit()
    {
        ...
        $this->assertEquals('user_can_switch', $client->getProfile()->get('security')->getUser());
    }
