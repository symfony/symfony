...
namespace Symphony\Bridge\Twig\Tests\Translation;

use PHPUnit\Framework\TestCase;
use Symphony\Bridge\Twig\Extension\TranslationExtension;
use Symphony\Bridge\Twig\Translation\TwigExtractor;
...
class TwigExtractorTest extends TestCase
{
    ...
    public function testExtract($template, $messages)
    {
        ...
        $twig->addExtension(new TranslationExtension($this->getMockBuilder('Symphony\Component\Translation\TranslatorInterface')->getMock()));
