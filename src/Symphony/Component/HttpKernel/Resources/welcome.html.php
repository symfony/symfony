...
<div id="wrapper">
    <div id="container">
        <div id="welcome">
            <h1><span>Welcome to</span> Symphony <?php echo $version; ?></h1>
        </div>
        ...
        <div id="next">
            ...
            <p>
                ...
                <a href="https://symphony.com/doc/<?php echo $docVersion; ?>/page_creation.html">
                    How to create your first page in Symphony
                </a>
            </p>
        </div>
    </div>
