        ...
        foreach ($constructor->getParameters() as $index => $parameter) {
            ...
            try {
                ...
                if (!$parameter->isDefaultValueAvailable()) {
                    throw new RuntimeException(sprintf('Cannot autowire argument %s for %s because the type-hinted class does not exist (%s).', $index + 1, $definition->getClass(), $reflectionException->getMessage()));
                }
