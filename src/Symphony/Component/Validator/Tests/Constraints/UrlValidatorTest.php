...
use Symphony\Component\Validator\Constraints\Url;
use Symphony\Component\Validator\Constraints\UrlValidator;
...
class UrlValidatorTest extends ConstraintValidatorTestCase
{
    ...
    public function getValidRelativeUrls()
    {
        return array(
            array('//google.com'),
            array('//symphony.fake/blog/'),
            array('//symphony.com/search?type=&q=url+validator'),
        );
    }
    ...
    public function getValidUrls()
    {
        return array(
            ...
            array('http://www.symphony.com/'),
            array('http://symphony.fake/blog/'),
            array('http://symphony.com/?'),
            array('http://symphony.com/search?type=&q=url+validator'),
            array('http://symphony.com/#'),
            array('http://symphony.com/#?'),
            array('http://www.symphony.com/doc/current/book/validation.html#supported-constraints'),
            ...
            array('http://☎.com/'),
            array('http://username:password@symphony.com'),
            array('http://user.name:password@symphony.com'),
            array('http://username:pass.word@symphony.com'),
            array('http://user.name:pass.word@symphony.com'),
            array('http://user-name@symphony.com'),
            array('http://symphony.com?'),
            array('http://symphony.com?query=1'),
            array('http://symphony.com/?query=1'),
            array('http://symphony.com#'),
            array('http://symphony.com#fragment'),
            array('http://symphony.com/#fragment'),
            array('http://symphony.com/#one_more%20test'),
        );
    }
    ...
    public function getInvalidRelativeUrls()
    {
        return array(
            ...
            array('//[::1'),
            array('//hello.☎/'),
            array('//:password@symphony.com'),
            array('//:password@@symphony.com'),
            array('//username:passwordsymphony.com'),
            array('//usern@me:password@symphony.com'),
    ...
    public function getInvalidUrls()
    {
        return array(
            ...
            array('http://[::1'),
            array('http://hello.☎/'),
            array('http://:password@symphony.com'),
            array('http://:password@@symphony.com'),
            array('http://username:passwordsymphony.com'),
            array('http://usern@me:password@symphony.com'),
     ...
     * @group legacy
     * @expectedDeprecation The "checkDNS" option in "Symphony\Component\Validator\Constraints\Url" is deprecated since Symphony 4.1. Its false-positive rate is too high to be relied upon.
     */
    ...
    /**
     * @expectedException \Symphony\Component\Validator\Exception\InvalidOptionsException
     * @requires function Symphony\Bridge\PhpUnit\DnsMock::withMockedHosts
     * @group legacy
     * @expectedDeprecation The "checkDNS" option in "Symphony\Component\Validator\Constraints\Url" is deprecated since Symphony 4.1. Its false-positive rate is too high to be relied upon.
     * @expectedDeprecation The "dnsMessage" option in "Symphony\Component\Validator\Constraints\Url" is deprecated since Symphony 4.1.
     */
