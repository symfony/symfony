...
use Symphony\Component\DependencyInjection\Exception\EnvNotFoundException;
...
class EnvVarProcessor implements EnvVarProcessorInterface
{
    ...
    private static function phpize($value)
    {
        if (!class_exists(XmlUtils::class)) {
            throw new RuntimeException('The Symphony Config component is required to cast env vars to "bool", "int" or "float".');
        }
