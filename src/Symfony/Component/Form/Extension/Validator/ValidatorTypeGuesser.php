...
class ValidatorTypeGuesser implements FormTypeGuesserInterface
{
        ...
        switch (\get_class($constraint)) {
            case 'Symfony\Component\Validator\Constraints\Type':
                switch ($constraint->type) {
                    ...
                    case 'boolean':
                    case 'bool':
                        return new TypeGuess('Symfony\Component\Form\Extension\Core\Type\CheckboxType', [], AbstractGuess::MEDIUM_CONFIDENCE);
                    ...
                    case \DateTime::class:
                    case '\DateTime':
                        return new TypeGuess('Symfony\Component\Form\Extension\Core\Type\DateType', [], AbstractGuess::MEDIUM_CONFIDENCE);
            ...
            case 'Symfony\Component\Validator\Constraints\Country':
                return new TypeGuess('Symfony\Component\Form\Extension\Core\Type\CountryType', [], AbstractGuess::HIGH_CONFIDENCE);

            case 'Symfony\Component\Validator\Constraints\Currency':
                return new TypeGuess('Symfony\Component\Form\Extension\Core\Type\CurrencyType', [], AbstractGuess::HIGH_CONFIDENCE);

            case 'Symfony\Component\Validator\Constraints\Date':
                return new TypeGuess('Symfony\Component\Form\Extension\Core\Type\DateType', ['input' => 'string'], AbstractGuess::HIGH_CONFIDENCE);

            case 'Symfony\Component\Validator\Constraints\DateTime':
                return new TypeGuess('Symfony\Component\Form\Extension\Core\Type\DateTimeType', ['input' => 'string'], AbstractGuess::HIGH_CONFIDENCE);

            case 'Symfony\Component\Validator\Constraints\Email':
                return new TypeGuess('Symfony\Component\Form\Extension\Core\Type\EmailType', [], AbstractGuess::HIGH_CONFIDENCE);
            ...
            case 'Symfony\Component\Validator\Constraints\Image':
                ...
                return new TypeGuess('Symfony\Component\Form\Extension\Core\Type\FileType', $options, AbstractGuess::HIGH_CONFIDENCE);

            case 'Symfony\Component\Validator\Constraints\Language':
                return new TypeGuess('Symfony\Component\Form\Extension\Core\Type\LanguageType', [], AbstractGuess::HIGH_CONFIDENCE);

            case 'Symfony\Component\Validator\Constraints\Locale':
                return new TypeGuess('Symfony\Component\Form\Extension\Core\Type\LocaleType', [], AbstractGuess::HIGH_CONFIDENCE);

            case 'Symfony\Component\Validator\Constraints\Time':
                return new TypeGuess('Symfony\Component\Form\Extension\Core\Type\TimeType', ['input' => 'string'], AbstractGuess::HIGH_CONFIDENCE);

            case 'Symfony\Component\Validator\Constraints\Url':
                return new TypeGuess('Symfony\Component\Form\Extension\Core\Type\UrlType', [], AbstractGuess::HIGH_CONFIDENCE);
            ...
            case 'Symfony\Component\Validator\Constraints\Range':
                return new TypeGuess('Symfony\Component\Form\Extension\Core\Type\NumberType', [], AbstractGuess::LOW_CONFIDENCE);

            case 'Symfony\Component\Validator\Constraints\Count':
                return new TypeGuess('Symfony\Component\Form\Extension\Core\Type\CollectionType', [], AbstractGuess::LOW_CONFIDENCE);
        ...
        switch (\get_class($constraint)) {
            case 'Symfony\Component\Validator\Constraints\Length':
                if (is_numeric($constraint->max)) {
                    return new ValueGuess($constraint->max, AbstractGuess::HIGH_CONFIDENCE);
                }
                break;
            ...
            case 'Symfony\Component\Validator\Constraints\Range':
                if (is_numeric($constraint->max)) {
                    return new ValueGuess(\strlen((string) $constraint->max), AbstractGuess::LOW_CONFIDENCE);
                }
                break;
        }
        ...
        switch (\get_class($constraint)) {
            case 'Symfony\Component\Validator\Constraints\Length':
                if (is_numeric($constraint->min)) {
                    return new ValueGuess(sprintf('.{%s,}', (string) $constraint->min), AbstractGuess::LOW_CONFIDENCE);
                }
                break;
            ...
            case 'Symfony\Component\Validator\Constraints\Regex':
                ...
                if (null !== $htmlPattern) {
                    return new ValueGuess($htmlPattern, AbstractGuess::HIGH_CONFIDENCE);
                }
                break;

            case 'Symfony\Component\Validator\Constraints\Range':
                if (is_numeric($constraint->min)) {
                    return new ValueGuess(sprintf('.{%s,}', \strlen((string) $constraint->min)), AbstractGuess::LOW_CONFIDENCE);
                }
                break;
     ...
     *                               can be guessed
     *
     * @return AbstractGuess|null The guessed value with the highest confidence
     */
    protected function guess(string $class, string $property, \Closure $closure, $defaultValue = null)
    {
        ...
        if (null !== $defaultValue) {
            $guesses[] = new ValueGuess($defaultValue, AbstractGuess::LOW_CONFIDENCE);
        }
