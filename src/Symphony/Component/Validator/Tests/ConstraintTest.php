...
use Symphony\Component\Validator\Tests\Fixtures\ConstraintC;
use Symphony\Component\Validator\Tests\Fixtures\ConstraintWithValue;
use Symphony\Component\Validator\Tests\Fixtures\ConstraintWithValueAsDefault;
...
class ConstraintTest extends TestCase
{
    ...
    {
        $this->{method_exists($this, $_ = 'expectException') ? $_ : 'setExpectedException'}('Symphony\Component\Validator\Exception\InvalidOptionsException');
    ...
    {
        $this->{method_exists($this, $_ = 'expectException') ? $_ : 'setExpectedException'}('Symphony\Component\Validator\Exception\MissingOptionsException');
    ...
    /**
     * @expectedException \Symphony\Component\Validator\Exception\InvalidArgumentException
     */
