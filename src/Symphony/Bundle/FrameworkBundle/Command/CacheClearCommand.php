...
use Symphony\Component\HttpKernel\RebootableInterface;
...
EOF
    ...
    private function warmup(string $warmupDir, string $realCacheDir, bool $enableOptionalWarmers = true)
    {
        ...
        if (!$kernel instanceof RebootableInterface) {
            throw new \LogicException('Calling "cache:clear" with a kernel that does not implement "Symphony\Component\HttpKernel\RebootableInterface" is not supported.');
        }
