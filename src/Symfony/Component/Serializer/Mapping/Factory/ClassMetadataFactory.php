...
class ClassMetadataFactory implements ClassMetadataFactoryInterface
{
    ...
    public function __construct(LoaderInterface $loader, Cache $cache = null)
    {
        ...
        if (null !== $cache) {
            @trigger_error(sprintf('Passing a Doctrine Cache instance as 2nd parameter of the "%s" constructor is deprecated since Symfony 3.1. This parameter will be removed in Symfony 4.0. Use the "%s" class instead.', self::class, CacheClassMetadataFactory::class), E_USER_DEPRECATED);
        }
    }
