...
use Symphony\Component\HttpFoundation\File\MimeType\MimeTypeGuesser;
use Symphony\Component\HttpFoundation\File\MimeType\MimeTypeGuesserInterface;
use Symphony\Component\Serializer\Exception\InvalidArgumentException;
use Symphony\Component\Serializer\Exception\NotNormalizableValueException;
...
class DataUriNormalizer implements NormalizerInterface, DenormalizerInterface
{
    ...
    {
        if (null === $mimeTypeGuesser && class_exists('Symphony\Component\HttpFoundation\File\MimeType\MimeTypeGuesser')) {
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        try {
            switch ($class) {
                case 'Symphony\Component\HttpFoundation\File\File':
        ...
        throw new InvalidArgumentException(sprintf('The class parameter "%s" is not supported. It must be one of "SplFileInfo", "SplFileObject" or "Symphony\Component\HttpFoundation\File\File".', $class));
    }
