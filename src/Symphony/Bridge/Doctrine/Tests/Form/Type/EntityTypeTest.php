...
namespace Symphony\Bridge\Doctrine\Tests\Form\Type;
...
use Symphony\Bridge\Doctrine\Form\DoctrineOrmExtension;
use Symphony\Bridge\Doctrine\Form\DoctrineOrmTypeGuesser;
use Symphony\Bridge\Doctrine\Form\Type\EntityType;
use Symphony\Bridge\Doctrine\Test\DoctrineTestHelper;
use Symphony\Bridge\Doctrine\Tests\Fixtures\CompositeIntIdEntity;
use Symphony\Bridge\Doctrine\Tests\Fixtures\CompositeStringIdEntity;
use Symphony\Bridge\Doctrine\Tests\Fixtures\GroupableEntity;
use Symphony\Bridge\Doctrine\Tests\Fixtures\SingleIntIdEntity;
use Symphony\Bridge\Doctrine\Tests\Fixtures\SingleStringCastableIdEntity;
use Symphony\Bridge\Doctrine\Tests\Fixtures\SingleStringIdEntity;
use Symphony\Component\Form\ChoiceList\View\ChoiceGroupView;
use Symphony\Component\Form\ChoiceList\View\ChoiceView;
use Symphony\Component\Form\Forms;
use Symphony\Component\Form\Tests\Extension\Core\Type\BaseTypeTest;
use Symphony\Component\Form\Tests\Extension\Core\Type\FormTypeTest;
use Symphony\Bridge\Doctrine\Tests\Fixtures\SingleAssociationToIntIdEntity;
use Symphony\Bridge\Doctrine\Tests\Fixtures\SingleIntIdNoToStringEntity;

class EntityTypeTest extends BaseTypeTest
{
    const TESTED_TYPE = 'Symphony\Bridge\Doctrine\Form\Type\EntityType';

    const ITEM_GROUP_CLASS = 'Symphony\Bridge\Doctrine\Tests\Fixtures\GroupableEntity';
    const SINGLE_IDENT_CLASS = 'Symphony\Bridge\Doctrine\Tests\Fixtures\SingleIntIdEntity';
    const SINGLE_IDENT_NO_TO_STRING_CLASS = 'Symphony\Bridge\Doctrine\Tests\Fixtures\SingleIntIdNoToStringEntity';
    const SINGLE_STRING_IDENT_CLASS = 'Symphony\Bridge\Doctrine\Tests\Fixtures\SingleStringIdEntity';
    const SINGLE_ASSOC_IDENT_CLASS = 'Symphony\Bridge\Doctrine\Tests\Fixtures\SingleAssociationToIntIdEntity';
    const SINGLE_STRING_CASTABLE_IDENT_CLASS = 'Symphony\Bridge\Doctrine\Tests\Fixtures\SingleStringCastableIdEntity';
    const COMPOSITE_IDENT_CLASS = 'Symphony\Bridge\Doctrine\Tests\Fixtures\CompositeIntIdEntity';
    const COMPOSITE_STRING_IDENT_CLASS = 'Symphony\Bridge\Doctrine\Tests\Fixtures\CompositeStringIdEntity';
    ...
    /**
     * @expectedException \Symphony\Component\OptionsResolver\Exception\MissingOptionsException
     */
    ...
    /**
     * @expectedException \Symphony\Component\Form\Exception\RuntimeException
     */
    ...
    public function testChoicesForValuesOptimization()
    {
        ...
        $managedEntitiesNames = array_map('strval', $unitOfWorkIdentityMap['Symphony\Bridge\Doctrine\Tests\Fixtures\SingleIntIdEntity']);
    ...
    public function testLoaderCaching()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\Form\ChoiceList\Loader\ChoiceLoaderInterface', $choiceLoader1);
