...
class DefaultChoiceListFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return $this->obj2 === $object || $this->obj3 === $object || $this->obj5 === $object;
    }
    ...
    public function testCreateViewFlatPreferredChoices()
    {
        $view = $this->factory->createView(
            $this->list,
            array($this->obj2, $this->obj3, $this->obj5)
        );
    ...
    public function testCreateViewFlatPreferredChoicesAsClosure()
    {
        ...
        $view = $this->factory->createView(
            $this->list,
            function ($object) use ($obj2, $obj3, $obj5) {
                return $obj2 === $object || $obj3 === $object || $obj5 === $object;
            }
        );
    ...
    public function testCreateViewFlatGroupByAsClosure()
    {
        ...
        $view = $this->factory->createView(
            ...
            null, // label
            null, // index
            function ($object) use ($obj1, $obj2, $obj3, $obj4) {
                return $obj1 === $object || $obj2 === $object ? 'Group 1' : ($obj3 === $object || $obj4 === $object ? 'Group 2' : 'Group 3');
            }
        );
    ...
    public function testCreateViewFlatGroupByClosureReceivesKey()
    {
        $view = $this->factory->createView(
            ...
            null, // index
            function ($object, $key) {
                return 'A' === $key || 'B' === $key ? 'Group 1' : ('C' === $key || 'D' === $key ? 'Group 2' : 'Group 3');
            }
        );
    ...
    public function testCreateViewFlatGroupByClosureReceivesValue()
    {
        $view = $this->factory->createView(
            ...
            null, // index
            function ($object, $key, $value) {
                return '0' === $value || '1' === $value ? 'Group 1' : ('2' === $value || '3' === $value ? 'Group 2' : 'Group 3');
            }
        );
        ...
        $view = $this->factory->createView(
            ...
            function ($object, $key) {
                switch ($key) {
                    ...
                    case 'E': return array('attr1' => 'value1');
        ...
        $view = $this->factory->createView(
            ...
            function ($object, $key, $value) {
                switch ($value) {
                    ...
                    case '4': return array('attr1' => 'value1');
                    default: return array();
                }
            }
        );
