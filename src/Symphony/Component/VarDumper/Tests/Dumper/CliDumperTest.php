...
%A  options: []
  ...
  "obj" => Symphony\Component\VarDumper\Tests\Fixture\DumbFoo {#%d
    +foo: "foo"
    +"bar": "bar"
  }
  "closure" => Closure {#%d
    class: "Symphony\Component\VarDumper\Tests\Dumper\CliDumperTest"
    this: Symphony\Component\VarDumper\Tests\Dumper\CliDumperTest {#%d …}
    parameters: {
      \$a: {}
      &\$b: {
        typeHint: "PDO"
  ...
  8 => &1 null
  "sobj" => Symphony\Component\VarDumper\Tests\Fixture\DumbFoo {#%d}
  "snobj" => &3 {#%d}
  "snobj2" => {#%d}
  "file" => "{$var['file']}"
  b"bin-key-é" => ""
...
EOTXT
    ...
    public function testThrowingCaster()
    {
        ...
        $this->assertStringMatchesFormat(
            <<<EOTXT
stream resource {@{$ref}
  ⚠: Symphony\Component\VarDumper\Exception\ThrowingCasterException {#%d
