...
class DateTimeImmutableToStringTransformerTest extends DateTimeImmutableTestCase
{
    ...
    {
        $transformer = new DateTimeImmutableToStringTransformer('UTC', 'UTC', $format);
    ...
    {
        $transformer = new DateTimeImmutableToStringTransformer();
    ...
    {
        $transformer = new DateTimeImmutableToStringTransformer('Asia/Hong_Kong', 'America/New_York', 'Y-m-d H:i:s');
    ...
    {
        $reverseTransformer = new DateTimeImmutableToStringTransformer('UTC', 'UTC', $format);
    ...
    {
        $reverseTransformer = new DateTimeImmutableToStringTransformer();
    ...
    {
        $reverseTransformer = new DateTimeImmutableToStringTransformer('America/New_York', 'Asia/Hong_Kong', 'Y-m-d H:i:s');
