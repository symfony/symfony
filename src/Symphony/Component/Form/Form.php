...
use Symphony\Component\Form\Exception\AlreadySubmittedException;
use Symphony\Component\Form\Exception\TransformationFailedException;
use Symphony\Component\Form\Exception\LogicException;
use Symphony\Component\Form\Exception\OutOfBoundsException;
use Symphony\Component\Form\Util\FormUtil;
use Symphony\Component\Form\Util\InheritDataAwareIterator;
use Symphony\Component\Form\Util\OrderedHashMap;
    ...
    public function add($child, $type = null, array $options = array())
    {
        ...
        if (!$child instanceof FormInterface) {
            if (!is_string($child) && !is_int($child)) {
                throw new UnexpectedTypeException($child, 'string, integer or Symphony\Component\Form\FormInterface');
            }
