...
use Symphony\Bridge\Twig\Node\FormThemeNode;
use Symphony\Bridge\Twig\Tests\Extension\RuntimeLoaderProvider;
use Symphony\Component\Form\FormRenderer;
use Symphony\Component\Form\FormRendererEngineInterface;
use Twig\Compiler;
...
class FormThemeTest extends TestCase
{
    ...
    public function testCompile()
    {
        ...
        $this->assertEquals(
            sprintf(
                '$this->env->getRuntime("Symphony\\\\Component\\\\Form\\\\FormRenderer")->setTheme(%s, array(0 => "tpl1", 1 => "tpl2"), true);',
        ...
        $this->assertEquals(
            sprintf(
                '$this->env->getRuntime("Symphony\\\\Component\\\\Form\\\\FormRenderer")->setTheme(%s, array(0 => "tpl1", 1 => "tpl2"), false);',
                $this->getVariableGetter('form')
             ),
            trim($compiler->compile($node)->getSource())
        );
        ...
        $this->assertEquals(
            sprintf(
                '$this->env->getRuntime("Symphony\\\\Component\\\\Form\\\\FormRenderer")->setTheme(%s, "tpl1", true);',
                $this->getVariableGetter('form')
             ),
            trim($compiler->compile($node)->getSource())
        );
        ...
        $this->assertEquals(
            sprintf(
                '$this->env->getRuntime("Symphony\\\\Component\\\\Form\\\\FormRenderer")->setTheme(%s, "tpl1", false);',
                $this->getVariableGetter('form')
             ),
            trim($compiler->compile($node)->getSource())
        );
