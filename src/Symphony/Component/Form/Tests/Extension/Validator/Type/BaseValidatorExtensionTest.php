...
use Symphony\Component\Form\Test\FormInterface;
...
abstract class BaseValidatorExtensionTest extends TypeTestCase
{
    ...
    public function testValidationGroupsCanBeSetToGroupSequence()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\Validator\Constraints\GroupSequence', $form->getConfig()->getOption('validation_groups'));
    }
