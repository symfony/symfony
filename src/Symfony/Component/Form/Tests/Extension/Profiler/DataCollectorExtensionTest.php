...
use Symfony\Component\Form\Extension\Profiler\DataCollectorExtension;
...
class DataCollectorExtensionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testLoadTypeExtensions()
    {
        ...
        $this->assertInstanceOf('Symfony\Component\Form\Extension\Profiler\Type\DataCollectorTypeExtension', array_shift($typeExtensions));
    }
}
