...
class RequestTest extends TestCase
{
    ...
    public function testCreate()
    {
        ...
        // assume rewrite rule: (.*) --> app/app.php; app/ is a symlink to a symphony web/ directory
    ...
    /**
     * @group legacy
     * @expectedDeprecation Calling "Symphony\Component\HttpFoundation\Request::getSession()" when no session has been set is deprecated since Symphony 4.1 and will throw an exception in 5.0. Use "hasSession()" instead.
     */
    ...
    {
        $class = new \ReflectionClass('Symphony\\Component\\HttpFoundation\\Request');
