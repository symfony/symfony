...
use Symphony\Component\Form\Extension\DataCollector\FormDataExtractor;
...
class FormDataExtractorTest extends TestCase
{
    ...
    public function testExtractConfigurationBuildsIdRecursively()
    {
        ...
        $grandParent = $this->createBuilder('grandParent')
            ->setCompound(true)
            ->setDataMapper($this->getMockBuilder('Symphony\Component\Form\DataMapperInterface')->getMock())
            ->getForm();
...
array:3 [
  ...
  "errors" => array:1 [
    0 => array:3 [
      ...
      "origin" => "$origin"
      "trace" => array:2 [
        0 => Symphony\Component\Validator\ConstraintViolation {
          -message: "Foo"
          -messageTemplate: "Foo"
          -parameters: []
          -plural: null
