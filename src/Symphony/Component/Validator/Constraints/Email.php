...
class Email extends Constraint
{
    ...
    /**
     * @deprecated since Symphony 4.1. Set mode to "strict" instead.
     */
    public $strict;
    public $mode;
    ...
    public function __construct($options = null)
    {
        if (is_array($options) && array_key_exists('strict', $options)) {
            @trigger_error(sprintf('The "strict" property is deprecated since Symphony 4.1. Use "mode"=>"%s" instead.', self::VALIDATION_MODE_STRICT), E_USER_DEPRECATED);
        }
