 ...
 * bug #53891 [PropertyAccess] Fixes getValue() on an uninitialized object property on a lazy ghost (priyadi)
 ...
 * bug #53890 [VarExporter] Uniform uninitialized property error message under ghost and non-ghost objects (priyadi)
 ...
 * bug #53634 [Notifier][Smsapi] Set messageId of SentMessage (tomasz-kusy)
 ...
 * bug #52713 [Serializer] Fix deserialization_path missing using constructor (mtarld)
 ...
 * feature #51849 [AssetMapper] Warn of missing or incompatible dependencies (weaverryan)
 ...
 * feature #50877 [Finder] Add early directory pruning filter support (mvorisek)
