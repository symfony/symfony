...
class TranslationExtractCommand extends Command
{
    ...
    {
        // the formats are the dumpers the writer holds, which only the default implementation exposes
        return $this->writer instanceof TranslationWriter ? $this->writer->getFormats() : [];
    }

    private function getKernel(): KernelInterface
    {
        return $this->kernel instanceof \Closure ? ($this->kernel)() : $this->kernel;
    }
}
