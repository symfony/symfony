...
class Symfony_Component_Serializer_Tests_Fixtures_CustomNormalizer_FullTypeHints_ComplexTypesPublicProperties implements NormalizerInterface, DenormalizerInterface, NormalizerAwareInterface, DenormalizerAwareInterface
{
    ...
    */
    ...
    {
        return ['simple' => $this->normalizeChild($object->simple, $format, $context, false), 'array' => $this->normalizeChild($object->array, $format, $context, true), 'union' => $this->normalizeChild($object->union, $format, $context, false), 'nested' => $this->normalizeChild($object->nested, $format, $context, false), 'unionArray' => $this->normalizeChild($object->unionArray, $format, $context, true)];
    }
