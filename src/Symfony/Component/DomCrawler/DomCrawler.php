...
{
    public const CRAWLER_DISABLE_DEFAULT_NAMESPACE = 1;
    ...
    {
        return \DOM\HTMLDocument::createFromString($htmlContent, $this->options & self::CRAWLER_DISABLE_DEFAULT_NAMESPACE ? \DOM\HTML_NO_DEFAULT_NS : 0, $charset);
    }
    ...
    {
        $crawler = new static($nodes, $this->uri, $this->baseHref, $this->options);
