    ...
    public function resolve(Request $request, ArgumentMetadata $argument): iterable
    {
        ...
        if ($attribute instanceof MapRequestPayload) {
            if ('array' === $argument->getType()) {
                if (!$attribute->type) {
                    throw new NearMissValueResolverException('Please set the $type argument of the #[MapRequestPayload] attribute to the type of the objects in the expected array.');
                }
            } elseif ($attribute->type) {
                throw new NearMissValueResolverException('Please set its type to "array" when using argument $type of #[MapRequestPayload].');
            }
        }
