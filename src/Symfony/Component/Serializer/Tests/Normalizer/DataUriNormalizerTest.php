...
{
    public const TEST_GIF_DATA = 'data:image/gif;base64,R0lGODdhAQABAIAAAP///////ywAAAAAAQABAAACAkQBADs=';
    public const TEST_TXT_DATA = 'data:text/plain,K%C3%A9vin%20Dunglas%0A';
    public const TEST_TXT_CONTENT = "Kévin Dunglas\n";
