...
class ServiceLocatorTest extends TestCase
{
     ...
     * @expectedExceptionMessage Service "dummy" not found: the container inside "Symphony\Component\DependencyInjection\Tests\ServiceLocatorTest" is a smaller service locator that only knows about the "foo" and "bar" services.
     */
