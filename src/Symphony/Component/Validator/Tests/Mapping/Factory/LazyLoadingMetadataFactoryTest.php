...
{
    const CLASS_NAME = 'Symphony\Component\Validator\Tests\Fixtures\Entity';
    const PARENT_CLASS = 'Symphony\Component\Validator\Tests\Fixtures\EntityParent';
    const INTERFACE_A_CLASS = 'Symphony\Component\Validator\Tests\Fixtures\EntityInterfaceA';
    const INTERFACE_B_CLASS = 'Symphony\Component\Validator\Tests\Fixtures\EntityInterfaceB';
    const PARENT_INTERFACE_CLASS = 'Symphony\Component\Validator\Tests\Fixtures\EntityParentInterface';
    ...
    {
        $cache = $this->getMockBuilder('Symphony\Component\Validator\Mapping\Cache\CacheInterface')->getMock();
    ...
    {
        $loader = $this->getMockBuilder('Symphony\Component\Validator\Mapping\Loader\LoaderInterface')->getMock();
        $cache = $this->getMockBuilder('Symphony\Component\Validator\Mapping\Cache\CacheInterface')->getMock();
    ...
    {
        $reader = new \Symphony\Component\Validator\Mapping\Loader\StaticMethodLoader();
        $factory = new LazyLoadingMetadataFactory($reader);
        $metadata = $factory->getMetadataFor('Symphony\Component\Validator\Tests\Fixtures\EntityStaticCarTurbo');
        $groups = array();
