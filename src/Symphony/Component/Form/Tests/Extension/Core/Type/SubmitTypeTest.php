...
{
    const TESTED_TYPE = 'Symphony\Component\Form\Extension\Core\Type\SubmitType';

    public function testCreateSubmitButtonInstances()
    {
        $this->assertInstanceOf('Symphony\Component\Form\SubmitButton', $this->factory->create(static::TESTED_TYPE));
    }
