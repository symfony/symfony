...
class InputOptionTest extends TestCase
{
    ...
    public static function provideInvalidModes(): iterable
    {
        yield 'negative mode' => [-1, 'Option mode "-1" is not valid.'];
        yield 'out of range mode' => [InputOption::HIDDEN << 1, \sprintf('Option mode "%d" is not valid.', InputOption::VALUE_NONE | InputOption::HIDDEN << 1)];
    }
