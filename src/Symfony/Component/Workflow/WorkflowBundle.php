...
class WorkflowBundle extends AbstractBundle
{
    ...
    public function build(ContainerBuilder $container): void
    {
        ...
        $container->registerAttributeForAutoconfiguration(AsWorkflowDefinition::class, static function (ChildDefinition $definition) {
            $definition->addResourceTag(WorkflowDefinitionPass::TAG);
        });
        $container->addCompilerPass(new WorkflowDefinitionPass(), PassConfig::TYPE_BEFORE_OPTIMIZATION, 10);
    ...
    public function loadExtension(array $config, ContainerConfigurator $configurator, ContainerBuilder $container): void
    {
        ...
        foreach ($config['workflows'] as $name => $workflow) {
            $registrar->register($container, WorkflowConfig::fromArray($name, $workflow));
        }
    }
}
