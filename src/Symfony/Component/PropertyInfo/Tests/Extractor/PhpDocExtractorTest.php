...
class PhpDocExtractorTest extends TestCase
{
    ...
    {
        $this->assertNull($this->extractor->getType(InvalidDummy::class, 'foo'));
        $this->assertSame('Foo.', $this->extractor->getShortDescription(InvalidDummy::class, 'foo'));
        $this->assertNull($this->extractor->getLongDescription(InvalidDummy::class, 'foo'));
    }
