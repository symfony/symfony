...
namespace Symphony\Component\Form\Tests\ChoiceList\Factory;
...
class CachingFactoryDecoratorTest extends TestCase
{
    ...
    {
        $this->decoratedFactory = $this->getMockBuilder('Symphony\Component\Form\ChoiceList\Factory\ChoiceListFactoryInterface')->getMock();
    ...
    {
        $loader = $this->getMockBuilder('Symphony\Component\Form\ChoiceList\Loader\ChoiceLoaderInterface')->getMock();
        $list = new \stdClass();
    ...
    {
        $loader1 = $this->getMockBuilder('Symphony\Component\Form\ChoiceList\Loader\ChoiceLoaderInterface')->getMock();
        $loader2 = $this->getMockBuilder('Symphony\Component\Form\ChoiceList\Loader\ChoiceLoaderInterface')->getMock();
        $list1 = new \stdClass();
        $list2 = new \stdClass();
    ...
    {
        $preferred = array('a');
        $list = $this->getMockBuilder('Symphony\Component\Form\ChoiceList\ChoiceListInterface')->getMock();
        $view = new \stdClass();
    ...
    public function provideSameChoices()
    {
        ...
        return array(
            array(0, 0),
            array('a', 'a'),
            // https://github.com/symphony/symphony/issues/10409
