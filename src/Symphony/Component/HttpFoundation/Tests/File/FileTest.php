...
class FileTest extends TestCase
{
    ...
    public function testMove()
    {
        ...
        $this->assertInstanceOf('Symphony\Component\HttpFoundation\File\File', $movedFile);
    ...
    {
        $guesser = $this->getMockBuilder('Symphony\Component\HttpFoundation\File\MimeType\MimeTypeGuesserInterface')->getMock();
        $guesser
            ->expects($this->once())
            ->method('guess')
