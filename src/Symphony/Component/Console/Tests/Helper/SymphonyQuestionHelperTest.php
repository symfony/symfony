...
namespace Symphony\Component\Console\Tests\Helper;

use Symphony\Component\Console\Helper\FormatterHelper;
use Symphony\Component\Console\Helper\HelperSet;
use Symphony\Component\Console\Helper\SymphonyQuestionHelper;
 ...
 * @group tty
 */
class SymphonyQuestionHelperTest extends AbstractQuestionHelperTest
{
    public function testAskChoice()
    {
        $questionHelper = new SymphonyQuestionHelper();
    ...
    {
        $helper = new SymphonyQuestionHelper();
        $input = $this->createStreamableInputInterfaceMock($this->getInputStream('\\'));
    ...
    /**
     * @expectedException        \Symphony\Component\Console\Exception\RuntimeException
     * @expectedExceptionMessage Aborted
     */
    public function testAskThrowsExceptionOnMissingInput()
    {
        $dialog = new SymphonyQuestionHelper();
    ...
    {
        $mock = $this->getMockBuilder('Symphony\Component\Console\Input\InputInterface')->getMock();
