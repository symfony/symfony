...
class PackagesTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $packages = new Packages(new Package('default'), array('a' => new Package('a')));

        $this->assertEquals('default', $packages->getVersion());
        $this->assertEquals('a', $packages->getVersion('a'));
    }
    ...
    public function testGetUrl()
    {
        ...
        $this->assertEquals('/foo?v1', $packages->getUrl('/foo', null, 'v1'));
    }
