...
use Symphony\Component\Security\Core\Authorization\AuthorizationChecker;
...
class AuthorizationCheckerTest extends TestCase
{
    ...
    {
        $this->authenticationManager = $this->getMockBuilder('Symphony\Component\Security\Core\Authentication\AuthenticationManagerInterface')->getMock();
    ...
    public function testVoteAuthenticatesTokenIfNecessary()
    {
        ...
        $newToken = $this->getMockBuilder('Symphony\Component\Security\Core\Authentication\Token\TokenInterface')->getMock();
