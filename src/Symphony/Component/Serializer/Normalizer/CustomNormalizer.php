...
use Symphony\Component\Serializer\SerializerAwareInterface;
use Symphony\Component\Serializer\SerializerAwareTrait;
...
class CustomNormalizer implements NormalizerInterface, DenormalizerInterface, SerializerAwareInterface
{
    ...
    public function supportsDenormalization($data, $type, $format = null)
    {
        ...
        return $this->cache[$type] = is_subclass_of($type, 'Symphony\Component\Serializer\Normalizer\DenormalizableInterface');
    }
}
