...
namespace Symphony\Bridge\Doctrine\Tests\Logger;

use PHPUnit\Framework\TestCase;
use Symphony\Bridge\Doctrine\Logger\DbalLogger;
...
class DbalLoggerTest extends TestCase
{
    ...
    public function testLog($sql, $params, $logParams)
    {
        ...
        $dbalLogger = $this
            ->getMockBuilder('Symphony\\Bridge\\Doctrine\\Logger\\DbalLogger')
