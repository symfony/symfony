...
use Symphony\Component\Form\Extension\Core\DataTransformer\DateIntervalToArrayTransformer;
...
class DateIntervalType extends AbstractType
{
    ...
    private static $widgets = array(
        ...
        'integer' => 'Symphony\Component\Form\Extension\Core\Type\IntegerType',
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        if ('single_text' === $options['widget']) {
            ...
            if ($options['with_invert']) {
                $builder->add('invert', 'Symphony\Component\Form\Extension\Core\Type\CheckboxType', array(
