...
class RequestPayloadValueResolverTest extends TestCase
{
    ...
    public function testItThrowsOnMissingAttributeType()
    {
        ...
        $this->expectExceptionMessage('Please set the $type argument of the #[MapRequestPayload] attribute to the type of the objects in the expected array.');
    ...
    public function testItThrowsOnInvalidAttributeTypeUsage()
    {
        ...
        $this->expectException(NearMissValueResolverException::class);
        $this->expectExceptionMessage('Please set its type to "array" when using argument $type of #[MapRequestPayload].');
        $resolver->resolve($request, $argument);
    }
