...
class HttpCacheTest extends HttpCacheTestCase
{
    ...
    {
        $storeMock = $this->getMockBuilder('Symphony\\Component\\HttpKernel\\HttpCache\\StoreInterface')
        ...
        $kernelMock = $this->getMockBuilder('Symphony\\Component\\HttpKernel\\Kernel')
            ->disableOriginalConstructor()
