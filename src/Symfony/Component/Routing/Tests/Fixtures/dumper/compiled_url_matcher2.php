...
return [
    ...
    [ // $staticRoutes
        ...
        '/secure' => [[['_route' => 'secure', '_route_path' => '/secure'], null, null, ['https' => 0], false, false, null]],
        '/nonsecure' => [[['_route' => 'nonsecure', '_route_path' => '/nonsecure'], null, null, ['http' => 0], false, false, null]],
    ],
    [ // $regexpList
        0 => '{^(?'
            .'|(?:(?:[^./]*+\\.)++)(?'
