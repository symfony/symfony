...
class ApplicationTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->setExpectedException('Symfony\Component\Console\Exception\CommandNotDefinedException', $expectedExceptionMessage);
    ...
    public function testFindAlternativeExceptionMessageMultiple()
    {
        ...
        try {
            ...
            $this->fail('->find() throws a CommandNotDefinedException if command does not exist, with alternatives');
        } catch (\Exception $e) {
            $this->assertInstanceOf('Symfony\Component\Console\Exception\CommandNotDefinedException', $e, '->find() throws a CommandNotDefinedException if command does not exist, with alternatives');
            $this->assertRegExp('/Did you mean one of these/', $e->getMessage(), '->find() throws a CommandNotDefinedException if command does not exist, with alternatives');
        ...
        try {
            ...
            $this->fail('->find() should throw an Symfony\Component\Console\Exception\CommandNotDefinedException if a command is ambiguous because of a subnamespace, with alternatives');
        } catch (\Exception $e) {
            $this->assertInstanceOf('Symfony\Component\Console\Exception\CommandNotDefinedException', $e);
    ...
    public function testFindAlternativeCommands()
    {
        ...
        try {
            ...
            $this->fail('->find() throws a CommandNotDefinedException if command does not exist');
        } catch (\Exception $e) {
            $this->assertInstanceOf('Symfony\Component\Console\Exception\CommandNotDefinedException', $e, '->find() throws a CommandNotDefinedException if command does not exist');
            $this->assertSame(array(), $e->getAlternatives());
            $this->assertEquals(sprintf('Command "%s" is not defined.', $commandName), $e->getMessage(), '->find() throws a CommandNotDefinedException if command does not exist, without alternatives');
        }

        // Test if "bar1" command throw a "CommandNotDefinedException" and does not contain
        ...
        try {
            ...
            $this->assertRegExp(sprintf('/Command "%s" is not defined./', $commandName), $e->getMessage(), '->find() throws a CommandNotDefinedException if command does not exist, with alternatives');
            $this->assertRegExp('/afoobar1/', $e->getMessage(), '->find() throws a CommandNotDefinedException if command does not exist, with alternative : "afoobar1"');
            $this->assertRegExp('/foo:bar1/', $e->getMessage(), '->find() throws a CommandNotDefinedException if command does not exist, with alternative : "foo:bar1"');
            $this->assertNotRegExp('/foo:bar(?>!1)/', $e->getMessage(), '->find() throws a CommandNotDefinedException if command does not exist, without "foo:bar" alternative');
        }
    }
    ...
    public function testFindAlternativeNamespace()
    {
        ...
        try {
            ...
            $this->fail('->find() throws a CommandNotDefinedException if namespace does not exist');
        } catch (\Exception $e) {
            $this->assertInstanceOf('Symfony\Component\Console\Exception\CommandNotDefinedException', $e, '->find() throws a CommandNotDefinedException if namespace does not exist');
            $this->assertSame(array(), $e->getAlternatives());
            $this->assertEquals('There are no commands defined in the "Unknown-namespace" namespace.', $e->getMessage(), '->find() throws a CommandNotDefinedException if namespace does not exist, without alternatives');
        }
        ...
        try {
            ...
            $this->assertRegExp('/There are no commands defined in the "foo2" namespace./', $e->getMessage(), '->find() throws a CommandNotDefinedException if namespace does not exist, with alternative');
            $this->assertRegExp('/foo/', $e->getMessage(), '->find() throws a CommandNotDefinedException if namespace does not exist, with alternative : "foo"');
            $this->assertRegExp('/foo1/', $e->getMessage(), '->find() throws a CommandNotDefinedException if namespace does not exist, with alternative : "foo1"');
            $this->assertRegExp('/foo3/', $e->getMessage(), '->find() throws a CommandNotDefinedException if namespace does not exist, with alternative : "foo3"');
        }
    }
