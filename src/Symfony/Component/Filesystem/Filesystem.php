...
class Filesystem
{
     ...
     *
     * All files and directories in the origin directory will be copied into the target directory. By default:
     *
     ...
     * @param \Traversable $iterator  Provide an iterator to filter which files in the origin directory will be copied.
