...
namespace Symfony\Bundle\FeatureFlagsBundle\DependencyInjection;
                    ...
                    ->arrayPrototype()
                        ->children()
                            ...
                            ->scalarNode('strategy')
                                ...
                                ->cannotBeEmpty()
                                ->example('header.feature-strategy')
                                ->info('Strategy to be used for this feature. Can be one of "feature_flags.strategies[].name" or a valid service id that implements StrategyInterface::class.')
                            ->end()
                        ->end()
                    ->end()
                ->end()
