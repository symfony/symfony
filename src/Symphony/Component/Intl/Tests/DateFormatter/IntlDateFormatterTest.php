...
class IntlDateFormatterTest extends AbstractIntlDateFormatterTest
{
    ...
    public function testStaticCreate()
    {
        ...
        $this->assertInstanceOf('\Symphony\Component\Intl\DateFormatter\IntlDateFormatter', $formatter);
    }
    ...
    public function testFormatWithUnsupportedTimestampArgument()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('Symphony\Component\Intl\Exception\MethodArgumentValueNotImplementedException', $e);
