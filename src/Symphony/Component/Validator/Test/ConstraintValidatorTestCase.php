...
namespace Symphony\Component\Validator\Test;
...
use Symphony\Component\Validator\Context\ExecutionContext;
...
abstract class ConstraintValidatorTestCase extends TestCase
{
    ...
    protected function expectValidateAt($i, $propertyPath, $value, $group)
    {
        ...
        $validator->expects($this->at(2 * $i + 1))
            ->method('validate')
            ->with($value, $this->logicalOr(null, array(), $this->isInstanceOf('\Symphony\Component\Validator\Constraints\Valid')), $group);
    }
