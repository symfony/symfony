...
abstract class AbstractRequestHandlerTest extends TestCase
{
    ...
    {
        $this->serverParams = $this->getMockBuilder('Symphony\Component\Form\Util\ServerParams')->setMethods(array('getNormalizedIniPostMaxSize', 'getContentLength'))->getMock();
    ...
    public function testAddFormErrorIfPostMaxSizeExceeded($contentLength, $iniMax, $shouldFail, array $errorParams = array())
    {
        ...
        $form = $this->factory->createNamed('name', 'Symphony\Component\Form\Extension\Core\Type\TextType', null, $options);
