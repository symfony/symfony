 ...
 * typically that a {@see CompositeKms} keeps reading through its other members and refuses to
 ...
 *     $kms = new CompositeKms(new ServiceLocator(['aws' => fn () => $aws, 'azure' => fn () => new InMemoryKms()]), ['aws' => null, 'azure' => 'backup']);
...
final class SwitchableKms implements DataKeyGeneratorInterface, DecrypterInterface, EncrypterInterface
{
    ...
    public function __construct(
        ...
        private readonly \Throwable $failure = new \RuntimeException('The backend is down.'),
    ) {
    }
