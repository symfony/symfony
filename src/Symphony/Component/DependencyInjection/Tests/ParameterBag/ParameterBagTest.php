...
use Symphony\Component\DependencyInjection\Exception\ParameterCircularReferenceException;
...
class ParameterBagTest extends TestCase
{
    ...
    public function testGetSet()
    {
        ...
        try {
            $bag->get('baba');
            $this->fail('->get() throws an Symphony\Component\DependencyInjection\Exception\ParameterNotFoundException if the key does not exist');
        } catch (\Exception $e) {
            $this->assertInstanceOf('Symphony\Component\DependencyInjection\Exception\ParameterNotFoundException', $e, '->get() throws an Symphony\Component\DependencyInjection\Exception\ParameterNotFoundException if the key does not exist');
            $this->assertEquals('You have requested a non-existent parameter "baba".', $e->getMessage(), '->get() throws an Symphony\Component\DependencyInjection\Exception\ParameterNotFoundException if the key does not exist');
        }
    }
