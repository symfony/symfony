        ...
        foreach ($aliases as $alias => $data) {
            ...
            if (2 === \strlen($language) && 3 === \strlen($alias) && 'overlong' === $data['reason']) {
                if (isset(self::PREFERRED_ALPHA2_TO_ALPHA3_MAPPING[$language])) {
                    ...
                    throw new RuntimeException('Multiple three-letter mappings exist for the language code '.$language.'. Please add one of them to the constant PREFERRED_ALPHA2_TO_ALPHA3_MAPPING.');
                } else {
