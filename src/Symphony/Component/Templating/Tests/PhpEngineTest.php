...
use Symphony\Component\Templating\Helper\SlotsHelper;
...
class PhpEngineTest extends TestCase
{
    ...
    {
        $engine = new ProjectTemplateEngine(new TemplateNameParser(), $this->loader);
        $engine->set($helper = new \Symphony\Component\Templating\Tests\Fixtures\SimpleHelper('bar'), 'foo');
    ...
    {
        $engine = new ProjectTemplateEngine(new TemplateNameParser(), $this->loader);
        $foo = new \Symphony\Component\Templating\Tests\Fixtures\SimpleHelper('foo');
        $engine->set($foo);
    ...
    public function testExtendRender()
    {
        ...
        $engine->set(new \Symphony\Component\Templating\Tests\Fixtures\SimpleHelper('bar'));
