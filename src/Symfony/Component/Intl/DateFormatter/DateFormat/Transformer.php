...
abstract class Transformer
{
     ...
     * @param integer   $length   The formatted value string length
     *
     ...
     *
     * @param integer $length The length of the value to be reverse matched
     *
     ...
     * @param integer $length  The length of the Transformer pattern string
     *
     ...
     * @param integer $length The length to pad
     *
