...
use Symphony\Component\Security\Core\Encoder\Argon2iPasswordEncoder;
...
abstract class CompleteConfigurationTest extends TestCase
{
    ...
    public function testFirewalls()
    {
        ...
        // the Symphony version. Transform them to lowercase to simplify tests.
        ...
        $this->assertFalse($container->hasAlias('Symphony\Component\Security\Core\User\UserCheckerInterface', 'No user checker alias is registered when custom user checker services are registered'));
    }
    ...
    public function testUserCheckerAliasIsRegistered()
    {
        ...
        $this->assertTrue($container->hasAlias('Symphony\Component\Security\Core\User\UserCheckerInterface', 'Alias for user checker is registered when no custom user checker service is registered'));
        $this->assertFalse($container->getAlias('Symphony\Component\Security\Core\User\UserCheckerInterface')->isPublic());
    }
    ...
    public function testEncoders()
    {
        ...
        $this->assertEquals(array(array(
            'JMS\FooBundle\Entity\User1' => array(
                'class' => 'Symphony\Component\Security\Core\Encoder\PlaintextPasswordEncoder',
            ...
            'JMS\FooBundle\Entity\User5' => array(
                'class' => 'Symphony\Component\Security\Core\Encoder\Pbkdf2PasswordEncoder',
                'arguments' => array('sha1', false, 5, 30),
            ),
            'JMS\FooBundle\Entity\User6' => array(
                'class' => 'Symphony\Component\Security\Core\Encoder\BCryptPasswordEncoder',
                'arguments' => array(15),
            ),
    ...
    public function testEncodersWithLibsodium()
    {
        ...
        $this->assertEquals(array(array(
            ...
            'JMS\FooBundle\Entity\User7' => array(
                'class' => 'Symphony\Component\Security\Core\Encoder\Argon2iPasswordEncoder',
