...
namespace Symphony\Bundle\FrameworkBundle\Console\Descriptor;
...
class TextDescriptor extends Descriptor
{
    ...
    protected function describeContainerParameters(ParameterBag $parameters, array $options = array())
    {
        ...
        $options['output']->title('Symphony Container Parameters');
        $options['output']->table($tableHeaders, $tableRows);
    }
    ...
    protected function describeContainerTags(ContainerBuilder $builder, array $options = array())
    {
        ...
        if ($showPrivate) {
            $options['output']->title('Symphony Container Public and Private Tags');
        } else {
            $options['output']->title('Symphony Container Public Tags');
        }
    ...
    protected function describeContainerServices(ContainerBuilder $builder, array $options = array())
    {
        ...
        if ($showPrivate) {
            $title = 'Symphony Container Public and Private Services';
        } else {
            $title = 'Symphony Container Public Services';
        }
    ...
    private function renderEventListenerTable(EventDispatcherInterface $eventDispatcher, $event, array $eventListeners, SymphonyStyle $io)
    {
