...
class TwigExtension extends Extension
{
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        if (interface_exists('Symphony\Component\Templating\EngineInterface')) {
        ...
        if (!interface_exists('Symphony\Component\Translation\TranslatorInterface')) {
    ...
    {
        return 'http://symphony.com/schema/dic/twig';
    }
}
