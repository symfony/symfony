...
namespace Symphony\Component\Form\Command;
...
use Symphony\Component\Form\Console\Helper\DescriptorHelper;
...
class DebugCommand extends Command
{
    ...
    public function __construct(FormRegistryInterface $formRegistry, array $namespaces = array('Symphony\Component\Form\Extension\Core\Type'), array $types = array(), array $extensions = array(), array $guessers = array())
    {
        parent::__construct();
...
The command lists all built-in types, services types, type extensions and guessers currently available.
  ...
  <info>php %command.full_name% Symphony\Component\Form\Extension\Core\Type\ChoiceType</info>
...
EOF
    ...
    private function getFqcnTypeClass(InputInterface $input, SymphonyStyle $io, $shortClassName)
    {
        $classes = array();
