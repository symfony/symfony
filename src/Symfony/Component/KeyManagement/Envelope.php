...
/**
 * Envelope produced by {@see EnvelopeEncrypter} and {@see StoredEnvelopeEncrypter}.
 *
 * Carries the AEAD nonce and tag, the local ciphertext, and how to obtain the data key. The bytes
 * are owned by its {@see EnvelopeFormat}, so callers persist or transmit the object as opaque bytes
 * through {@see __toString()} and read it back through {@see fromBytes()}, which resolves the
 * format from the leading byte.
 *
