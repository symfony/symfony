...
use Symphony\Bridge\Twig\Extension\StopwatchExtension;
...
class StopwatchExtensionTest extends TestCase
{
    ...
    public function getTimingTemplates()
    {
        return array(
            ...
            array('{% stopwatch "foo" %}symphony is fun{% endstopwatch %}{% stopwatch "bar" %}something{% endstopwatch %}', array('foo', 'bar')),
