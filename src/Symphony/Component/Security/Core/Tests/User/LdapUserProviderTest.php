...
use Symphony\Component\Security\Core\User\LdapUserProvider;
...
class LdapUserProviderTest extends TestCase
{
    ...
    public function testLoadUserByUsernameFailsIfCantConnectToLdap()
    {
        ...
        $provider = new LdapUserProvider($ldap, 'ou=MyBusiness,dc=symphony,dc=com');
    ...
    /**
     * @expectedException \Symphony\Component\Security\Core\Exception\InvalidArgumentException
     */
    public function testLoadUserByUsernameFailsIfMoreThanOneLdapPasswordsInEntry()
    {
        ...
        $provider = new LdapUserProvider($ldap, 'ou=MyBusiness,dc=symphony,dc=com', null, null, array(), 'sAMAccountName', '({uid_key}={username})', 'userpassword');
        $this->assertInstanceOf(
            'Symphony\Component\Security\Core\User\User',
            $provider->loadUserByUsername('foo')
        );
    }
    ...
    public function testLoadUserByUsernameShouldNotFailIfEntryHasNoUidKeyAttribute()
    {
        ...
        $provider = new LdapUserProvider($ldap, 'ou=MyBusiness,dc=symphony,dc=com', null, null, array(), 'sAMAccountName', '({uid_key}={username})');
        $this->assertInstanceOf(
            'Symphony\Component\Security\Core\User\User',
            $provider->loadUserByUsername('foo')
        );
