 ...
 */
final class MonthsExpressionValidatorTest extends TestCase
{
    public function testInvalidExpressionCannotBeValidated(): void
    {
        static::assertFalse((new MonthsExpressionValidator())->isValid('test'));
    }

    public function testValidExpressionCanBeValidated(): void
    {
        static::assertTrue((new MonthsExpressionValidator())->isValid('2'));
    }
}
