...
class UrlMatcherTest extends TestCase
{
    ...
    /**
     * @expectedException \Symphony\Component\Routing\Exception\ResourceNotFoundException
     */
    ...
    public function testMatchOverriddenRoute()
    {
        ...
        $this->{method_exists($this, $_ = 'expectException') ? $_ : 'setExpectedException'}('Symphony\Component\Routing\Exception\ResourceNotFoundException');
    ...
    /**
     * @expectedException \Symphony\Component\Routing\Exception\NoConfigurationException
     */
